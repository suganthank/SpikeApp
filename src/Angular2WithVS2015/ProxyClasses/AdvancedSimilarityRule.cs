...
{
    [EntityLogicalNameAttribute("advancedsimilarityrule")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class AdvancedSimilarityRule : BaseProxyClass
    {
        public new const string LogicalName = "advancedsimilarityrule";
        public const int ObjectTypeCode = 9949;
        public const string PrimaryIdAttribute = "advancedsimilarityruleid";
        public const string PrimaryNameAttribute = "name";
        
        static AdvancedSimilarityRule()
        {
            BaseProxyClass.RegisterProxyType(typeof(AdvancedSimilarityRule), "advancedsimilarityrule");
        ...
        public AdvancedSimilarityRule() : base(new Entity("advancedsimilarityrule")) { }
        public AdvancedSimilarityRule(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<AdvancedSimilarityRule>(); }
        /// <summary>
...
///<summary>
///<para>Logical Name: advancedsimilarityruleidunique</para>
///</summary>
[AttributeLogicalNameAttribute("advancedsimilarityruleidunique")]
public Guid AdvancedSimilarityRuleUniqueId
{
	get { return this.GetPropertyValue<Guid>("advancedsimilarityruleidunique"); }
}
/// <summary>
...
///<summary>
///<para>Logical Name: filterresultbystatusdisplayname</para>
///<para>Max Length: 50 characters</para>
///</summary>
[AttributeLogicalNameAttribute("filterresultbystatusdisplayname")]
public string FilterResultByStatus
{
	get { return this.GetPropertyValue<string>("filterresultbystatusdisplayname"); }
	set { this.SetPropertyValue("filterresultbystatusdisplayname", value, 50, "FilterResultByStatus"); }
}
///<summary>
///<para>Logical Name: filterresultbystatus</para>
///</summary>
[AttributeLogicalNameAttribute("filterresultbystatus")]
public string FilterResultByStatus2
{
	get { return this.GetPropertyValue<string>("filterresultbystatus"); }
	set { this.SetPropertyValue<string>("filterresultbystatus", value, "FilterResultByStatus2"); }
}
///<summary>
...
public string ForInternalUseOnly
{
	...
	set { this.SetPropertyValue("fetchxmllist", value, 500000, "ForInternalUseOnly"); }
}
///<summary>
///<para>Logical Name: exactmatchlist</para>
///<para>Max Length: 500000 characters</para>
///</summary>
[AttributeLogicalNameAttribute("exactmatchlist")]
public string ForInternalUseOnly2
{
	get { return this.GetPropertyValue<string>("exactmatchlist"); }
	set { this.SetPropertyValue("exactmatchlist", value, 500000, "ForInternalUseOnly2"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: maxnumberkeyphrases</para>
///<para>Minimum Value: 0</para>
///<para>Maximum Value: 1000</para>
///</summary>
[AttributeLogicalNameAttribute("maxnumberkeyphrases")]
public int? MaximumNumberOfKeyPhrases
{
	get { return this.GetPropertyValue<int?>("maxnumberkeyphrases"); }
	set { this.SetPropertyValue("maxnumberkeyphrases", (int?)value, (int)0, (int)1000, "MaximumNumberOfKeyPhrases"); }
}
///<summary>
...
public eStatusReason? Status2
{
	get
	{
		if (Status2_OptionSetValue != null) { return (eStatusReason)Status2_OptionSetValue.Value; }
		return null;
	}
	set
	{
...
public OptionSetValue Status2_OptionSetValue
{
	...
	set { this.SetPropertyValue<OptionSetValue>("statuscode", value, "Status2_OptionSetValue"); }
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
...
{
	return this.Status2_OptionSetValue.GetOptionSetText(Service, this, "statuscode");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
...
public string TargetEntity
{
	...
	set { this.SetPropertyValue("entity", value, 100, "TargetEntity"); }
}
///<summary>
///<para>Logical Name: isazuremlrequired</para>
///<para>True = Yes</para>
///<para>False = No</para>
///</summary>
[AttributeLogicalNameAttribute("isazuremlrequired")]
public bool? UseTextAnalyticsForTargetMatch
{
	get { return this.GetPropertyValue<bool?>("isazuremlrequired"); }
	set { this.SetPropertyValue<bool?>("isazuremlrequired", value, "UseTextAnalyticsForTargetMatch"); }
}


        /// <summary>
/// <para><b>TextAnalyticsEntityMapping (Advanced Similarity RuleId)</b></para>
/// <para>Schema Name: advancedsimilarityrule_textanalyticsentitymapping</para>
/// </summary>
public List<TextAnalyticsEntityMapping> GetTextAnalyticsEntityMappings_AdvancedSimilarityRuleId (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<TextAnalyticsEntityMapping>(Service, this.Id, "textanalyticsentitymapping", "advancedsimilarityruleid", Columns); }
/// <summary>
/// <para><b>TextAnalyticsEntityMapping (Advanced Similarity RuleId)</b></para>
/// <para>Schema Name: advancedsimilarityrule_textanalyticsentitymapping</para>
/// </summary>
public List<TextAnalyticsEntityMapping> GetTextAnalyticsEntityMappings_AdvancedSimilarityRuleId (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<TextAnalyticsEntityMapping>(Service, this.Id, "textanalyticsentitymapping", "advancedsimilarityruleid", Columns); }
        ...
        public static class Properties
{
	...
	/// <summary><para>Advanced Similarity Rule Unique Id</para>
	/// <para>advancedsimilarityruleidunique</para></summary>
	public const string AdvancedSimilarityRuleUniqueId = "advancedsimilarityruleidunique";
	...
	/// <summary><para>Filter Result By Status</para>
	/// <para>filterresultbystatusdisplayname</para></summary>
	public const string FilterResultByStatus = "filterresultbystatusdisplayname";
	/// <summary><para>Filter Result By Status</para>
	/// <para>filterresultbystatus</para></summary>
	public const string FilterResultByStatus2 = "filterresultbystatus";
	/// <summary><para>For internal use only.</para>
	/// <para>fetchxmllist</para></summary>
	public const string ForInternalUseOnly = "fetchxmllist";
	/// <summary><para>For internal use only.</para>
	/// <para>exactmatchlist</para></summary>
	public const string ForInternalUseOnly2 = "exactmatchlist";
	...
	/// <para>maxnumberkeyphrases</para></summary>
	public const string MaximumNumberOfKeyPhrases = "maxnumberkeyphrases";
	...
	public const string Status2 = "statuscode";
	/// <summary><para>Target Entity</para>
	/// <para>entity</para></summary>
	public const string TargetEntity = "entity";
	/// <summary><para>Use Text Analytics for Target Match</para>
	/// <para>isazuremlrequired</para></summary>
	public const string UseTextAnalyticsForTargetMatch = "isazuremlrequired";
}
