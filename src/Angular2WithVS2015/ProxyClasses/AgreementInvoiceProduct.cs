...
namespace ProxyClasses
{
    ...
    public partial class AgreementInvoiceProduct : BaseProxyClass
    {
        public new const string LogicalName = "msdyn_agreementinvoiceproduct";
        public const int ObjectTypeCode = 10112;
        public const string PrimaryIdAttribute = "msdyn_agreementinvoiceproductid";
        public const string PrimaryNameAttribute = "msdyn_name";
        
        static AgreementInvoiceProduct()
        {
            BaseProxyClass.RegisterProxyType(typeof(AgreementInvoiceProduct), "msdyn_agreementinvoiceproduct");
        ...
        public AgreementInvoiceProduct() : base(new Entity("msdyn_agreementinvoiceproduct")) { }
        public AgreementInvoiceProduct(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<AgreementInvoiceProduct>(); }
        /// <summary>
...
public Guid AgreementInvoiceProductId
{
	get
	{
		return this.Id;
...
public EntityReference AgreementInvoiceSetup
{
	get { return this.GetPropertyValue<EntityReference>("msdyn_agreementinvoicesetup"); }
	set { this.SetPropertyValue<EntityReference>("msdyn_agreementinvoicesetup", value, "AgreementInvoiceSetup"); }
}
///<summary>
...
/// <summary>
/// <para><b>InvoiceLine (Agreement Invoice Product)</b></para>
/// <para>Schema Name: msdyn_msdyn_agreementinvoiceproduct_invoicedetail_AgreementInvoiceProduct</para>
/// </summary>
public List<InvoiceLine> GetInvoiceLines_AgreementInvoiceProduct (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<InvoiceLine>(Service, this.Id, "invoicedetail", "msdyn_agreementinvoiceproduct", Columns); }
/// <summary>
/// <para><b>InvoiceLine (Agreement Invoice Product)</b></para>
/// <para>Schema Name: msdyn_msdyn_agreementinvoiceproduct_invoicedetail_AgreementInvoiceProduct</para>
/// </summary>
public List<InvoiceLine> GetInvoiceLines_AgreementInvoiceProduct (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<InvoiceLine>(Service, this.Id, "invoicedetail", "msdyn_agreementinvoiceproduct", Columns); }
/// <summary>
...
/// <para>Schema Name: msdyn_agreementinvoiceproduct_msdyn_approvals</para>
/// </summary>
        ...
        public static class Properties
{
	...
	public const string AgreementInvoiceProductId = "msdyn_agreementinvoiceproductid";
	/// <summary><para>Agreement Invoice Setup</para>
	/// <para>msdyn_agreementinvoicesetup</para></summary>
	public const string AgreementInvoiceSetup = "msdyn_agreementinvoicesetup";
