...
{
    [EntityLogicalNameAttribute("msdyn_workhourtemplate")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class WorkTemplate : BaseProxyClass
    {
        public new const string LogicalName = "msdyn_workhourtemplate";
        public const int ObjectTypeCode = 10027;
        public const string PrimaryIdAttribute = "msdyn_workhourtemplateid";
        public const string PrimaryNameAttribute = "msdyn_name";
        
        static WorkTemplate()
        {
            BaseProxyClass.RegisterProxyType(typeof(WorkTemplate), "msdyn_workhourtemplate");
        ...
        public WorkTemplate() : base(new Entity("msdyn_workhourtemplate")) { }
        public WorkTemplate(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<WorkTemplate>(); }
        /// <summary>
...
public string Calendar
{
	...
	set { this.SetPropertyValue("msdyn_calendarid", value, 200, "Calendar"); }
}
///<summary>
...
public EntityReference TemplateResource
{
	get { return this.GetPropertyValue<EntityReference>("msdyn_bookableresourceid"); }
	set { this.SetPropertyValue<EntityReference>("msdyn_bookableresourceid", value, "TemplateResource"); }
}
///<summary>
...
///<para>Logical Name: msdyn_workhourtemplateid</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_workhourtemplateid")]
public Guid WorkTemplateId
{
	get
	{
		return this.Id;
...
/// <para>Schema Name: msdyn_workhourtemplate_Annotations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_workhourtemplate_AsyncOperations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_workhourtemplate_BulkDeleteFailures</para>
/// </summary>
...
/// <para>Schema Name: msdyn_workhourtemplate_DuplicateBaseRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_workhourtemplate_DuplicateMatchingRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_workhourtemplate_MailboxTrackingFolders</para>
/// </summary>
...
/// <summary>
/// <para><b>Project (Work hour template)</b></para>
/// <para>Schema Name: msdyn_msdyn_workhourtemplate_msdyn_project_workhourtemplate</para>
/// </summary>
public List<Project> GetProjects_WorkHourTemplate (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Project>(Service, this.Id, "msdyn_project", "msdyn_workhourtemplate", Columns); }
/// <summary>
/// <para><b>Project (Work hour template)</b></para>
/// <para>Schema Name: msdyn_msdyn_workhourtemplate_msdyn_project_workhourtemplate</para>
/// </summary>
public List<Project> GetProjects_WorkHourTemplate (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Project>(Service, this.Id, "msdyn_project", "msdyn_workhourtemplate", Columns); }
/// <summary>
/// <para><b>ProjectParameter (defaultWorkTemplate)</b></para>
/// <para>Schema Name: msdyn_msdyn_workhourtemplate_msdyn_projectparameter_defaultWorkTemplate</para>
/// </summary>
public List<ProjectParameter> GetProjectParameters_defaultWorkTemplate (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ProjectParameter>(Service, this.Id, "msdyn_projectparameter", "msdyn_defaultworktemplate", Columns); }
/// <summary>
/// <para><b>ProjectParameter (defaultWorkTemplate)</b></para>
/// <para>Schema Name: msdyn_msdyn_workhourtemplate_msdyn_projectparameter_defaultWorkTemplate</para>
/// </summary>
public List<ProjectParameter> GetProjectParameters_defaultWorkTemplate (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ProjectParameter>(Service, this.Id, "msdyn_projectparameter", "msdyn_defaultworktemplate", Columns); }
/// <summary>
/// <para><b>ProjectTeamMember (Work Template)</b></para>
/// <para>Schema Name: msdyn_msdyn_workhourtemplate_msdyn_projectteam_worktemplate</para>
/// </summary>
public List<ProjectTeamMember> GetProjectTeamMembers_WorkTemplate (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ProjectTeamMember>(Service, this.Id, "msdyn_projectteam", "msdyn_worktemplate", Columns); }
/// <summary>
/// <para><b>ProjectTeamMember (Work Template)</b></para>
/// <para>Schema Name: msdyn_msdyn_workhourtemplate_msdyn_projectteam_worktemplate</para>
/// </summary>
public List<ProjectTeamMember> GetProjectTeamMembers_WorkTemplate (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ProjectTeamMember>(Service, this.Id, "msdyn_projectteam", "msdyn_worktemplate", Columns); }
/// <summary>
/// <para>Requirements</para>
/// <para><b>ResourceRequirement (Work Hour Template)</b></para>
/// <para>Schema Name: msdyn_workhourtemplate_msdyn_resourcerequirement_workhourtemplate</para>
/// </summary>
public List<ResourceRequirement> GetRequirements_WorkHourTemplate (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ResourceRequirement>(Service, this.Id, "msdyn_resourcerequirement", "msdyn_workhourtemplate", Columns); }
/// <summary>
/// <para>Requirements</para>
/// <para><b>ResourceRequirement (Work Hour Template)</b></para>
/// <para>Schema Name: msdyn_workhourtemplate_msdyn_resourcerequirement_workhourtemplate</para>
/// </summary>
public List<ResourceRequirement> GetRequirements_WorkHourTemplate (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ResourceRequirement>(Service, this.Id, "msdyn_resourcerequirement", "msdyn_workhourtemplate", Columns); }
/// <summary>
/// <para><b>FieldSharing (Entity instance)</b></para>
/// <para>Schema Name: msdyn_workhourtemplate_PrincipalObjectAttributeAccesses</para>
/// </summary>
...
/// <para>Schema Name: msdyn_workhourtemplate_ProcessSession</para>
/// </summary>
...
/// <para>Schema Name: msdyn_workhourtemplate_SyncErrors</para>
/// </summary>
...
/// <para>Schema Name: msdyn_workhourtemplate_UserEntityInstanceDatas</para>
/// </summary>
        ...
        public static class Properties
{
	...
	public const string Calendar = "msdyn_calendarid";
	...
	/// <summary><para>Template Resource</para>
	/// <para>msdyn_bookableresourceid</para></summary>
	public const string TemplateResource = "msdyn_bookableresourceid";
	...
	/// <para>msdyn_workhourtemplateid</para></summary>
	public const string WorkTemplateId = "msdyn_workhourtemplateid";
}
