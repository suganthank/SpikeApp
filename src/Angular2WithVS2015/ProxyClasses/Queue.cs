...
/// <summary>
/// <para><b>RecordCreationAndUpdateRule (Queue)</b></para>
/// <para>Schema Name: convertrule_queue</para>
/// </summary>
public List<RecordCreationAndUpdateRule> GetRecordCreationAndUpdateRules_Queue (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RecordCreationAndUpdateRule>(Service, this.Id, "convertrule", "queueid", Columns); }
/// <summary>
/// <para><b>RecordCreationAndUpdateRule (Queue)</b></para>
/// <para>Schema Name: convertrule_queue</para>
/// </summary>
public List<RecordCreationAndUpdateRule> GetRecordCreationAndUpdateRules_Queue (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RecordCreationAndUpdateRule>(Service, this.Id, "convertrule", "queueid", Columns); }
/// <summary>
/// <para><b>RecordCreationAndUpdateRuleItem (Queue)</b></para>
/// <para>Schema Name: queue_convertruleitem</para>
/// </summary>
public List<RecordCreationAndUpdateRuleItem> GetRecordCreationAndUpdateRuleItems_Queue (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RecordCreationAndUpdateRuleItem>(Service, this.Id, "convertruleitem", "queueid", Columns); }
/// <summary>
/// <para><b>RecordCreationAndUpdateRuleItem (Queue)</b></para>
/// <para>Schema Name: queue_convertruleitem</para>
/// </summary>
public List<RecordCreationAndUpdateRuleItem> GetRecordCreationAndUpdateRuleItems_Queue (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RecordCreationAndUpdateRuleItem>(Service, this.Id, "convertruleitem", "queueid", Columns); }
/// <summary>
...
/// <summary>
/// <para><b>Mailbox (Regarding)</b></para>
/// <para>Schema Name: mailbox_regarding_queue</para>
/// </summary>
public List<Mailbox> GetMailboxes_Regarding (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Mailbox>(Service, this.Id, "mailbox", "regardingobjectid", Columns); }
/// <summary>
/// <para><b>Mailbox (Regarding)</b></para>
/// <para>Schema Name: mailbox_regarding_queue</para>
/// </summary>
public List<Mailbox> GetMailboxes_Regarding (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Mailbox>(Service, this.Id, "mailbox", "regardingobjectid", Columns); }
/// <summary>
...
/// <summary>
/// <para><b>RuleItem (Add to Queue)</b></para>
/// <para>Schema Name: queue_routingruleitem</para>
/// </summary>
public List<RuleItem> GetRuleItems_AddToQueue (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RuleItem>(Service, this.Id, "routingruleitem", "routedqueueid", Columns); }
/// <summary>
/// <para><b>RuleItem (Add to Queue)</b></para>
/// <para>Schema Name: queue_routingruleitem</para>
/// </summary>
public List<RuleItem> GetRuleItems_AddToQueue (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RuleItem>(Service, this.Id, "routingruleitem", "routedqueueid", Columns); }
/// <summary>
...
/// <summary>
/// <para><b>User (Default Queue)</b></para>
/// <para>Schema Name: queue_system_user</para>
/// </summary>
public List<User> GetUsers_DefaultQueue (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<User>(Service, this.Id, "systemuser", "queueid", Columns); }
/// <summary>
/// <para><b>User (Default Queue)</b></para>
/// <para>Schema Name: queue_system_user</para>
/// </summary>
public List<User> GetUsers_DefaultQueue (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<User>(Service, this.Id, "systemuser", "queueid", Columns); }
/// <summary>
...
/// </summary>
public List<User> GetUsers (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<User>(Service, this, "queue", "queueid", "systemuser", "systemuserid", "queuemembership", "queueid", "systemuserid", Columns); }
public List<User> GetUsers (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<User>(Service, this, "queue", "queueid", "systemuser", "systemuserid", "queuemembership", "queueid", "systemuserid", Columns); }
