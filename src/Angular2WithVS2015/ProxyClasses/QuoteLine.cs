...
{
    [EntityLogicalNameAttribute("quotedetail")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class QuoteLine : BaseProxyClass
    {
        public new const string LogicalName = "quotedetail";
        public const int ObjectTypeCode = 1085;
        public const string PrimaryIdAttribute = "quotedetailid";
        public const string PrimaryNameAttribute = "productidname";
        
        static QuoteLine()
        {
            BaseProxyClass.RegisterProxyType(typeof(QuoteLine), "quotedetail");
        ...
        public QuoteLine() : base(new Entity("quotedetail")) { }
        public QuoteLine(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<QuoteLine>(); }
        /// <summary>
...
public Money EstimatedRevenueMoney
{
	...
	set { this.SetPropertyValue("msdyn_estimatedrevenue", (Money)value, (decimal)0, (decimal)922337203685477, "EstimatedRevenueMoney"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: msdyn_importdetailsfromagreement</para>
///<para>True = Yes</para>
///<para>False = No</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_importdetailsfromagreement")]
public bool? ImportDetailsFromAgreement
{
	get { return this.GetPropertyValue<bool?>("msdyn_importdetailsfromagreement"); }
	set { this.SetPropertyValue<bool?>("msdyn_importdetailsfromagreement", value, "ImportDetailsFromAgreement"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: msdyn_opportunityline</para>
///<para>Max Length: 100 characters</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_opportunityline")]
public string OpportunityLine
{
	get { return this.GetPropertyValue<string>("msdyn_opportunityline"); }
	set { this.SetPropertyValue("msdyn_opportunityline", value, 100, "OpportunityLine"); }
}
///<summary>
...
///<para>Precision: 4</para>
///</summary>
public decimal? QuoteLineAmount
{
	get
	{
		if (QuoteLineAmountMoney != null) { return QuoteLineAmountMoney.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.QuoteLineAmountMoney = new Money(value.Value); }
		else this.QuoteLineAmountMoney = null;
	}
}
///<summary>
///<para>Logical Name: extendedamount</para>
...
public Money QuoteLineAmountMoney
{
	get { return this.GetPropertyValue<Money>("extendedamount"); }
	set { this.SetPropertyValue("extendedamount", (Money)value, (decimal)-922337203685477, (decimal)922337203685477, "QuoteLineAmountMoney"); }
}
///<summary>
///<para>Logical Name: msdyn_linedescription</para>
///<para>Max Length: 4000 characters</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_linedescription")]
public string QuoteLineDescription
{
	get { return this.GetPropertyValue<string>("msdyn_linedescription"); }
}
///<summary>
///<para>Key Property (Uniqueidentifier)</para>
///<para>Logical Name: quotedetailid</para>
///</summary>
[AttributeLogicalNameAttribute("quotedetailid")]
public Guid QuoteProductId
{
	get
	{
		return this.Id;
...
/// <summary>
///Logical Name: quotestatecode
/// </summary>
[AttributeLogicalNameAttribute("quotestatecode")]
public eQuoteStatus? QuoteStatus
{
	get
	{
		if (QuoteStatus_OptionSetValue != null) { return (eQuoteStatus)QuoteStatus_OptionSetValue.Value; }
		return null;
	}
}
///<summary>
///<para>Logical Name: quotestatecode</para>
///</summary>
[AttributeLogicalNameAttribute("quotestatecode")]
public OptionSetValue QuoteStatus_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("quotestatecode"); }
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
/// <param name="Service">CRM Organization Service</param>
/// <returns></returns>
public string QuoteStatus_Text(IOrganizationService Service)
{
	return this.QuoteStatus_OptionSetValue.GetOptionSetText(Service, this, "quotestatecode");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
/// <param name="AttributeMetadata">The attribute metadata previously retrieved using the 'GetAttributeMetadata' extension method on the IOrganizationService object.</param>
/// <returns></returns>
public string QuoteStatus_Text(EnumAttributeMetadata AttributeMetadata)
{
	return AttributeMetadata.GetOptionSetText(this.QuoteStatus_OptionSetValue.Value);
}
///<summary>
...
public EntityReference ServicesPriceList
{
	get { return this.GetPropertyValue<EntityReference>("msdyn_pricelist"); }
	set { this.SetPropertyValue<EntityReference>("msdyn_pricelist", value, "ServicesPriceList"); }
}
///<summary>
...
/// <para>Schema Name: QuoteDetail_AsyncOperations</para>
/// </summary>
...
/// <para>Schema Name: QuoteDetail_BulkDeleteFailures</para>
/// </summary>
...
/// <para>Schema Name: QuoteDetail_Dynamicpropertyinstance</para>
/// </summary>
...
/// <para>Schema Name: quotedetail_principalobjectattributeaccess</para>
/// </summary>
...
/// <para>Schema Name: QuoteDetail_ProcessSessions</para>
/// </summary>
...
/// <summary>
/// <para><b>QuoteLine (Parent Bundle)</b></para>
/// <para>Schema Name: quotedetail_parent_quotedetail</para>
/// </summary>
public List<QuoteLine> GetQuoteLines_ParentBundle (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<QuoteLine>(Service, this.Id, "quotedetail", "parentbundleid", Columns); }
/// <summary>
/// <para><b>QuoteLine (Parent Bundle)</b></para>
/// <para>Schema Name: quotedetail_parent_quotedetail</para>
/// </summary>
public List<QuoteLine> GetQuoteLines_ParentBundle (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<QuoteLine>(Service, this.Id, "quotedetail", "parentbundleid", Columns); }
/// <summary>
/// <para><b>SyncError (Record)</b></para>
/// <para>Schema Name: QuoteDetail_SyncErrors</para>
/// </summary>
...
/// <para>Schema Name: userentityinstancedata_quotedetail</para>
/// </summary>
        ...
        public static class Properties
{
	...
	/// <summary><para>CostAmount (Base)</para>
	...
	/// <summary><para>ImportDetailsFromAgreement</para>
	/// <para>msdyn_importdetailsfromagreement</para></summary>
	public const string ImportDetailsFromAgreement = "msdyn_importdetailsfromagreement";
	...
	/// <para>msdyn_opportunityline</para></summary>
	public const string OpportunityLine = "msdyn_opportunityline";
	...
	/// <summary><para>Quote Line Amount</para>
	/// <para>extendedamount</para></summary>
	public const string QuoteLineAmount = "extendedamount";
	/// <summary><para>Quote Line Description</para>
	/// <para>msdyn_linedescription</para></summary>
	public const string QuoteLineDescription = "msdyn_linedescription";
	/// <summary><para>Quote Product</para>
	/// <para>quotedetailid</para></summary>
	public const string QuoteProductId = "quotedetailid";
	/// <summary><para>Quote Status</para>
	/// <para>quotestatecode</para></summary>
	...
	/// <summary><para>Services Price List</para>
	/// <para>msdyn_pricelist</para></summary>
	public const string ServicesPriceList = "msdyn_pricelist";
