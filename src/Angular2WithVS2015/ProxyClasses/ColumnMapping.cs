...
public string TargetEntity
{
	...
	set { this.SetPropertyValue("targetentityname", value, 160, "TargetEntity"); }
        ...
        /// <summary>
/// <para><b>LookupMapping (Column Mapping Id)</b></para>
/// <para>Schema Name: LookUpMapping_ColumnMapping</para>
/// </summary>
public List<LookupMapping> GetLookupMappings_ColumnMappingId (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<LookupMapping>(Service, this.Id, "lookupmapping", "columnmappingid", Columns); }
/// <summary>
/// <para><b>LookupMapping (Column Mapping Id)</b></para>
/// <para>Schema Name: LookUpMapping_ColumnMapping</para>
/// </summary>
public List<LookupMapping> GetLookupMappings_ColumnMappingId (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<LookupMapping>(Service, this.Id, "lookupmapping", "columnmappingid", Columns); }
/// <summary>
/// <para><b>ListValueMapping (Column Mapping Id)</b></para>
/// <para>Schema Name: PickListMapping_ColumnMapping</para>
/// </summary>
public List<ListValueMapping> GetListValueMappings_ColumnMappingId (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ListValueMapping>(Service, this.Id, "picklistmapping", "columnmappingid", Columns); }
/// <summary>
/// <para><b>ListValueMapping (Column Mapping Id)</b></para>
/// <para>Schema Name: PickListMapping_ColumnMapping</para>
/// </summary>
public List<ListValueMapping> GetListValueMappings_ColumnMappingId (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ListValueMapping>(Service, this.Id, "picklistmapping", "columnmappingid", Columns); }
/// <summary>
