...
{
    [EntityLogicalNameAttribute("msdyn_integrationjob")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class IntegrationJob : BaseProxyClass
    {
        public new const string LogicalName = "msdyn_integrationjob";
        public const int ObjectTypeCode = 10045;
        public const string PrimaryIdAttribute = "msdyn_integrationjobid";
        public const string PrimaryNameAttribute = "msdyn_name";
        
        static IntegrationJob()
        {
            BaseProxyClass.RegisterProxyType(typeof(IntegrationJob), "msdyn_integrationjob");
        ...
        public IntegrationJob() : base(new Entity("msdyn_integrationjob")) { }
        public IntegrationJob(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<IntegrationJob>(); }
        /// <summary>
...
///<para>Logical Name: msdyn_integrationjobid</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_integrationjobid")]
public Guid IntegrationJobId
{
	get
	{
		return this.Id;
...
public string Name
{
	...
	set { this.SetPropertyValue("msdyn_name", value, 250, "Name"); }
}
///<summary>
///<para>Logical Name: msdyn_numberofpackets</para>
///<para>Minimum Value: 0</para>
///<para>Maximum Value: 2147483647</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_numberofpackets")]
public int? NumberOfPackets
{
	get { return this.GetPropertyValue<int?>("msdyn_numberofpackets"); }
	set { this.SetPropertyValue("msdyn_numberofpackets", (int?)value, (int)0, (int)2147483647, "NumberOfPackets"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: msdyn_regardingentity</para>
///<para>Max Length: 100 characters</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_regardingentity")]
public string RegardingEntity
{
	get { return this.GetPropertyValue<string>("msdyn_regardingentity"); }
	set { this.SetPropertyValue("msdyn_regardingentity", value, 100, "RegardingEntity"); }
}
///<summary>
///<para>Logical Name: msdyn_regardingentityid</para>
///<para>Max Length: 100 characters</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_regardingentityid")]
public string RegardingEntityId
{
	get { return this.GetPropertyValue<string>("msdyn_regardingentityid"); }
	set { this.SetPropertyValue("msdyn_regardingentityid", value, 100, "RegardingEntityId"); }
}
///<summary>
///<para>Logical Name: msdyn_responsejson</para>
///<para>Max Length: 1048576 characters</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_responsejson")]
public string ResponseJSON
{
	get { return this.GetPropertyValue<string>("msdyn_responsejson"); }
	set { this.SetPropertyValue("msdyn_responsejson", value, 1048576, "ResponseJSON"); }
}
/// <summary>
...
public eIntegrationJobStatus? Status2
{
	get
	{
		if (Status2_OptionSetValue != null) { return (eIntegrationJobStatus)Status2_OptionSetValue.Value; }
		return null;
	}
	set
	{
...
public eIntegrationType? Type
{
	get
	{
		if (Type_OptionSetValue != null) { return (eIntegrationType)Type_OptionSetValue.Value; }
		return null;
	}
	set
	{
...
/// <para>Schema Name: msdyn_integrationjob_AsyncOperations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_integrationjob_BulkDeleteFailures</para>
/// </summary>
...
/// <para>Schema Name: msdyn_integrationjob_MailboxTrackingFolders</para>
/// </summary>
...
/// <summary>
/// <para><b>IntegrationJobDetail (Integration Job Header)</b></para>
/// <para>Schema Name: msdyn_msdyn_integrationjob_msdyn_integrationjob</para>
/// </summary>
public List<IntegrationJobDetail> GetIntegrationJobDetails_IntegrationJobHeader (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<IntegrationJobDetail>(Service, this.Id, "msdyn_integrationjobdetail", "msdyn_integrationjobheader", Columns); }
/// <summary>
/// <para><b>IntegrationJobDetail (Integration Job Header)</b></para>
/// <para>Schema Name: msdyn_msdyn_integrationjob_msdyn_integrationjob</para>
/// </summary>
public List<IntegrationJobDetail> GetIntegrationJobDetails_IntegrationJobHeader (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<IntegrationJobDetail>(Service, this.Id, "msdyn_integrationjobdetail", "msdyn_integrationjobheader", Columns); }
/// <summary>
/// <para><b>FieldSharing (Entity instance)</b></para>
/// <para>Schema Name: msdyn_integrationjob_PrincipalObjectAttributeAccesses</para>
/// </summary>
...
/// <para>Schema Name: msdyn_integrationjob_ProcessSession</para>
/// </summary>
...
/// <para>Schema Name: msdyn_integrationjob_SyncErrors</para>
/// </summary>
...
/// <para>Schema Name: msdyn_integrationjob_UserEntityInstanceDatas</para>
/// </summary>
...
public enum eIntegrationJobStatus
{
...
{
	///<summary><para>MS Project Client</para>
	///<para>Value = 192350000</para></summary>
	[Description("MS Project Client")]
        ...
        public static class Properties
{
	...
	/// <para>msdyn_integrationjobid</para></summary>
	public const string IntegrationJobId = "msdyn_integrationjobid";
	...
	/// <summary><para>Number of packets</para>
	/// <para>msdyn_numberofpackets</para></summary>
	public const string NumberOfPackets = "msdyn_numberofpackets";
	...
	/// <summary><para>Regarding Entity</para>
	/// <para>msdyn_regardingentity</para></summary>
	public const string RegardingEntity = "msdyn_regardingentity";
	/// <summary><para>Regarding Entity Id</para>
	/// <para>msdyn_regardingentityid</para></summary>
	public const string RegardingEntityId = "msdyn_regardingentityid";
	/// <summary><para>ResponseJSON</para>
	/// <para>msdyn_responsejson</para></summary>
	public const string ResponseJSON = "msdyn_responsejson";
