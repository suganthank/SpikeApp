...
{
    [EntityLogicalNameAttribute("ribbondiff")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class RibbonDifference : BaseProxyClass
    {
        public new const string LogicalName = "ribbondiff";
        public const int ObjectTypeCode = 1130;
        public const string PrimaryIdAttribute = "ribbondiffid";
        public const string PrimaryNameAttribute = "";
        
        static RibbonDifference()
        {
            BaseProxyClass.RegisterProxyType(typeof(RibbonDifference), "ribbondiff");
        ...
        public RibbonDifference() : base(new Entity("ribbondiff")) { }
        public RibbonDifference(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<RibbonDifference>(); }
        /// <summary>
...
{
	get { return this.GetPropertyValue<Guid>("contextgroupid"); }
	set { this.SetPropertyValue<Guid>("contextgroupid", value, "ContextGroupId"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: ribbondiffuniqueid</para>
///</summary>
[AttributeLogicalNameAttribute("ribbondiffuniqueid")]
public Guid RibbonDiffUniqueId
{
	get { return this.GetPropertyValue<Guid>("ribbondiffuniqueid"); }
}
///<summary>
...
public int? Sequence
{
	...
	set { this.SetPropertyValue("sequence", (int?)value, (int)-2147483648, (int)2147483647, "Sequence"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: rdx</para>
///<para>Max Length: 1073741823 characters</para>
///</summary>
[AttributeLogicalNameAttribute("rdx")]
public string RDX
{
	get { return this.GetPropertyValue<string>("rdx"); }
	set { this.SetPropertyValue("rdx", value, 1073741823, "RDX"); }
}
/// <summary>
///Logical Name: difftype
/// </summary>
[AttributeLogicalNameAttribute("difftype")]
public eRibbonDiffType? DiffType
{
	get
	{
		if (DiffType_OptionSetValue != null) { return (eRibbonDiffType)DiffType_OptionSetValue.Value; }
		return null;
	}
}
///<summary>
///<para>Logical Name: difftype</para>
///</summary>
[AttributeLogicalNameAttribute("difftype")]
public OptionSetValue DiffType_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("difftype"); }
}
/// <summary>
...
/// <returns></returns>
public string DiffType_Text(IOrganizationService Service)
{
	return this.DiffType_OptionSetValue.GetOptionSetText(Service, this, "difftype");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
...
/// <returns></returns>
public string DiffType_Text(EnumAttributeMetadata AttributeMetadata)
{
	return AttributeMetadata.GetOptionSetText(this.DiffType_OptionSetValue.Value);
}
///<summary>
...
///<summary>
///<para>Logical Name: diffid</para>
///<para>Max Length: 200 characters</para>
///</summary>
[AttributeLogicalNameAttribute("diffid")]
public string DiffId
{
	get { return this.GetPropertyValue<string>("diffid"); }
	set { this.SetPropertyValue("diffid", value, 200, "DiffId"); }
}
///<summary>
...
/// <para>Schema Name: RibbonDiff_RibbonTabToCommandMap</para>
/// </summary>
public List<RibbonTabToCommandMapping> GetRibbonTabToCommandMap (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RibbonTabToCommandMapping>(Service, this.Id, "ribbontabtocommandmap", "ribbondiffid", Columns); }
/// <summary>
/// <para><b>RibbonTabToCommandMapping ()</b></para>
/// <para>Schema Name: RibbonDiff_RibbonTabToCommandMap</para>
/// </summary>
public List<RibbonTabToCommandMapping> GetRibbonTabToCommandMap (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RibbonTabToCommandMapping>(Service, this.Id, "ribbontabtocommandmap", "ribbondiffid", Columns); }
/// <summary>
/// <para><b>UserEntityInstanceData (Object Id)</b></para>
/// <para>Schema Name: userentityinstancedata_ribbondiff</para>
/// </summary>
        ...
        public enum eRibbonDiffType
{
	...
	[Description("Tab")]
	Tab = 1, 
	///<summary><para>Layout Template</para>
        ...
        public static class Properties
{
	...
	/// <summary><para>ribbondiffuniqueid</para>
	/// <para>ribbondiffuniqueid</para></summary>
	...
	/// <summary><para>rdx</para>
	/// <para>rdx</para></summary>
	public const string RDX = "rdx";
	/// <summary><para>difftype</para>
	/// <para>difftype</para></summary>
	public const string DiffType = "difftype";
	/// <summary><para>entity</para>
	/// <para>entity</para></summary>
	public const string Entity = "entity";
	/// <summary><para>diffid</para>
	/// <para>diffid</para></summary>
	...
	public const string PrimaryKeyId = "ribbondiffid";
