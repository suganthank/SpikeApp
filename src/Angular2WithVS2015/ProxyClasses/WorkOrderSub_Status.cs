...
{
    [EntityLogicalNameAttribute("msdyn_workordersubstatus")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class WorkOrderSub_Status : BaseProxyClass
    {
        public new const string LogicalName = "msdyn_workordersubstatus";
        public const int ObjectTypeCode = 10181;
        public const string PrimaryIdAttribute = "msdyn_workordersubstatusid";
        public const string PrimaryNameAttribute = "msdyn_name";
        
        static WorkOrderSub_Status()
        {
            BaseProxyClass.RegisterProxyType(typeof(WorkOrderSub_Status), "msdyn_workordersubstatus");
        ...
        public WorkOrderSub_Status() : base(new Entity("msdyn_workordersubstatus")) { }
        public WorkOrderSub_Status(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<WorkOrderSub_Status>(); }
        /// <summary>
...
///<para>Logical Name: msdyn_workordersubstatusid</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_workordersubstatusid")]
public Guid WorkOrderSub_statusId
{
	get
	{
		return this.Id;
...
/// <para>Schema Name: msdyn_workordersubstatus_Annotations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_workordersubstatus_AsyncOperations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_workordersubstatus_BulkDeleteFailures</para>
/// </summary>
...
/// <para>Schema Name: msdyn_workordersubstatus_DuplicateBaseRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_workordersubstatus_DuplicateMatchingRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_workordersubstatus_MailboxTrackingFolders</para>
/// </summary>
...
/// <summary>
/// <para><b>WorkOrder (Sub-Status)</b></para>
/// <para>Schema Name: msdyn_msdyn_workordersubstatus_msdyn_workorder_Status</para>
/// </summary>
public List<WorkOrder> GetWorkOrders_Sub_Status (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<WorkOrder>(Service, this.Id, "msdyn_workorder", "msdyn_substatus", Columns); }
/// <summary>
/// <para><b>WorkOrder (Sub-Status)</b></para>
/// <para>Schema Name: msdyn_msdyn_workordersubstatus_msdyn_workorder_Status</para>
/// </summary>
public List<WorkOrder> GetWorkOrders_Sub_Status (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<WorkOrder>(Service, this.Id, "msdyn_workorder", "msdyn_substatus", Columns); }
/// <summary>
/// <para><b>FieldSharing (Entity instance)</b></para>
/// <para>Schema Name: msdyn_workordersubstatus_PrincipalObjectAttributeAccesses</para>
/// </summary>
...
/// <para>Schema Name: msdyn_workordersubstatus_ProcessSession</para>
/// </summary>
...
/// <para>Schema Name: msdyn_workordersubstatus_SyncErrors</para>
/// </summary>
...
/// <para>Schema Name: msdyn_workordersubstatus_UserEntityInstanceDatas</para>
/// </summary>
        ...
        public static class Properties
{
	...
	/// <para>msdyn_workordersubstatusid</para></summary>
	public const string WorkOrderSub_statusId = "msdyn_workordersubstatusid";
}
