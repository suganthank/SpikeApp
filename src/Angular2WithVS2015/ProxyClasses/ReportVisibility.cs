...
namespace ProxyClasses
{
    ...
    public partial class ReportVisibility : BaseProxyClass
    {
        public new const string LogicalName = "reportvisibility";
        public const int ObjectTypeCode = 9103;
        public const string PrimaryIdAttribute = "reportvisibilityid";
        public const string PrimaryNameAttribute = "";
        
        static ReportVisibility()
        {
            BaseProxyClass.RegisterProxyType(typeof(ReportVisibility), "reportvisibility");
        ...
        public ReportVisibility() : base(new Entity("reportvisibility")) { }
        public ReportVisibility(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<ReportVisibility>(); }
        /// <summary>
...
///<summary>
///<para>Logical Name: reportvisibilityidunique</para>
///</summary>
[AttributeLogicalNameAttribute("reportvisibilityidunique")]
public Guid ReportVisibilityIdUnique
{
	get { return this.GetPropertyValue<Guid>("reportvisibilityidunique"); }
}
///<summary>
...
///<para>Logical Name: reportvisibilityid</para>
///</summary>
...
public eVisibility? Visibility
{
	get
	{
		if (Visibility_OptionSetValue != null) { return (eVisibility)Visibility_OptionSetValue.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.Visibility_OptionSetValue = new OptionSetValue((int)value); }
		else this.Visibility_OptionSetValue = null;
	}
}
///<summary>
///<para>Logical Name: visibilitycode</para>
///</summary>
[AttributeLogicalNameAttribute("visibilitycode")]
public OptionSetValue Visibility_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("visibilitycode"); }
	set { this.SetPropertyValue<OptionSetValue>("visibilitycode", value, "Visibility_OptionSetValue"); }
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
/// <param name="Service">CRM Organization Service</param>
/// <returns></returns>
public string Visibility_Text(IOrganizationService Service)
{
	return this.Visibility_OptionSetValue.GetOptionSetText(Service, this, "visibilitycode");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
/// <param name="AttributeMetadata">The attribute metadata previously retrieved using the 'GetAttributeMetadata' extension method on the IOrganizationService object.</param>
/// <returns></returns>
public string Visibility_Text(EnumAttributeMetadata AttributeMetadata)
{
	return AttributeMetadata.GetOptionSetText(this.Visibility_OptionSetValue.Value);
}


        /// <summary>
/// <para><b>UserEntityInstanceData (Object Id)</b></para>
/// <para>Schema Name: userentityinstancedata_reportvisibility</para>
/// </summary>
...
{
	///<summary><para>Reports area</para>
	///<para>Value = 1</para></summary>
	[Description("Reports area")]
	ReportsArea = 1, 
	///<summary><para>Forms for related record types</para>
	///<para>Value = 2</para></summary>
	[Description("Forms for related record types")]
	FormsForRelatedRecordTypes = 2, 
	///<summary><para>Lists for related record types</para>
	///<para>Value = 3</para></summary>
        ...
        public static class Properties
{
	...
	/// <summary><para>reportvisibilityidunique</para>
	/// <para>reportvisibilityidunique</para></summary>
	...
	/// <para>reportvisibilityid</para></summary>
	...
	/// <summary><para>Visibility</para>
	/// <para>visibilitycode</para></summary>
