...
public string AccountName
{
	...
	set { this.SetPropertyValue("name", value, 160, "AccountName"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: msdyn_externalaccountid</para>
///<para>Max Length: 100 characters</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_externalaccountid")]
public string ExternalID
{
	get { return this.GetPropertyValue<string>("msdyn_externalaccountid"); }
	set { this.SetPropertyValue("msdyn_externalaccountid", value, 100, "ExternalID"); }
}
///<summary>
///<para>Logical Name: int_facebook</para>
///<para>Max Length: 100 characters</para>
///</summary>
[AttributeLogicalNameAttribute("int_facebook")]
public string Facebook
{
	get { return this.GetPropertyValue<string>("int_facebook"); }
	set { this.SetPropertyValue("int_facebook", value, 100, "Facebook"); }
}
///<summary>
...
public int? No_OfEmployees
{
	...
	set { this.SetPropertyValue("numberofemployees", (int?)value, (int)0, (int)1000000000, "No_OfEmployees"); }
}
///<summary>
...
public string PrimaryTwitterID
{
	...
	set { this.SetPropertyValue("primarytwitterid", value, 20, "PrimaryTwitterID"); }
}
///<summary>
...
public EntityReference ProductPriceList
{
	get { return this.GetPropertyValue<EntityReference>("defaultpricelevelid"); }
	set { this.SetPropertyValue<EntityReference>("defaultpricelevelid", value, "ProductPriceList"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: msdyn_taxexempt</para>
///<para>True = Yes</para>
///<para>False = No</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_taxexempt")]
public bool? TaxExempt
{
	get { return this.GetPropertyValue<bool?>("msdyn_taxexempt"); }
	set { this.SetPropertyValue<bool?>("msdyn_taxexempt", value, "TaxExempt"); }
}
///<summary>
///<para>Logical Name: msdyn_taxexemptnumber</para>
///<para>Max Length: 20 characters</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_taxexemptnumber")]
public string TaxExemptNumber
{
	get { return this.GetPropertyValue<string>("msdyn_taxexemptnumber"); }
	set { this.SetPropertyValue("msdyn_taxexemptnumber", value, 20, "TaxExemptNumber"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: msdyn_travelcharge</para>
///<para>Minimum Value: 0</para>
///<para>Maximum Value: 1000000000</para>
///<para>Precision: 2</para>
///</summary>
public decimal? TravelCharge
{
	get
	{
		if (TravelChargeMoney != null) { return TravelChargeMoney.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.TravelChargeMoney = new Money(value.Value); }
		else this.TravelChargeMoney = null;
	}
}
///<summary>
///<para>Logical Name: msdyn_travelcharge</para>
...
///<para>Precision: 2</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_travelcharge")]
public Money TravelChargeMoney
{
	get { return this.GetPropertyValue<Money>("msdyn_travelcharge"); }
	set { this.SetPropertyValue("msdyn_travelcharge", (Money)value, (decimal)0, (decimal)1000000000, "TravelChargeMoney"); }
}
///<summary>
///<para>Logical Name: msdyn_travelcharge_base</para>
///<para>Minimum Value: -922337203685477</para>
///<para>Maximum Value: 922337203685477</para>
///<para>Precision: 2</para>
///</summary>
public decimal? TravelCharge_Base
{
	get
	{
		if (TravelCharge_BaseMoney != null) { return TravelCharge_BaseMoney.Value; }
		return null;
	}
}
///<summary>
...
///<para>Precision: 2</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_travelcharge_base")]
public Money TravelCharge_BaseMoney
{
	get { return this.GetPropertyValue<Money>("msdyn_travelcharge_base"); }
}
/// <summary>
///Logical Name: msdyn_travelchargetype
/// </summary>
[AttributeLogicalNameAttribute("msdyn_travelchargetype")]
public eTravelChargeType? TravelChargeType
{
	get
	{
		if (TravelChargeType_OptionSetValue != null) { return (eTravelChargeType)TravelChargeType_OptionSetValue.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.TravelChargeType_OptionSetValue = new OptionSetValue((int)value); }
		else this.TravelChargeType_OptionSetValue = null;
	}
}
///<summary>
///<para>Logical Name: msdyn_travelchargetype</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_travelchargetype")]
public OptionSetValue TravelChargeType_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("msdyn_travelchargetype"); }
	set { this.SetPropertyValue<OptionSetValue>("msdyn_travelchargetype", value, "TravelChargeType_OptionSetValue"); }
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
/// <param name="Service">CRM Organization Service</param>
/// <returns></returns>
public string TravelChargeType_Text(IOrganizationService Service)
{
	return this.TravelChargeType_OptionSetValue.GetOptionSetText(Service, this, "msdyn_travelchargetype");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
/// <param name="AttributeMetadata">The attribute metadata previously retrieved using the 'GetAttributeMetadata' extension method on the IOrganizationService object.</param>
/// <returns></returns>
public string TravelChargeType_Text(EnumAttributeMetadata AttributeMetadata)
{
	return AttributeMetadata.GetOptionSetText(this.TravelChargeType_OptionSetValue.Value);
}
///<summary>
...
///<summary>
///<para>Logical Name: int_twitter</para>
///<para>Max Length: 100 characters</para>
///</summary>
[AttributeLogicalNameAttribute("int_twitter")]
public string Twitter
{
	get { return this.GetPropertyValue<string>("int_twitter"); }
	set { this.SetPropertyValue("int_twitter", value, 100, "Twitter"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: msdyn_workorderinstructions</para>
///<para>Max Length: 4000 characters</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_workorderinstructions")]
public string WorkOrderInstructions
{
	get { return this.GetPropertyValue<string>("msdyn_workorderinstructions"); }
	set { this.SetPropertyValue("msdyn_workorderinstructions", value, 4000, "WorkOrderInstructions"); }
}
///<summary>
...
/// <summary>
/// <para>Billed Accounts</para>
/// <para><b>Account (Billing Account)</b></para>
/// <para>Schema Name: msdyn_account_account_BillingAccount</para>
/// </summary>
public List<Account> GetBilledAccounts_BillingAccount (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Account>(Service, this.Id, "account", "msdyn_billingaccount", Columns); }
/// <summary>
/// <para>Billed Accounts</para>
/// <para><b>Account (Billing Account)</b></para>
/// <para>Schema Name: msdyn_account_account_BillingAccount</para>
/// </summary>
public List<Account> GetBilledAccounts_BillingAccount (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Account>(Service, this.Id, "account", "msdyn_billingaccount", Columns); }
/// <summary>
...
/// <summary>
/// <para><b>BookableResource (Account)</b></para>
/// <para>Schema Name: account_bookableresource_AccountId</para>
/// </summary>
public List<BookableResource> GetBookableResources_Account (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<BookableResource>(Service, this.Id, "bookableresource", "accountid", Columns); }
/// <summary>
/// <para><b>BookableResource (Account)</b></para>
/// <para>Schema Name: account_bookableresource_AccountId</para>
/// </summary>
public List<BookableResource> GetBookableResources_Account (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<BookableResource>(Service, this.Id, "bookableresource", "accountid", Columns); }
/// <summary>
...
/// <summary>
/// <para><b>Contract (Bill To Customer)</b></para>
/// <para>Schema Name: contract_billingcustomer_accounts</para>
/// </summary>
public List<Contract> GetContracts_BillToCustomer (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Contract>(Service, this.Id, "contract", "billingcustomerid", Columns); }
/// <summary>
/// <para><b>Contract (Bill To Customer)</b></para>
/// <para>Schema Name: contract_billingcustomer_accounts</para>
/// </summary>
public List<Contract> GetContracts_BillToCustomer (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Contract>(Service, this.Id, "contract", "billingcustomerid", Columns); }
/// <summary>
/// <para><b>Contract (Customer)</b></para>
/// <para>Schema Name: contract_customer_accounts</para>
/// </summary>
public List<Contract> GetContracts_Customer (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Contract>(Service, this.Id, "contract", "customerid", Columns); }
/// <summary>
/// <para><b>Contract (Customer)</b></para>
/// <para>Schema Name: contract_customer_accounts</para>
/// </summary>
public List<Contract> GetContracts_Customer (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Contract>(Service, this.Id, "contract", "customerid", Columns); }
/// <summary>
/// <para><b>ContractLine (Customer)</b></para>
/// <para>Schema Name: contractlineitem_customer_accounts</para>
/// </summary>
public List<ContractLine> GetContractLines_Customer (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ContractLine>(Service, this.Id, "contractdetail", "customerid", Columns); }
/// <summary>
/// <para><b>ContractLine (Customer)</b></para>
/// <para>Schema Name: contractlineitem_customer_accounts</para>
/// </summary>
public List<ContractLine> GetContractLines_Customer (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ContractLine>(Service, this.Id, "contractdetail", "customerid", Columns); }
/// <summary>
/// <para><b>Address (Parent)</b></para>
/// <para>Schema Name: Account_CustomerAddress</para>
/// </summary>
public List<Address> GetAddresses_Parent (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Address>(Service, this.Id, "customeraddress", "parentid", Columns); }
/// <summary>
/// <para><b>Address (Parent)</b></para>
/// <para>Schema Name: Account_CustomerAddress</para>
/// </summary>
public List<Address> GetAddresses_Parent (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Address>(Service, this.Id, "customeraddress", "parentid", Columns); }
/// <summary>
/// <para><b>OpportunityRelationship (Customer)</b></para>
/// <para>Schema Name: account_customer_opportunity_roles</para>
/// </summary>
public List<OpportunityRelationship> GetOpportunityRelationships_Customer (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OpportunityRelationship>(Service, this.Id, "customeropportunityrole", "customerid", Columns); }
/// <summary>
/// <para><b>OpportunityRelationship (Customer)</b></para>
/// <para>Schema Name: account_customer_opportunity_roles</para>
/// </summary>
public List<OpportunityRelationship> GetOpportunityRelationships_Customer (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OpportunityRelationship>(Service, this.Id, "customeropportunityrole", "customerid", Columns); }
/// <summary>
/// <para><b>CustomerRelationship (Party 1)</b></para>
/// <para>Schema Name: account_customer_relationship_customer</para>
/// </summary>
public List<CustomerRelationship> GetCustomerRelationships_Party1 (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<CustomerRelationship>(Service, this.Id, "customerrelationship", "customerid", Columns); }
/// <summary>
/// <para><b>CustomerRelationship (Party 1)</b></para>
/// <para>Schema Name: account_customer_relationship_customer</para>
/// </summary>
public List<CustomerRelationship> GetCustomerRelationships_Party1 (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<CustomerRelationship>(Service, this.Id, "customerrelationship", "customerid", Columns); }
/// <summary>
/// <para><b>CustomerRelationship (Party 2)</b></para>
/// <para>Schema Name: account_customer_relationship_partner</para>
/// </summary>
public List<CustomerRelationship> GetCustomerRelationships_Party2 (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<CustomerRelationship>(Service, this.Id, "customerrelationship", "partnerid", Columns); }
/// <summary>
/// <para><b>CustomerRelationship (Party 2)</b></para>
/// <para>Schema Name: account_customer_relationship_partner</para>
/// </summary>
public List<CustomerRelationship> GetCustomerRelationships_Party2 (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<CustomerRelationship>(Service, this.Id, "customerrelationship", "partnerid", Columns); }
/// <summary>
...
/// <summary>
/// <para><b>Email (Senders Account)</b></para>
/// <para>Schema Name: Account_Email_SendersAccount</para>
/// </summary>
public List<Email> GetEmailMessages_SendersAccount (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Email>(Service, this.Id, "email", "sendersaccount", Columns); }
/// <summary>
/// <para><b>Email (Senders Account)</b></para>
/// <para>Schema Name: Account_Email_SendersAccount</para>
/// </summary>
public List<Email> GetEmailMessages_SendersAccount (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Email>(Service, this.Id, "email", "sendersaccount", Columns); }
/// <summary>
...
/// <summary>
/// <para><b>Entitlement (Account)</b></para>
/// <para>Schema Name: account_entitlement_Account</para>
/// </summary>
public List<Entitlement> GetEntitlements_Account (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Entitlement>(Service, this.Id, "entitlement", "accountid", Columns); }
/// <summary>
/// <para><b>Entitlement (Account)</b></para>
/// <para>Schema Name: account_entitlement_Account</para>
/// </summary>
public List<Entitlement> GetEntitlements_Account (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Entitlement>(Service, this.Id, "entitlement", "accountid", Columns); }
/// <summary>
/// <para><b>Entitlement (Customer)</b></para>
/// <para>Schema Name: account_entitlement_Customer</para>
/// </summary>
public List<Entitlement> GetEntitlements_Customer (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Entitlement>(Service, this.Id, "entitlement", "customerid", Columns); }
/// <summary>
/// <para><b>Entitlement (Customer)</b></para>
/// <para>Schema Name: account_entitlement_Customer</para>
/// </summary>
public List<Entitlement> GetEntitlements_Customer (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Entitlement>(Service, this.Id, "entitlement", "customerid", Columns); }
/// <summary>
...
/// <summary>
/// <para><b>@Case (Customer)</b></para>
/// <para>Schema Name: incident_customer_accounts</para>
/// </summary>
public List<@Case> GetCases_Customer (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<@Case>(Service, this.Id, "incident", "customerid", Columns); }
/// <summary>
/// <para><b>@Case (Customer)</b></para>
/// <para>Schema Name: incident_customer_accounts</para>
/// </summary>
public List<@Case> GetCases_Customer (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<@Case>(Service, this.Id, "incident", "customerid", Columns); }
/// <summary>
/// <para><b>Invoice (Customer)</b></para>
/// <para>Schema Name: invoice_customer_accounts</para>
/// </summary>
public List<Invoice> GetInvoices_Customer (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Invoice>(Service, this.Id, "invoice", "customerid", Columns); }
/// <summary>
/// <para><b>Invoice (Customer)</b></para>
/// <para>Schema Name: invoice_customer_accounts</para>
/// </summary>
public List<Invoice> GetInvoices_Customer (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Invoice>(Service, this.Id, "invoice", "customerid", Columns); }
/// <summary>
/// <para><b>Lead (Customer)</b></para>
/// <para>Schema Name: lead_customer_accounts</para>
/// </summary>
public List<Lead> GetLeads_Customer (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Lead>(Service, this.Id, "lead", "customerid", Columns); }
/// <summary>
/// <para><b>Lead (Customer)</b></para>
/// <para>Schema Name: lead_customer_accounts</para>
/// </summary>
public List<Lead> GetLeads_Customer (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Lead>(Service, this.Id, "lead", "customerid", Columns); }
/// <summary>
/// <para><b>Lead (Parent Account for lead)</b></para>
/// <para>Schema Name: lead_parent_account</para>
/// </summary>
public List<Lead> GetLeads_ParentAccountForLead (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Lead>(Service, this.Id, "lead", "parentaccountid", Columns); }
/// <summary>
/// <para><b>Lead (Parent Account for lead)</b></para>
/// <para>Schema Name: lead_parent_account</para>
/// </summary>
public List<Lead> GetLeads_ParentAccountForLead (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Lead>(Service, this.Id, "lead", "parentaccountid", Columns); }
/// <summary>
...
/// <summary>
/// <para><b>AccountProjectPriceList (Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_accountpricelist_Account</para>
/// </summary>
public List<AccountProjectPriceList> GetProjectPriceLists_Account (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<AccountProjectPriceList>(Service, this.Id, "msdyn_accountpricelist", "msdyn_account", Columns); }
/// <summary>
/// <para><b>AccountProjectPriceList (Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_accountpricelist_Account</para>
/// </summary>
public List<AccountProjectPriceList> GetProjectPriceLists_Account (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<AccountProjectPriceList>(Service, this.Id, "msdyn_accountpricelist", "msdyn_account", Columns); }
/// <summary>
/// <para><b>Actual (Customer ID)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_actual_AccountCustomer</para>
/// </summary>
public List<Actual> GetActuals_CustomerID (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Actual>(Service, this.Id, "msdyn_actual", "msdyn_accountcustomer", Columns); }
/// <summary>
/// <para><b>Actual (Customer ID)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_actual_AccountCustomer</para>
/// </summary>
public List<Actual> GetActuals_CustomerID (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Actual>(Service, this.Id, "msdyn_actual", "msdyn_accountcustomer", Columns); }
/// <summary>
/// <para><b>Actual (Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_actual_AccountVendor</para>
/// </summary>
public List<Actual> GetActuals_Vendor (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Actual>(Service, this.Id, "msdyn_actual", "msdyn_accountvendor", Columns); }
/// <summary>
/// <para><b>Actual (Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_actual_AccountVendor</para>
/// </summary>
public List<Actual> GetActuals_Vendor (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Actual>(Service, this.Id, "msdyn_actual", "msdyn_accountvendor", Columns); }
/// <summary>
/// <para><b>Actual (Service Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_actual_ServiceAccount</para>
/// </summary>
public List<Actual> GetActuals_ServiceAccount (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Actual>(Service, this.Id, "msdyn_actual", "msdyn_serviceaccount", Columns); }
/// <summary>
/// <para><b>Actual (Service Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_actual_ServiceAccount</para>
/// </summary>
public List<Actual> GetActuals_ServiceAccount (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Actual>(Service, this.Id, "msdyn_actual", "msdyn_serviceaccount", Columns); }
/// <summary>
/// <para>Billed Agreements</para>
/// <para><b>Agreement (Billing Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_agreement_BillingAccount</para>
/// </summary>
public List<Agreement> GetBilledAgreements_BillingAccount (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Agreement>(Service, this.Id, "msdyn_agreement", "msdyn_billingaccount", Columns); }
/// <summary>
/// <para>Billed Agreements</para>
/// <para><b>Agreement (Billing Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_agreement_BillingAccount</para>
/// </summary>
public List<Agreement> GetBilledAgreements_BillingAccount (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Agreement>(Service, this.Id, "msdyn_agreement", "msdyn_billingaccount", Columns); }
/// <summary>
/// <para><b>Agreement (Service Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_agreement_ServiceAccount</para>
/// </summary>
public List<Agreement> GetAgreements_ServiceAccount (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Agreement>(Service, this.Id, "msdyn_agreement", "msdyn_serviceaccount", Columns); }
/// <summary>
/// <para><b>Agreement (Service Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_agreement_ServiceAccount</para>
/// </summary>
public List<Agreement> GetAgreements_ServiceAccount (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Agreement>(Service, this.Id, "msdyn_agreement", "msdyn_serviceaccount", Columns); }
/// <summary>
/// <para><b>Approval (Regarding)</b></para>
/// <para>Schema Name: account_msdyn_approvals</para>
/// </summary>
...
/// <para>Schema Name: account_msdyn_bookingalerts</para>
/// </summary>
...
/// <summary>
/// <para><b>CustomerAsset (Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_customerasset_Account</para>
/// </summary>
public List<CustomerAsset> GetCustomerAssets_Account (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<CustomerAsset>(Service, this.Id, "msdyn_customerasset", "msdyn_account", Columns); }
/// <summary>
/// <para><b>CustomerAsset (Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_customerasset_Account</para>
/// </summary>
public List<CustomerAsset> GetCustomerAssets_Account (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<CustomerAsset>(Service, this.Id, "msdyn_customerasset", "msdyn_account", Columns); }
/// <summary>
/// <para><b>EstimateLine (Customer)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_estimateline_AccountCustomer</para>
/// </summary>
public List<EstimateLine> GetEstimateLines_Customer (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<EstimateLine>(Service, this.Id, "msdyn_estimateline", "msdyn_accountcustomer", Columns); }
/// <summary>
/// <para><b>EstimateLine (Customer)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_estimateline_AccountCustomer</para>
/// </summary>
public List<EstimateLine> GetEstimateLines_Customer (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<EstimateLine>(Service, this.Id, "msdyn_estimateline", "msdyn_accountcustomer", Columns); }
/// <summary>
/// <para><b>EstimateLine (Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_estimateline_AccountVendor</para>
/// </summary>
public List<EstimateLine> GetEstimateLines_Vendor (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<EstimateLine>(Service, this.Id, "msdyn_estimateline", "msdyn_accountvendor", Columns); }
/// <summary>
/// <para><b>EstimateLine (Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_estimateline_AccountVendor</para>
/// </summary>
public List<EstimateLine> GetEstimateLines_Vendor (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<EstimateLine>(Service, this.Id, "msdyn_estimateline", "msdyn_accountvendor", Columns); }
/// <summary>
/// <para><b>Fact (Customer)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_fact_AccountCustomer</para>
/// </summary>
public List<Fact> GetFacts_Customer (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Fact>(Service, this.Id, "msdyn_fact", "msdyn_accountcustomer", Columns); }
/// <summary>
/// <para><b>Fact (Customer)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_fact_AccountCustomer</para>
/// </summary>
public List<Fact> GetFacts_Customer (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Fact>(Service, this.Id, "msdyn_fact", "msdyn_accountcustomer", Columns); }
/// <summary>
/// <para><b>Fact (Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_fact_AccountVendor</para>
/// </summary>
public List<Fact> GetFacts_Vendor (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Fact>(Service, this.Id, "msdyn_fact", "msdyn_accountvendor", Columns); }
/// <summary>
/// <para><b>Fact (Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_fact_AccountVendor</para>
/// </summary>
public List<Fact> GetFacts_Vendor (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Fact>(Service, this.Id, "msdyn_fact", "msdyn_accountvendor", Columns); }
/// <summary>
/// <para><b>InvoiceLineDetail (Customer)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_invoicelinetransaction_AccountCustomer</para>
/// </summary>
public List<InvoiceLineDetail> GetInvoiceLineDetails_Customer (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<InvoiceLineDetail>(Service, this.Id, "msdyn_invoicelinetransaction", "msdyn_accountcustomer", Columns); }
/// <summary>
/// <para><b>InvoiceLineDetail (Customer)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_invoicelinetransaction_AccountCustomer</para>
/// </summary>
public List<InvoiceLineDetail> GetInvoiceLineDetails_Customer (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<InvoiceLineDetail>(Service, this.Id, "msdyn_invoicelinetransaction", "msdyn_accountcustomer", Columns); }
/// <summary>
/// <para><b>InvoiceLineDetail (Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_invoicelinetransaction_AccountVendor</para>
/// </summary>
public List<InvoiceLineDetail> GetInvoiceLineDetails_Vendor (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<InvoiceLineDetail>(Service, this.Id, "msdyn_invoicelinetransaction", "msdyn_accountvendor", Columns); }
/// <summary>
/// <para><b>InvoiceLineDetail (Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_invoicelinetransaction_AccountVendor</para>
/// </summary>
public List<InvoiceLineDetail> GetInvoiceLineDetails_Vendor (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<InvoiceLineDetail>(Service, this.Id, "msdyn_invoicelinetransaction", "msdyn_accountvendor", Columns); }
/// <summary>
/// <para><b>JournalLine (Customer)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_journalline_AccountCustomer</para>
/// </summary>
public List<JournalLine> GetJournalLines_Customer (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<JournalLine>(Service, this.Id, "msdyn_journalline", "msdyn_accountcustomer", Columns); }
/// <summary>
/// <para><b>JournalLine (Customer)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_journalline_AccountCustomer</para>
/// </summary>
public List<JournalLine> GetJournalLines_Customer (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<JournalLine>(Service, this.Id, "msdyn_journalline", "msdyn_accountcustomer", Columns); }
/// <summary>
/// <para><b>JournalLine (Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_journalline_AccountVendor</para>
/// </summary>
public List<JournalLine> GetJournalLines_Vendor (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<JournalLine>(Service, this.Id, "msdyn_journalline", "msdyn_accountvendor", Columns); }
/// <summary>
/// <para><b>JournalLine (Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_journalline_AccountVendor</para>
/// </summary>
public List<JournalLine> GetJournalLines_Vendor (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<JournalLine>(Service, this.Id, "msdyn_journalline", "msdyn_accountvendor", Columns); }
/// <summary>
/// <para><b>OpportunityLineDetail (Customer)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_opportunitylinetransaction_AccountCustomer</para>
/// </summary>
public List<OpportunityLineDetail> GetOpportunityLineDetails_Customer (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OpportunityLineDetail>(Service, this.Id, "msdyn_opportunitylinetransaction", "msdyn_accountcustomer", Columns); }
/// <summary>
/// <para><b>OpportunityLineDetail (Customer)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_opportunitylinetransaction_AccountCustomer</para>
/// </summary>
public List<OpportunityLineDetail> GetOpportunityLineDetails_Customer (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OpportunityLineDetail>(Service, this.Id, "msdyn_opportunitylinetransaction", "msdyn_accountcustomer", Columns); }
/// <summary>
/// <para><b>OpportunityLineDetail (Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_opportunitylinetransaction_AccountVendor</para>
/// </summary>
public List<OpportunityLineDetail> GetOpportunityLineDetails_Vendor (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OpportunityLineDetail>(Service, this.Id, "msdyn_opportunitylinetransaction", "msdyn_accountvendor", Columns); }
/// <summary>
/// <para><b>OpportunityLineDetail (Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_opportunitylinetransaction_AccountVendor</para>
/// </summary>
public List<OpportunityLineDetail> GetOpportunityLineDetails_Vendor (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OpportunityLineDetail>(Service, this.Id, "msdyn_opportunitylinetransaction", "msdyn_accountvendor", Columns); }
/// <summary>
/// <para><b>ProjectContractLineDetail (Customer)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_orderlinetransaction_AccountCustomer</para>
/// </summary>
public List<ProjectContractLineDetail> GetProjectContractLineDetails_Customer (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ProjectContractLineDetail>(Service, this.Id, "msdyn_orderlinetransaction", "msdyn_accountcustomer", Columns); }
/// <summary>
/// <para><b>ProjectContractLineDetail (Customer)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_orderlinetransaction_AccountCustomer</para>
/// </summary>
public List<ProjectContractLineDetail> GetProjectContractLineDetails_Customer (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ProjectContractLineDetail>(Service, this.Id, "msdyn_orderlinetransaction", "msdyn_accountcustomer", Columns); }
/// <summary>
/// <para><b>ProjectContractLineDetail (Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_orderlinetransaction_AccountVendor</para>
/// </summary>
public List<ProjectContractLineDetail> GetProjectContractLineDetails_Vendor (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ProjectContractLineDetail>(Service, this.Id, "msdyn_orderlinetransaction", "msdyn_accountvendor", Columns); }
/// <summary>
/// <para><b>ProjectContractLineDetail (Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_orderlinetransaction_AccountVendor</para>
/// </summary>
public List<ProjectContractLineDetail> GetProjectContractLineDetails_Vendor (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ProjectContractLineDetail>(Service, this.Id, "msdyn_orderlinetransaction", "msdyn_accountvendor", Columns); }
/// <summary>
/// <para><b>Payment (Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_payment_Account</para>
/// </summary>
public List<Payment> GetPayments_Account (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Payment>(Service, this.Id, "msdyn_payment", "msdyn_account", Columns); }
/// <summary>
/// <para><b>Payment (Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_payment_Account</para>
/// </summary>
public List<Payment> GetPayments_Account (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Payment>(Service, this.Id, "msdyn_payment", "msdyn_account", Columns); }
/// <summary>
/// <para><b>Project (Customer)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_project_Customer</para>
/// </summary>
public List<Project> GetProjects_Customer (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Project>(Service, this.Id, "msdyn_project", "msdyn_customer", Columns); }
/// <summary>
/// <para><b>Project (Customer)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_project_Customer</para>
/// </summary>
public List<Project> GetProjects_Customer (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Project>(Service, this.Id, "msdyn_project", "msdyn_customer", Columns); }
/// <summary>
/// <para><b>PurchaseOrder (Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_purchaseorder_Vendor</para>
/// </summary>
public List<PurchaseOrder> GetPurchaseOrders_Vendor (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<PurchaseOrder>(Service, this.Id, "msdyn_purchaseorder", "msdyn_vendor", Columns); }
/// <summary>
/// <para><b>PurchaseOrder (Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_purchaseorder_Vendor</para>
/// </summary>
public List<PurchaseOrder> GetPurchaseOrders_Vendor (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<PurchaseOrder>(Service, this.Id, "msdyn_purchaseorder", "msdyn_vendor", Columns); }
/// <summary>
/// <para><b>QuoteLineDetail (Customer)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_quotelinetransaction_AccountCustomer</para>
/// </summary>
public List<QuoteLineDetail> GetQuoteLineDetail_Customer (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<QuoteLineDetail>(Service, this.Id, "msdyn_quotelinetransaction", "msdyn_accountcustomer", Columns); }
/// <summary>
/// <para><b>QuoteLineDetail (Customer)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_quotelinetransaction_AccountCustomer</para>
/// </summary>
public List<QuoteLineDetail> GetQuoteLineDetail_Customer (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<QuoteLineDetail>(Service, this.Id, "msdyn_quotelinetransaction", "msdyn_accountcustomer", Columns); }
/// <summary>
/// <para><b>QuoteLineDetail (Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_quotelinetransaction_AccountVendor</para>
/// </summary>
public List<QuoteLineDetail> GetQuoteLineDetail_Vendor (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<QuoteLineDetail>(Service, this.Id, "msdyn_quotelinetransaction", "msdyn_accountvendor", Columns); }
/// <summary>
/// <para><b>QuoteLineDetail (Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_quotelinetransaction_AccountVendor</para>
/// </summary>
public List<QuoteLineDetail> GetQuoteLineDetail_Vendor (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<QuoteLineDetail>(Service, this.Id, "msdyn_quotelinetransaction", "msdyn_accountvendor", Columns); }
/// <summary>
/// <para>Resource Preferences</para>
/// <para><b>RequirementResourcePreference (Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_requirementresourcepreference_Account</para>
/// </summary>
public List<RequirementResourcePreference> GetResourcePreferences_Account (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RequirementResourcePreference>(Service, this.Id, "msdyn_requirementresourcepreference", "msdyn_account", Columns); }
/// <summary>
/// <para>Resource Preferences</para>
/// <para><b>RequirementResourcePreference (Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_requirementresourcepreference_Account</para>
/// </summary>
public List<RequirementResourcePreference> GetResourcePreferences_Account (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RequirementResourcePreference>(Service, this.Id, "msdyn_requirementresourcepreference", "msdyn_account", Columns); }
/// <summary>
/// <para>Billing RMAs</para>
/// <para><b>RMA (Billing Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_rma_BillingAccount</para>
/// </summary>
public List<RMA> GetBillingRMAs_BillingAccount (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RMA>(Service, this.Id, "msdyn_rma", "msdyn_billingaccount", Columns); }
/// <summary>
/// <para>Billing RMAs</para>
/// <para><b>RMA (Billing Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_rma_BillingAccount</para>
/// </summary>
public List<RMA> GetBillingRMAs_BillingAccount (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RMA>(Service, this.Id, "msdyn_rma", "msdyn_billingaccount", Columns); }
/// <summary>
/// <para>RMAs</para>
/// <para><b>RMA (Service Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_rma_ServiceAccount</para>
/// </summary>
public List<RMA> GetRMAs_ServiceAccount (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RMA>(Service, this.Id, "msdyn_rma", "msdyn_serviceaccount", Columns); }
/// <summary>
/// <para>RMAs</para>
/// <para><b>RMA (Service Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_rma_ServiceAccount</para>
/// </summary>
public List<RMA> GetRMAs_ServiceAccount (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RMA>(Service, this.Id, "msdyn_rma", "msdyn_serviceaccount", Columns); }
/// <summary>
/// <para>Change ownership</para>
/// <para><b>RMAProduct (Change ownership)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_rmaproduct_Changeownership</para>
/// </summary>
public List<RMAProduct> GetChangeOwnership_ChangeOwnership (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RMAProduct>(Service, this.Id, "msdyn_rmaproduct", "msdyn_changeownership", Columns); }
/// <summary>
/// <para>Change ownership</para>
/// <para><b>RMAProduct (Change ownership)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_rmaproduct_Changeownership</para>
/// </summary>
public List<RMAProduct> GetChangeOwnership_ChangeOwnership (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RMAProduct>(Service, this.Id, "msdyn_rmaproduct", "msdyn_changeownership", Columns); }
/// <summary>
/// <para>Return to Vendor</para>
/// <para><b>RMAProduct (Return to Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_rmaproduct_ReturntoVendor</para>
/// </summary>
public List<RMAProduct> GetReturnToVendor_ReturnToVendor (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RMAProduct>(Service, this.Id, "msdyn_rmaproduct", "msdyn_returntovendor", Columns); }
/// <summary>
/// <para>Return to Vendor</para>
/// <para><b>RMAProduct (Return to Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_rmaproduct_ReturntoVendor</para>
/// </summary>
public List<RMAProduct> GetReturnToVendor_ReturnToVendor (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RMAProduct>(Service, this.Id, "msdyn_rmaproduct", "msdyn_returntovendor", Columns); }
/// <summary>
/// <para>RTVs</para>
/// <para><b>RTV (Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_rtv_Vendor</para>
/// </summary>
public List<RTV> GetRTVs_Vendor (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RTV>(Service, this.Id, "msdyn_rtv", "msdyn_vendor", Columns); }
/// <summary>
/// <para>RTVs</para>
/// <para><b>RTV (Vendor)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_rtv_Vendor</para>
/// </summary>
public List<RTV> GetRTVs_Vendor (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RTV>(Service, this.Id, "msdyn_rtv", "msdyn_vendor", Columns); }
/// <summary>
/// <para>Billed Work Orders</para>
/// <para><b>WorkOrder (Billing Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_workorder_BillingAccount</para>
/// </summary>
public List<WorkOrder> GetBilledWorkOrders_BillingAccount (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<WorkOrder>(Service, this.Id, "msdyn_workorder", "msdyn_billingaccount", Columns); }
/// <summary>
/// <para>Billed Work Orders</para>
/// <para><b>WorkOrder (Billing Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_workorder_BillingAccount</para>
/// </summary>
public List<WorkOrder> GetBilledWorkOrders_BillingAccount (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<WorkOrder>(Service, this.Id, "msdyn_workorder", "msdyn_billingaccount", Columns); }
/// <summary>
/// <para><b>WorkOrder (Service Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_workorder_ServiceAccount</para>
/// </summary>
public List<WorkOrder> GetWorkOrders_ServiceAccount (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<WorkOrder>(Service, this.Id, "msdyn_workorder", "msdyn_serviceaccount", Columns); }
/// <summary>
/// <para><b>WorkOrder (Service Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_workorder_ServiceAccount</para>
/// </summary>
public List<WorkOrder> GetWorkOrders_ServiceAccount (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<WorkOrder>(Service, this.Id, "msdyn_workorder", "msdyn_serviceaccount", Columns); }
/// <summary>
/// <para><b>ResourceRestriction_Deprecated (Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_workorderresourcerestriction_Account</para>
/// </summary>
public List<ResourceRestriction_Deprecated> GetResourceRestrictions_Deprecated__Account (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ResourceRestriction_Deprecated>(Service, this.Id, "msdyn_workorderresourcerestriction", "msdyn_account", Columns); }
/// <summary>
/// <para><b>ResourceRestriction_Deprecated (Account)</b></para>
/// <para>Schema Name: msdyn_account_msdyn_workorderresourcerestriction_Account</para>
/// </summary>
public List<ResourceRestriction_Deprecated> GetResourceRestrictions_Deprecated__Account (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ResourceRestriction_Deprecated>(Service, this.Id, "msdyn_workorderresourcerestriction", "msdyn_account", Columns); }
/// <summary>
/// <para><b>Opportunity (Potential Customer)</b></para>
/// <para>Schema Name: opportunity_customer_accounts</para>
/// </summary>
public List<Opportunity> GetOpportunities_PotentialCustomer (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Opportunity>(Service, this.Id, "opportunity", "customerid", Columns); }
/// <summary>
/// <para><b>Opportunity (Potential Customer)</b></para>
/// <para>Schema Name: opportunity_customer_accounts</para>
/// </summary>
public List<Opportunity> GetOpportunities_PotentialCustomer (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Opportunity>(Service, this.Id, "opportunity", "customerid", Columns); }
/// <summary>
/// <para><b>Opportunity (Account)</b></para>
/// <para>Schema Name: opportunity_parent_account</para>
/// </summary>
public List<Opportunity> GetOpportunities_Account (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Opportunity>(Service, this.Id, "opportunity", "parentaccountid", Columns); }
/// <summary>
/// <para><b>Opportunity (Account)</b></para>
/// <para>Schema Name: opportunity_parent_account</para>
/// </summary>
public List<Opportunity> GetOpportunities_Account (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Opportunity>(Service, this.Id, "opportunity", "parentaccountid", Columns); }
/// <summary>
/// <para><b>OpportunityLine (Service Account)</b></para>
/// <para>Schema Name: msdyn_account_opportunityproduct_ServiceAccount</para>
/// </summary>
public List<OpportunityLine> GetOpportunityLines_ServiceAccount (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OpportunityLine>(Service, this.Id, "opportunityproduct", "msdyn_serviceaccount", Columns); }
/// <summary>
/// <para><b>OpportunityLine (Service Account)</b></para>
/// <para>Schema Name: msdyn_account_opportunityproduct_ServiceAccount</para>
/// </summary>
public List<OpportunityLine> GetOpportunityLines_ServiceAccount (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OpportunityLine>(Service, this.Id, "opportunityproduct", "msdyn_serviceaccount", Columns); }
/// <summary>
...
/// <para><b>Product (Default Vendor)</b></para>
/// <para>Schema Name: msdyn_account_product_DefaultVendor</para>
/// </summary>
public List<Product> GetDefaultVendor_DefaultVendor (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Product>(Service, this.Id, "product", "msdyn_defaultvendor", Columns); }
/// <summary>
/// <para>Default Vendor</para>
/// <para><b>Product (Default Vendor)</b></para>
/// <para>Schema Name: msdyn_account_product_DefaultVendor</para>
/// </summary>
public List<Product> GetDefaultVendor_DefaultVendor (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Product>(Service, this.Id, "product", "msdyn_defaultvendor", Columns); }
/// <summary>
/// <para><b>Quote (Potential Customer)</b></para>
/// <para>Schema Name: msdyn_account_quote_Account</para>
/// </summary>
public List<Quote> GetQuotes_PotentialCustomer (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Quote>(Service, this.Id, "quote", "msdyn_account", Columns); }
/// <summary>
/// <para><b>Quote (Potential Customer)</b></para>
/// <para>Schema Name: msdyn_account_quote_Account</para>
/// </summary>
public List<Quote> GetQuotes_PotentialCustomer (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Quote>(Service, this.Id, "quote", "msdyn_account", Columns); }
/// <summary>
/// <para><b>Quote (Potential Customer)</b></para>
/// <para>Schema Name: quote_customer_accounts</para>
/// </summary>
public List<Quote> GetQuotes_PotentialCustomer2 (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Quote>(Service, this.Id, "quote", "customerid", Columns); }
/// <summary>
/// <para><b>Quote (Potential Customer)</b></para>
/// <para>Schema Name: quote_customer_accounts</para>
/// </summary>
public List<Quote> GetQuotes_PotentialCustomer2 (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Quote>(Service, this.Id, "quote", "customerid", Columns); }
/// <summary>
/// <para><b>QuoteLine (Service Account)</b></para>
/// <para>Schema Name: msdyn_account_quotedetail_ServiceAccount</para>
/// </summary>
public List<QuoteLine> GetQuoteLines_ServiceAccount (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<QuoteLine>(Service, this.Id, "quotedetail", "msdyn_serviceaccount", Columns); }
/// <summary>
/// <para><b>QuoteLine (Service Account)</b></para>
/// <para>Schema Name: msdyn_account_quotedetail_ServiceAccount</para>
/// </summary>
public List<QuoteLine> GetQuoteLines_ServiceAccount (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<QuoteLine>(Service, this.Id, "quotedetail", "msdyn_serviceaccount", Columns); }
/// <summary>
...
/// <summary>
/// <para><b>Order (Potential Customer)</b></para>
/// <para>Schema Name: msdyn_account_salesorder_Account</para>
/// </summary>
public List<Order> GetOrders_PotentialCustomer (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Order>(Service, this.Id, "salesorder", "msdyn_account", Columns); }
/// <summary>
/// <para><b>Order (Potential Customer)</b></para>
/// <para>Schema Name: msdyn_account_salesorder_Account</para>
/// </summary>
public List<Order> GetOrders_PotentialCustomer (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Order>(Service, this.Id, "salesorder", "msdyn_account", Columns); }
/// <summary>
/// <para><b>Order (Customer)</b></para>
/// <para>Schema Name: order_customer_accounts</para>
/// </summary>
public List<Order> GetOrders_Customer (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Order>(Service, this.Id, "salesorder", "customerid", Columns); }
/// <summary>
/// <para><b>Order (Customer)</b></para>
/// <para>Schema Name: order_customer_accounts</para>
/// </summary>
public List<Order> GetOrders_Customer (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Order>(Service, this.Id, "salesorder", "customerid", Columns); }
/// <summary>
...
/// <summary>
/// <para><b>SocialActivity (Post Author)</b></para>
/// <para>Schema Name: SocialActivity_PostAuthor_accounts</para>
/// </summary>
public List<SocialActivity> GetSocialActivities_PostAuthor (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<SocialActivity>(Service, this.Id, "socialactivity", "postauthor", Columns); }
/// <summary>
/// <para><b>SocialActivity (Post Author)</b></para>
/// <para>Schema Name: SocialActivity_PostAuthor_accounts</para>
/// </summary>
public List<SocialActivity> GetSocialActivities_PostAuthor (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<SocialActivity>(Service, this.Id, "socialactivity", "postauthor", Columns); }
/// <summary>
/// <para><b>SocialActivity (Post Author Account)</b></para>
/// <para>Schema Name: SocialActivity_PostAuthorAccount_accounts</para>
/// </summary>
public List<SocialActivity> GetSocialActivities_PostAuthorAccount (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<SocialActivity>(Service, this.Id, "socialactivity", "postauthoraccount", Columns); }
/// <summary>
/// <para><b>SocialActivity (Post Author Account)</b></para>
/// <para>Schema Name: SocialActivity_PostAuthorAccount_accounts</para>
/// </summary>
public List<SocialActivity> GetSocialActivities_PostAuthorAccount (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<SocialActivity>(Service, this.Id, "socialactivity", "postauthoraccount", Columns); }
/// <summary>
/// <para><b>SocialProfile (Customer)</b></para>
/// <para>Schema Name: Socialprofile_customer_accounts</para>
/// </summary>
public List<SocialProfile> GetSocialProfiles_Customer (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<SocialProfile>(Service, this.Id, "socialprofile", "customerid", Columns); }
/// <summary>
/// <para><b>SocialProfile (Customer)</b></para>
/// <para>Schema Name: Socialprofile_customer_accounts</para>
/// </summary>
public List<SocialProfile> GetSocialProfiles_Customer (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<SocialProfile>(Service, this.Id, "socialprofile", "customerid", Columns); }
/// <summary>
...
/// </summary>
public List<Lead> GetLeads (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<Lead>(Service, this, "account", "accountid", "lead", "leadid", "accountleads", "accountid", "leadid", Columns); }
public List<Lead> GetLeads (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<Lead>(Service, this, "account", "accountid", "lead", "leadid", "accountleads", "accountid", "leadid", Columns); }
...
/// </summary>
public List<MarketingList> GetMarketingLists (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<MarketingList>(Service, this, "account", "accountid", "list", "listid", "listmember", "entityid", "listid", Columns); }
public List<MarketingList> GetMarketingLists (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<MarketingList>(Service, this, "account", "accountid", "list", "listid", "listmember", "entityid", "listid", Columns); }
...
public enum eTravelChargeType
{
	///<summary><para>Hourly</para>
	///<para>Value = 690970000</para></summary>
	[Description("Hourly")]
	Hourly = 690970000, 
	///<summary><para>Mileage</para>
        ...
        public static class Properties
{
	...
	/// <summary><para>External ID</para>
	/// <para>msdyn_externalaccountid</para></summary>
	public const string ExternalID = "msdyn_externalaccountid";
	/// <summary><para>Facebook</para>
	/// <para>int_facebook</para></summary>
	public const string Facebook = "int_facebook";
	/// <summary><para>Fax</para>
	...
	/// <summary><para>Open Deals(Last Updated Time)</para>
	...
	/// <summary><para>Open Revenue(Last Updated Time)</para>
	...
	/// <summary><para>Tax Exempt</para>
	/// <para>msdyn_taxexempt</para></summary>
	public const string TaxExempt = "msdyn_taxexempt";
	/// <summary><para>Tax Exempt Number</para>
	/// <para>msdyn_taxexemptnumber</para></summary>
	...
	/// <para>msdyn_travelcharge</para></summary>
	public const string TravelCharge = "msdyn_travelcharge";
	/// <summary><para>Travel Charge (Base)</para>
	/// <para>msdyn_travelcharge_base</para></summary>
	public const string TravelCharge_Base = "msdyn_travelcharge_base";
	/// <summary><para>Travel Charge Type</para>
	/// <para>msdyn_travelchargetype</para></summary>
	...
	/// <para>int_twitter</para></summary>
	public const string Twitter = "int_twitter";
	...
	/// <summary><para>Work Order Instructions</para>
	/// <para>msdyn_workorderinstructions</para></summary>
