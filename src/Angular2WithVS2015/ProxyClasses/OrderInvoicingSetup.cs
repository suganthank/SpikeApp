...
{
    [EntityLogicalNameAttribute("msdyn_orderinvoicingsetup")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class OrderInvoicingSetup : BaseProxyClass
    {
        public new const string LogicalName = "msdyn_orderinvoicingsetup";
        public const int ObjectTypeCode = 10136;
        public const string PrimaryIdAttribute = "msdyn_orderinvoicingsetupid";
        public const string PrimaryNameAttribute = "msdyn_name";
        
        static OrderInvoicingSetup()
        {
            BaseProxyClass.RegisterProxyType(typeof(OrderInvoicingSetup), "msdyn_orderinvoicingsetup");
        ...
        public OrderInvoicingSetup() : base(new Entity("msdyn_orderinvoicingsetup")) { }
        public OrderInvoicingSetup(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<OrderInvoicingSetup>(); }
        /// <summary>
...
///<para>Logical Name: msdyn_orderinvoicingsetupid</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_orderinvoicingsetupid")]
public Guid OrderInvoicingSetupId
{
	get
	{
		return this.Id;
...
/// <para>Schema Name: msdyn_orderinvoicingsetup_AsyncOperations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_orderinvoicingsetup_BulkDeleteFailures</para>
/// </summary>
...
/// <para>Schema Name: msdyn_orderinvoicingsetup_DuplicateBaseRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_orderinvoicingsetup_DuplicateMatchingRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_orderinvoicingsetup_MailboxTrackingFolders</para>
/// </summary>
...
/// <summary>
/// <para><b>OrderInvoicingProduct (Order Invoicing Setup)</b></para>
/// <para>Schema Name: msdyn_msdyn_orderinvoicingsetup_msdyn_orderinvoicingproduct_OrderInvoicingSetup</para>
/// </summary>
public List<OrderInvoicingProduct> GetOrderInvoicingProducts_OrderInvoicingSetup (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OrderInvoicingProduct>(Service, this.Id, "msdyn_orderinvoicingproduct", "msdyn_orderinvoicingsetup", Columns); }
/// <summary>
/// <para><b>OrderInvoicingProduct (Order Invoicing Setup)</b></para>
/// <para>Schema Name: msdyn_msdyn_orderinvoicingsetup_msdyn_orderinvoicingproduct_OrderInvoicingSetup</para>
/// </summary>
public List<OrderInvoicingProduct> GetOrderInvoicingProducts_OrderInvoicingSetup (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OrderInvoicingProduct>(Service, this.Id, "msdyn_orderinvoicingproduct", "msdyn_orderinvoicingsetup", Columns); }
/// <summary>
/// <para><b>OrderInvoicingSetupDate (Invoice Setup)</b></para>
/// <para>Schema Name: msdyn_msdyn_orderinvoicingsetup_msdyn_orderinvoicingsetupdate_InvoiceSetup</para>
/// </summary>
public List<OrderInvoicingSetupDate> GetOrderInvoicingSetupDates_InvoiceSetup (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OrderInvoicingSetupDate>(Service, this.Id, "msdyn_orderinvoicingsetupdate", "msdyn_invoicesetup", Columns); }
/// <summary>
/// <para><b>OrderInvoicingSetupDate (Invoice Setup)</b></para>
/// <para>Schema Name: msdyn_msdyn_orderinvoicingsetup_msdyn_orderinvoicingsetupdate_InvoiceSetup</para>
/// </summary>
public List<OrderInvoicingSetupDate> GetOrderInvoicingSetupDates_InvoiceSetup (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OrderInvoicingSetupDate>(Service, this.Id, "msdyn_orderinvoicingsetupdate", "msdyn_invoicesetup", Columns); }
/// <summary>
/// <para><b>FieldSharing (Entity instance)</b></para>
/// <para>Schema Name: msdyn_orderinvoicingsetup_PrincipalObjectAttributeAccesses</para>
/// </summary>
...
/// <para>Schema Name: msdyn_orderinvoicingsetup_ProcessSession</para>
/// </summary>
...
/// <para>Schema Name: msdyn_orderinvoicingsetup_SyncErrors</para>
/// </summary>
...
/// <para>Schema Name: msdyn_orderinvoicingsetup_UserEntityInstanceDatas</para>
/// </summary>
        ...
        public static class Properties
{
	...
	/// <para>msdyn_orderinvoicingsetupid</para></summary>
	public const string OrderInvoicingSetupId = "msdyn_orderinvoicingsetupid";
