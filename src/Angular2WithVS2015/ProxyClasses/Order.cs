...
{
    [EntityLogicalNameAttribute("salesorder")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class Order : BaseProxyClass
    {
        public new const string LogicalName = "salesorder";
        public const int ObjectTypeCode = 1088;
        public const string PrimaryIdAttribute = "salesorderid";
        public const string PrimaryNameAttribute = "name";
        
        static Order()
        {
            BaseProxyClass.RegisterProxyType(typeof(Order), "salesorder");
        ...
        public Order() : base(new Entity("salesorder")) { }
        public Order(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<Order>(); }
        /// <summary>
...
///<summary>
///<para>Logical Name: quoteidname</para>
///<para>Max Length: 100 characters</para>
///</summary>
[AttributeLogicalNameAttribute("quoteidname")]
public string QuoteIdName
{
	get { return this.GetPropertyValue<string>("quoteidname"); }
}
///<summary>
...
/// <summary>
///Logical Name: msdyn_psastate
/// </summary>
[AttributeLogicalNameAttribute("msdyn_psastate")]
public eProjectContractState? ContractStatus
{
	get
	{
		if (ContractStatus_OptionSetValue != null) { return (eProjectContractState)ContractStatus_OptionSetValue.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.ContractStatus_OptionSetValue = new OptionSetValue((int)value); }
		else this.ContractStatus_OptionSetValue = null;
	}
}
///<summary>
///<para>Logical Name: msdyn_psastate</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_psastate")]
public OptionSetValue ContractStatus_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("msdyn_psastate"); }
	set { this.SetPropertyValue<OptionSetValue>("msdyn_psastate", value, "ContractStatus_OptionSetValue"); }
}
/// <summary>
...
/// <returns></returns>
public string ContractStatus_Text(IOrganizationService Service)
{
	return this.ContractStatus_OptionSetValue.GetOptionSetText(Service, this, "msdyn_psastate");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
...
/// <returns></returns>
public string ContractStatus_Text(EnumAttributeMetadata AttributeMetadata)
{
	return AttributeMetadata.GetOptionSetText(this.ContractStatus_OptionSetValue.Value);
}
/// <summary>
///Logical Name: msdyn_psastatusreason
/// </summary>
[AttributeLogicalNameAttribute("msdyn_psastatusreason")]
public eProjectContractStatus? ContractStatusReason
{
	get
	{
		if (ContractStatusReason_OptionSetValue != null) { return (eProjectContractStatus)ContractStatusReason_OptionSetValue.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.ContractStatusReason_OptionSetValue = new OptionSetValue((int)value); }
		else this.ContractStatusReason_OptionSetValue = null;
	}
}
///<summary>
///<para>Logical Name: msdyn_psastatusreason</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_psastatusreason")]
public OptionSetValue ContractStatusReason_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("msdyn_psastatusreason"); }
	set { this.SetPropertyValue<OptionSetValue>("msdyn_psastatusreason", value, "ContractStatusReason_OptionSetValue"); }
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
/// <param name="Service">CRM Organization Service</param>
/// <returns></returns>
public string ContractStatusReason_Text(IOrganizationService Service)
{
	return this.ContractStatusReason_OptionSetValue.GetOptionSetText(Service, this, "msdyn_psastatusreason");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
/// <param name="AttributeMetadata">The attribute metadata previously retrieved using the 'GetAttributeMetadata' extension method on the IOrganizationService object.</param>
/// <returns></returns>
public string ContractStatusReason_Text(EnumAttributeMetadata AttributeMetadata)
{
	return AttributeMetadata.GetOptionSetText(this.ContractStatusReason_OptionSetValue.Value);
}
///<summary>
...
///<summary>
///<para>Logical Name: datefulfilled</para>
///</summary>
[AttributeLogicalNameAttribute("datefulfilled")]
public DateTime? DateFulfilled
{
	get { return this.GetPropertyValue<DateTime?>("datefulfilled"); }
	set { this.SetPropertyValue<DateTime?>("datefulfilled", value, "DateFulfilled"); }
}
///<summary>
///<para>Logical Name: submitdate</para>
///</summary>
[AttributeLogicalNameAttribute("submitdate")]
public DateTime? DateSubmitted
{
	get { return this.GetPropertyValue<DateTime?>("submitdate"); }
	set { this.SetPropertyValue<DateTime?>("submitdate", value, "DateSubmitted"); }
}
///<summary>
...
public decimal? OrderDiscount
{
	...
	set { this.SetPropertyValue("discountpercentage", (decimal?)value, (decimal)0, (decimal)100, "OrderDiscount"); }
}
///<summary>
...
public decimal? OrderDiscountAmount
{
	get
	{
		if (OrderDiscountAmountMoney != null) { return OrderDiscountAmountMoney.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.OrderDiscountAmountMoney = new Money(value.Value); }
		else this.OrderDiscountAmountMoney = null;
	}
}
///<summary>
///<para>Logical Name: discountamount</para>
...
public Money OrderDiscountAmountMoney
{
	get { return this.GetPropertyValue<Money>("discountamount"); }
	set { this.SetPropertyValue("discountamount", (Money)value, (decimal)0, (decimal)1000000000000, "OrderDiscountAmountMoney"); }
}
///<summary>
...
///<para>Precision: 4</para>
///</summary>
public decimal? OrderDiscountAmount_Base
{
	get
	{
		if (OrderDiscountAmount_BaseMoney != null) { return OrderDiscountAmount_BaseMoney.Value; }
		return null;
	}
}
///<summary>
...
public Money OrderDiscountAmount_BaseMoney
{
	get { return this.GetPropertyValue<Money>("discountamount_base"); }
}
///<summary>
///<para>Logical Name: ordernumber</para>
///<para>Max Length: 100 characters</para>
///</summary>
[AttributeLogicalNameAttribute("ordernumber")]
public string OrderID
{
	get { return this.GetPropertyValue<string>("ordernumber"); }
	set { this.SetPropertyValue("ordernumber", value, 100, "OrderID"); }
}
/// <summary>
...
public EntityReference PotentialCustomer
{
	...
	set { this.SetPropertyValue<EntityReference>("msdyn_account", value, "PotentialCustomer"); }
}
///<summary>
...
{
	get { return this.GetPropertyValue<EntityReference>("quoteid"); }
	set { this.SetPropertyValue<EntityReference>("quoteid", value, "Quote"); }
}
///<summary>
...
public DateTime? RequestedCompletionDate
{
	...
	set { this.SetPropertyValue<DateTime?>("requestdeliveryby", value, "RequestedCompletionDate"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: submitstatus</para>
///<para>Minimum Value: 0</para>
///<para>Maximum Value: 1000000000</para>
///</summary>
[AttributeLogicalNameAttribute("submitstatus")]
public int? SubmittedStatus
{
	get { return this.GetPropertyValue<int?>("submitstatus"); }
	set { this.SetPropertyValue("submitstatus", (int?)value, (int)0, (int)1000000000, "SubmittedStatus"); }
}
///<summary>
///<para>Logical Name: submitstatusdescription</para>
///<para>Max Length: 2000 characters</para>
///</summary>
[AttributeLogicalNameAttribute("submitstatusdescription")]
public string SubmittedStatusDescription
{
	get { return this.GetPropertyValue<string>("submitstatusdescription"); }
	set { this.SetPropertyValue("submitstatusdescription", value, 2000, "SubmittedStatusDescription"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: int_trackingnumber</para>
///<para>Max Length: 100 characters</para>
///</summary>
[AttributeLogicalNameAttribute("int_trackingnumber")]
public string TrackingNumber
{
	get { return this.GetPropertyValue<string>("int_trackingnumber"); }
	set { this.SetPropertyValue("int_trackingnumber", value, 100, "TrackingNumber"); }
}
///<summary>
...
/// <para>Schema Name: salesorder_activity_parties</para>
/// </summary>
...
/// <para>Schema Name: SalesOrder_ActivityPointers</para>
/// </summary>
...
/// <para>Schema Name: SalesOrder_Annotation</para>
/// </summary>
...
/// <para>Schema Name: SalesOrder_Appointments</para>
/// </summary>
...
/// <para>Schema Name: SalesOrder_AsyncOperations</para>
/// </summary>
...
/// <para>Schema Name: SalesOrder_BulkDeleteFailures</para>
/// </summary>
...
/// <para>Schema Name: salesorder_connections1</para>
/// </summary>
...
/// <para>Schema Name: salesorder_connections2</para>
/// </summary>
...
/// <para>Schema Name: SalesOrder_Emails</para>
/// </summary>
...
/// <para>Schema Name: SalesOrder_Faxes</para>
/// </summary>
...
/// <summary>
/// <para><b>Invoice (Contract)</b></para>
/// <para>Schema Name: order_invoices</para>
/// </summary>
public List<Invoice> GetInvoices_Contract (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Invoice>(Service, this.Id, "invoice", "salesorderid", Columns); }
/// <summary>
/// <para><b>Invoice (Contract)</b></para>
/// <para>Schema Name: order_invoices</para>
/// </summary>
public List<Invoice> GetInvoices_Contract (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Invoice>(Service, this.Id, "invoice", "salesorderid", Columns); }
/// <summary>
/// <para><b>Letter (Regarding)</b></para>
/// <para>Schema Name: SalesOrder_Letters</para>
/// </summary>
...
/// <para>Schema Name: SalesOrder_MailboxTrackingFolder</para>
/// </summary>
...
/// <summary>
/// <para><b>Actual (Project Contract ID)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_actual_SalesContract</para>
/// </summary>
public List<Actual> GetActuals_ProjectContractID (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Actual>(Service, this.Id, "msdyn_actual", "msdyn_salescontract", Columns); }
/// <summary>
/// <para><b>Actual (Project Contract ID)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_actual_SalesContract</para>
/// </summary>
public List<Actual> GetActuals_ProjectContractID (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Actual>(Service, this.Id, "msdyn_actual", "msdyn_salescontract", Columns); }
/// <summary>
/// <para><b>Approval (Regarding)</b></para>
/// <para>Schema Name: salesorder_msdyn_approvals</para>
/// </summary>
...
/// <para>Schema Name: salesorder_msdyn_bookingalerts</para>
/// </summary>
...
/// <summary>
/// <para><b>ProjectContractLineMilestone (Project Contract)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_contractlinescheduleofvalue_contract</para>
/// </summary>
public List<ProjectContractLineMilestone> GetProjectContractLineMilestones_ProjectContract (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ProjectContractLineMilestone>(Service, this.Id, "msdyn_contractlinescheduleofvalue", "msdyn_contract", Columns); }
/// <summary>
/// <para><b>ProjectContractLineMilestone (Project Contract)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_contractlinescheduleofvalue_contract</para>
/// </summary>
public List<ProjectContractLineMilestone> GetProjectContractLineMilestones_ProjectContract (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ProjectContractLineMilestone>(Service, this.Id, "msdyn_contractlinescheduleofvalue", "msdyn_contract", Columns); }
/// <summary>
/// <para><b>Fact (Project Contract)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_fact_SalesContract</para>
/// </summary>
public List<Fact> GetFacts_ProjectContract (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Fact>(Service, this.Id, "msdyn_fact", "msdyn_salescontract", Columns); }
/// <summary>
/// <para><b>Fact (Project Contract)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_fact_SalesContract</para>
/// </summary>
public List<Fact> GetFacts_ProjectContract (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Fact>(Service, this.Id, "msdyn_fact", "msdyn_salescontract", Columns); }
/// <summary>
/// <para><b>InvoiceLineDetail (Project Contract)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_invoicelinetransaction_SalesContract</para>
/// </summary>
public List<InvoiceLineDetail> GetInvoiceLineDetails_ProjectContract (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<InvoiceLineDetail>(Service, this.Id, "msdyn_invoicelinetransaction", "msdyn_salescontract", Columns); }
/// <summary>
/// <para><b>InvoiceLineDetail (Project Contract)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_invoicelinetransaction_SalesContract</para>
/// </summary>
public List<InvoiceLineDetail> GetInvoiceLineDetails_ProjectContract (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<InvoiceLineDetail>(Service, this.Id, "msdyn_invoicelinetransaction", "msdyn_salescontract", Columns); }
/// <summary>
/// <para><b>JournalLine (Project Contract)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_journalline_SalesContract</para>
/// </summary>
public List<JournalLine> GetJournalLines_ProjectContract (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<JournalLine>(Service, this.Id, "msdyn_journalline", "msdyn_salescontract", Columns); }
/// <summary>
/// <para><b>JournalLine (Project Contract)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_journalline_SalesContract</para>
/// </summary>
public List<JournalLine> GetJournalLines_ProjectContract (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<JournalLine>(Service, this.Id, "msdyn_journalline", "msdyn_salescontract", Columns); }
/// <summary>
/// <para><b>OrderInvoicingDate (Order)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_orderinvoicingdate_Order</para>
/// </summary>
public List<OrderInvoicingDate> GetOrderInvoicingDates_Order (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OrderInvoicingDate>(Service, this.Id, "msdyn_orderinvoicingdate", "msdyn_order", Columns); }
/// <summary>
/// <para><b>OrderInvoicingDate (Order)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_orderinvoicingdate_Order</para>
/// </summary>
public List<OrderInvoicingDate> GetOrderInvoicingDates_Order (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OrderInvoicingDate>(Service, this.Id, "msdyn_orderinvoicingdate", "msdyn_order", Columns); }
/// <summary>
/// <para><b>OrderInvoicingSetup (Order)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_orderinvoicingsetup_Order</para>
/// </summary>
public List<OrderInvoicingSetup> GetOrderInvoicingSetups_Order (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OrderInvoicingSetup>(Service, this.Id, "msdyn_orderinvoicingsetup", "msdyn_order", Columns); }
/// <summary>
/// <para><b>OrderInvoicingSetup (Order)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_orderinvoicingsetup_Order</para>
/// </summary>
public List<OrderInvoicingSetup> GetOrderInvoicingSetups_Order (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OrderInvoicingSetup>(Service, this.Id, "msdyn_orderinvoicingsetup", "msdyn_order", Columns); }
/// <summary>
/// <para><b>OrderInvoicingSetupDate (Order)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_orderinvoicingsetupdate_Order</para>
/// </summary>
public List<OrderInvoicingSetupDate> GetOrderInvoicingSetupDates_Order (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OrderInvoicingSetupDate>(Service, this.Id, "msdyn_orderinvoicingsetupdate", "msdyn_order", Columns); }
/// <summary>
/// <para><b>OrderInvoicingSetupDate (Order)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_orderinvoicingsetupdate_Order</para>
/// </summary>
public List<OrderInvoicingSetupDate> GetOrderInvoicingSetupDates_Order (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OrderInvoicingSetupDate>(Service, this.Id, "msdyn_orderinvoicingsetupdate", "msdyn_order", Columns); }
/// <summary>
/// <para><b>ProjectContractLineDetail (Project Contract)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_orderlinetransaction_SalesContract</para>
/// </summary>
public List<ProjectContractLineDetail> GetProjectContractLineDetails_ProjectContract (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ProjectContractLineDetail>(Service, this.Id, "msdyn_orderlinetransaction", "msdyn_salescontract", Columns); }
/// <summary>
/// <para><b>ProjectContractLineDetail (Project Contract)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_orderlinetransaction_SalesContract</para>
/// </summary>
public List<ProjectContractLineDetail> GetProjectContractLineDetails_ProjectContract (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ProjectContractLineDetail>(Service, this.Id, "msdyn_orderlinetransaction", "msdyn_salescontract", Columns); }
/// <summary>
/// <para><b>ProjectContractProjectPriceList (Project contract)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_orderpricelist_Contract</para>
/// </summary>
public List<ProjectContractProjectPriceList> GetProjectPriceLists_ProjectContract (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ProjectContractProjectPriceList>(Service, this.Id, "msdyn_orderpricelist", "msdyn_contract", Columns); }
/// <summary>
/// <para><b>ProjectContractProjectPriceList (Project contract)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_orderpricelist_Contract</para>
/// </summary>
public List<ProjectContractProjectPriceList> GetProjectPriceLists_ProjectContract (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ProjectContractProjectPriceList>(Service, this.Id, "msdyn_orderpricelist", "msdyn_contract", Columns); }
/// <summary>
/// <para><b>Project (Contract)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_project_salesorderid</para>
/// </summary>
public List<Project> GetProjects_Contract (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Project>(Service, this.Id, "msdyn_project", "msdyn_salesorderid", Columns); }
/// <summary>
/// <para><b>Project (Contract)</b></para>
/// <para>Schema Name: msdyn_salesorder_msdyn_project_salesorderid</para>
/// </summary>
public List<Project> GetProjects_Contract (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Project>(Service, this.Id, "msdyn_project", "msdyn_salesorderid", Columns); }
/// <summary>
/// <para>salesorder</para>
/// <para><b>OpportunitySalesProcess (salesorder)</b></para>
/// <para>Schema Name: bpf_salesorder_OpportunitySalesProcess</para>
/// </summary>
public List<OpportunitySalesProcess> Getsalesorder_salesorder (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OpportunitySalesProcess>(Service, this.Id, "opportunitysalesprocess", "bpf_salesorderid", Columns); }
/// <summary>
/// <para>salesorder</para>
/// <para><b>OpportunitySalesProcess (salesorder)</b></para>
/// <para>Schema Name: bpf_salesorder_OpportunitySalesProcess</para>
/// </summary>
public List<OpportunitySalesProcess> Getsalesorder_salesorder (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OpportunitySalesProcess>(Service, this.Id, "opportunitysalesprocess", "bpf_salesorderid", Columns); }
/// <summary>
/// <para><b>OpportunitySalesProcess (Related Sales Order)</b></para>
/// <para>Schema Name: lk_opportunitysalesprocess_salesorderid</para>
/// </summary>
public List<OpportunitySalesProcess> GetOpportunitySalesProcess_RelatedSalesOrder (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OpportunitySalesProcess>(Service, this.Id, "opportunitysalesprocess", "salesorderid", Columns); }
/// <summary>
/// <para><b>OpportunitySalesProcess (Related Sales Order)</b></para>
/// <para>Schema Name: lk_opportunitysalesprocess_salesorderid</para>
/// </summary>
public List<OpportunitySalesProcess> GetOpportunitySalesProcess_RelatedSalesOrder (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OpportunitySalesProcess>(Service, this.Id, "opportunitysalesprocess", "salesorderid", Columns); }
/// <summary>
/// <para><b>OrderClose (Order)</b></para>
/// <para>Schema Name: SalesOrder_OrderClose</para>
/// </summary>
public List<OrderClose> GetOrderCloseActivities_Order (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OrderClose>(Service, this.Id, "orderclose", "salesorderid", Columns); }
/// <summary>
/// <para><b>OrderClose (Order)</b></para>
/// <para>Schema Name: SalesOrder_OrderClose</para>
/// </summary>
public List<OrderClose> GetOrderCloseActivities_Order (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OrderClose>(Service, this.Id, "orderclose", "salesorderid", Columns); }
/// <summary>
/// <para><b>PhoneCall (Regarding)</b></para>
/// <para>Schema Name: SalesOrder_Phonecalls</para>
/// </summary>
...
/// <para>Schema Name: salesorder_principalobjectattributeaccess</para>
/// </summary>
...
/// <para>Schema Name: SalesOrder_ProcessSessions</para>
/// </summary>
...
/// <para>Schema Name: SalesOrder_RecurringAppointmentMasters</para>
/// </summary>
...
/// <summary>
/// <para><b>OrderLine (Order)</b></para>
/// <para>Schema Name: order_details</para>
/// </summary>
public List<OrderLine> GetOrderLines_Order (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OrderLine>(Service, this.Id, "salesorderdetail", "salesorderid", Columns); }
/// <summary>
/// <para><b>OrderLine (Order)</b></para>
/// <para>Schema Name: order_details</para>
/// </summary>
public List<OrderLine> GetOrderLines_Order (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<OrderLine>(Service, this.Id, "salesorderdetail", "salesorderid", Columns); }
/// <summary>
/// <para><b>ServiceActivity (Regarding)</b></para>
/// <para>Schema Name: SalesOrder_ServiceAppointments</para>
/// </summary>
...
/// <para>Schema Name: slakpiinstance_salesorder</para>
/// </summary>
...
/// <para>Schema Name: SalesOrder_SocialActivities</para>
/// </summary>
...
/// <para>Schema Name: SalesOrder_SyncErrors</para>
/// </summary>
...
/// <para>Schema Name: SalesOrder_Tasks</para>
/// </summary>
...
/// <para>Schema Name: userentityinstancedata_salesorder</para>
/// </summary>
...
/// </summary>
public List<Contact> GetContacts (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<Contact>(Service, this, "salesorder", "salesorderid", "contact", "contactid", "contactorders", "salesorderid", "contactid", Columns); }
public List<Contact> GetContacts (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<Contact>(Service, this, "salesorder", "salesorderid", "contact", "contactid", "contactorders", "salesorderid", "contactid", Columns); }
public void RelateContacts (IOrganizationService Service, params Entity[] Items) { Service.RelateEntities(this, "contactorders_association", Items); }
public void RelateContacts (IOrganizationService Service, params EntityReference[] Items) { Service.RelateEntities(this, "contactorders_association", Items); }
public void UnRelateContacts (IOrganizationService Service, params Entity[] Items) { Service.UnRelateEntities(this, "contactorders_association", Items); }
public void UnRelateContacts (IOrganizationService Service, params EntityReference[] Items) { Service.UnRelateEntities(this, "contactorders_association", Items); }


        

        public enum eProjectContractState
{
...
public enum eProjectContractStatus
{
	///<summary><para>Draft</para>
	///<para>Value = 192350000</para></summary>
	[Description("Draft")]
...
public enum eStatusReason
{
	...
	[Description("On hold")]
	OnHold_Active = 690970000, 
	///<summary><para>In Progress</para>
	///<para>Value = 3</para></summary>
	[Description("In Progress")]
	InProgress_Submitted = 3, 
	///<summary><para>No Money</para>
	///<para>Value = 4</para></summary>
        ...
        public static class Properties
{
	...
	/// <summary><para>quoteidname</para>
	/// <para>quoteidname</para></summary>
	...
	/// <summary><para>Contract Status</para>
	/// <para>msdyn_psastate</para></summary>
	public const string ContractStatus = "msdyn_psastate";
	/// <summary><para>Contract Status Reason</para>
	/// <para>msdyn_psastatusreason</para></summary>
	...
	/// <summary><para>Date Fulfilled</para>
	/// <para>datefulfilled</para></summary>
	public const string DateFulfilled = "datefulfilled";
	/// <summary><para>Date Submitted</para>
	/// <para>submitdate</para></summary>
	...
	/// <summary><para>Order Discount (%)</para>
	/// <para>discountpercentage</para></summary>
	public const string OrderDiscount = "discountpercentage";
	/// <summary><para>Order Discount Amount</para>
	/// <para>discountamount</para></summary>
	public const string OrderDiscountAmount = "discountamount";
	/// <summary><para>Order Discount Amount (Base)</para>
	/// <para>discountamount_base</para></summary>
	public const string OrderDiscountAmount_Base = "discountamount_base";
	/// <summary><para>Order ID</para>
	/// <para>ordernumber</para></summary>
	...
	/// <summary><para>Requested Completion Date</para>
	/// <para>requestdeliveryby</para></summary>
	public const string RequestedCompletionDate = "requestdeliveryby";
	...
	/// <summary><para>Submitted Status</para>
	/// <para>submitstatus</para></summary>
	public const string SubmittedStatus = "submitstatus";
	/// <summary><para>Submitted Status Description</para>
	/// <para>submitstatusdescription</para></summary>
	...
	/// <summary><para>Tracking Number</para>
	/// <para>int_trackingnumber</para></summary>
	public const string TrackingNumber = "int_trackingnumber";
