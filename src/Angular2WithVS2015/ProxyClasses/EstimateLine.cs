...
{
    [EntityLogicalNameAttribute("msdyn_estimateline")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class EstimateLine : BaseProxyClass
    {
        public new const string LogicalName = "msdyn_estimateline";
        public const int ObjectTypeCode = 10038;
        public const string PrimaryIdAttribute = "msdyn_estimatelineid";
        public const string PrimaryNameAttribute = "msdyn_description";
        
        static EstimateLine()
        {
            BaseProxyClass.RegisterProxyType(typeof(EstimateLine), "msdyn_estimateline");
        ...
        public EstimateLine() : base(new Entity("msdyn_estimateline")) { }
        public EstimateLine(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<EstimateLine>(); }
        /// <summary>
...
public string Description
{
	...
	set { this.SetPropertyValue("msdyn_description", value, 450, "Description"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: msdyn_estimateperdaylines</para>
///<para>Max Length: 1048576 characters</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_estimateperdaylines")]
public string EstimatePerDayLines
{
	get { return this.GetPropertyValue<string>("msdyn_estimateperdaylines"); }
	set { this.SetPropertyValue("msdyn_estimateperdaylines", value, 1048576, "EstimatePerDayLines"); }
}
///<summary>
...
/// <para>Schema Name: msdyn_estimateline_Annotations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_estimateline_AsyncOperations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_estimateline_BulkDeleteFailures</para>
/// </summary>
...
/// <para>Schema Name: msdyn_estimateline_DuplicateBaseRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_estimateline_DuplicateMatchingRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_estimateline_MailboxTrackingFolders</para>
/// </summary>
...
/// <summary>
/// <para><b>Fact (Estimate Line)</b></para>
/// <para>Schema Name: msdyn_msdyn_estimateline_msdyn_fact_estimatelineid</para>
/// </summary>
public List<Fact> GetFacts_EstimateLine (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Fact>(Service, this.Id, "msdyn_fact", "msdyn_estimatelineid", Columns); }
/// <summary>
/// <para><b>Fact (Estimate Line)</b></para>
/// <para>Schema Name: msdyn_msdyn_estimateline_msdyn_fact_estimatelineid</para>
/// </summary>
public List<Fact> GetFacts_EstimateLine (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Fact>(Service, this.Id, "msdyn_fact", "msdyn_estimatelineid", Columns); }
/// <summary>
/// <para><b>FieldSharing (Entity instance)</b></para>
/// <para>Schema Name: msdyn_estimateline_PrincipalObjectAttributeAccesses</para>
/// </summary>
...
/// <para>Schema Name: msdyn_estimateline_ProcessSession</para>
/// </summary>
...
/// <para>Schema Name: msdyn_estimateline_SyncErrors</para>
/// </summary>
...
/// <para>Schema Name: msdyn_estimateline_UserEntityInstanceDatas</para>
/// </summary>
        ...
        public static class Properties
{
	...
	public const string EstimateLineId = "msdyn_estimatelineid";
	/// <summary><para>Estimate Per Day Lines</para>
	/// <para>msdyn_estimateperdaylines</para></summary>
	public const string EstimatePerDayLines = "msdyn_estimateperdaylines";
