...
{
    [EntityLogicalNameAttribute("ribbonrule")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class RibbonRule : BaseProxyClass
    {
        public new const string LogicalName = "ribbonrule";
        public const int ObjectTypeCode = 1117;
        public const string PrimaryIdAttribute = "ribbonruleid";
        public const string PrimaryNameAttribute = "";
        
        static RibbonRule()
        {
            BaseProxyClass.RegisterProxyType(typeof(RibbonRule), "ribbonrule");
        ...
        public RibbonRule() : base(new Entity("ribbonrule")) { }
        public RibbonRule(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<RibbonRule>(); }
        /// <summary>
...
///<summary>
///<para>Logical Name: ruledefinition</para>
///<para>Max Length: 100000 characters</para>
///</summary>
[AttributeLogicalNameAttribute("ruledefinition")]
public string RuleDefinition
{
	get { return this.GetPropertyValue<string>("ruledefinition"); }
	set { this.SetPropertyValue("ruledefinition", value, 100000, "RuleDefinition"); }
}
///<summary>
...
{
	get { return this.GetPropertyValue<string>("ruleid"); }
	set { this.SetPropertyValue("ruleid", value, 200, "RuleId"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: ribbonruleuniqueid</para>
///</summary>
[AttributeLogicalNameAttribute("ribbonruleuniqueid")]
public Guid RibbonRuleUniqueId
{
	get { return this.GetPropertyValue<Guid>("ribbonruleuniqueid"); }
}
/// <summary>
///Logical Name: ruletype
/// </summary>
[AttributeLogicalNameAttribute("ruletype")]
public eRuleType? RuleType
{
	get
	{
		if (RuleType_OptionSetValue != null) { return (eRuleType)RuleType_OptionSetValue.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.RuleType_OptionSetValue = new OptionSetValue((int)value); }
		else this.RuleType_OptionSetValue = null;
	}
}
///<summary>
///<para>Logical Name: ruletype</para>
///</summary>
[AttributeLogicalNameAttribute("ruletype")]
public OptionSetValue RuleType_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("ruletype"); }
	set { this.SetPropertyValue<OptionSetValue>("ruletype", value, "RuleType_OptionSetValue"); }
}
/// <summary>
...
/// <returns></returns>
public string RuleType_Text(IOrganizationService Service)
{
	return this.RuleType_OptionSetValue.GetOptionSetText(Service, this, "ruletype");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
...
/// <returns></returns>
public string RuleType_Text(EnumAttributeMetadata AttributeMetadata)
{
	return AttributeMetadata.GetOptionSetText(this.RuleType_OptionSetValue.Value);
}
///<summary>
...
///<para>Logical Name: ribbonruleid</para>
///</summary>
[AttributeLogicalNameAttribute("ribbonruleid")]
...
/// <para>Schema Name: userentityinstancedata_ribbonrule</para>
/// </summary>
...
{
	///<summary><para>Enable</para>
	///<para>Value = 1</para></summary>
	[Description("Enable")]
	Enable = 1, 
	///<summary><para>Trim</para>
	///<para>Value = 2</para></summary>
	[Description("Trim")]
	Trim = 2, 
	///<summary><para>Tab Selection</para>
        ...
        public static class Properties
{
	...
	/// <summary><para>ruledefinition</para>
	/// <para>ruledefinition</para></summary>
	public const string RuleDefinition = "ruledefinition";
	/// <summary><para>versionnumber</para>
	/// <para>versionnumber</para></summary>
	public const string VersionNumber = "versionnumber";
	/// <summary><para>ruleid</para>
	...
	/// <summary><para>ribbonruleuniqueid</para>
	/// <para>ribbonruleuniqueid</para></summary>
	public const string RibbonRuleUniqueId = "ribbonruleuniqueid";
	/// <summary><para>ruletype</para>
	/// <para>ruletype</para></summary>
	...
	/// <para>ribbonruleid</para></summary>
	public const string PrimaryKeyId = "ribbonruleid";
