...
{
    [EntityLogicalNameAttribute("invaliddependency")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class InvalidDependency : BaseProxyClass
    {
        public new const string LogicalName = "invaliddependency";
        public const int ObjectTypeCode = 7107;
        public const string PrimaryIdAttribute = "invaliddependencyid";
        public const string PrimaryNameAttribute = "";
        
        static InvalidDependency()
        {
            BaseProxyClass.RegisterProxyType(typeof(InvalidDependency), "invaliddependency");
        ...
        public InvalidDependency() : base(new Entity("invaliddependency")) { }
        public InvalidDependency(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<InvalidDependency>(); }
        /// <summary>
        ...
        ///<summary>
///<para>Logical Name: missingcomponentinfo</para>
///<para>Max Length: 1073741823 characters</para>
///</summary>
[AttributeLogicalNameAttribute("missingcomponentinfo")]
public string MissingComponentInfo
{
	get { return this.GetPropertyValue<string>("missingcomponentinfo"); }
}
///<summary>
///<para>Logical Name: existingcomponentid</para>
///</summary>
[AttributeLogicalNameAttribute("existingcomponentid")]
public Guid ExistingObjectId
{
	get { return this.GetPropertyValue<Guid>("existingcomponentid"); }
}
/// <summary>
///Logical Name: existingcomponenttype
/// </summary>
[AttributeLogicalNameAttribute("existingcomponenttype")]
public eComponentType? ExistingObjectsComponentType
{
	get
	{
		if (ExistingObjectsComponentType_OptionSetValue != null) { return (eComponentType)ExistingObjectsComponentType_OptionSetValue.Value; }
		return null;
	}
}
///<summary>
///<para>Logical Name: existingcomponenttype</para>
///</summary>
[AttributeLogicalNameAttribute("existingcomponenttype")]
public OptionSetValue ExistingObjectsComponentType_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("existingcomponenttype"); }
}
/// <summary>
...
/// <returns></returns>
public string ExistingObjectsComponentType_Text(IOrganizationService Service)
{
	return this.ExistingObjectsComponentType_OptionSetValue.GetOptionSetText(Service, this, "existingcomponenttype");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
...
/// <returns></returns>
public string ExistingObjectsComponentType_Text(EnumAttributeMetadata AttributeMetadata)
{
	return AttributeMetadata.GetOptionSetText(this.ExistingObjectsComponentType_OptionSetValue.Value);
}
///<summary>
///<para>Key Property (Uniqueidentifier)</para>
///<para>Logical Name: invaliddependencyid</para>
///</summary>
[AttributeLogicalNameAttribute("invaliddependencyid")]
public Guid InvalidDependencyIdentifierId
{
	get
	{
		return this.Id;
...
///<summary>
///<para>Logical Name: isexistingnoderequiredcomponent</para>
///<para>True = Ancestor</para>
///<para>False = Descendent</para>
///</summary>
[AttributeLogicalNameAttribute("isexistingnoderequiredcomponent")]
public bool? IsThisNodeTheRequiredComponent
{
	get { return this.GetPropertyValue<bool?>("isexistingnoderequiredcomponent"); }
}
///<summary>
///<para>Logical Name: missingcomponentlookuptype</para>
///<para>Minimum Value: -2147483648</para>
///<para>Maximum Value: 2147483647</para>
///</summary>
[AttributeLogicalNameAttribute("missingcomponentlookuptype")]
public int? LookupType
{
	get { return this.GetPropertyValue<int?>("missingcomponentlookuptype"); }
}
///<summary>
///<para>Logical Name: missingcomponentid</para>
///</summary>
[AttributeLogicalNameAttribute("missingcomponentid")]
public Guid Regarding
{
	get { return this.GetPropertyValue<Guid>("missingcomponentid"); }
	set { this.SetPropertyValue<Guid>("missingcomponentid", value, "Regarding"); }
}
/// <summary>
///Logical Name: missingcomponenttype
/// </summary>
[AttributeLogicalNameAttribute("missingcomponenttype")]
...
///<summary>
///<para>Logical Name: missingcomponenttype</para>
///</summary>
[AttributeLogicalNameAttribute("missingcomponenttype")]
public OptionSetValue TypeCode_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("missingcomponenttype"); }
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
...
{
	return this.TypeCode_OptionSetValue.GetOptionSetText(Service, this, "missingcomponenttype");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
...
/// <summary>
///Logical Name: existingdependencytype
/// </summary>
[AttributeLogicalNameAttribute("existingdependencytype")]
public eDependencyType? Weight
{
	get
	{
		if (Weight_OptionSetValue != null) { return (eDependencyType)Weight_OptionSetValue.Value; }
		return null;
	}
}
///<summary>
///<para>Logical Name: existingdependencytype</para>
///</summary>
[AttributeLogicalNameAttribute("existingdependencytype")]
public OptionSetValue Weight_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("existingdependencytype"); }
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
/// <param name="Service">CRM Organization Service</param>
/// <returns></returns>
public string Weight_Text(IOrganizationService Service)
{
	return this.Weight_OptionSetValue.GetOptionSetText(Service, this, "existingdependencytype");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
/// <param name="AttributeMetadata">The attribute metadata previously retrieved using the 'GetAttributeMetadata' extension method on the IOrganizationService object.</param>
/// <returns></returns>
public string Weight_Text(EnumAttributeMetadata AttributeMetadata)
{
	return AttributeMetadata.GetOptionSetText(this.Weight_OptionSetValue.Value);
}


        /// <summary>
/// <para><b>UserEntityInstanceData (Object Id)</b></para>
/// <para>Schema Name: userentityinstancedata_invaliddependency</para>
/// </summary>
...
{
	/// <summary><para>missingcomponentinfo</para>
	/// <para>missingcomponentinfo</para></summary>
	public const string MissingComponentInfo = "missingcomponentinfo";
	/// <summary><para>Existing Object Id</para>
	/// <para>existingcomponentid</para></summary>
	public const string ExistingObjectId = "existingcomponentid";
	/// <summary><para>Existing Object's Component Type</para>
	/// <para>existingcomponenttype</para></summary>
	public const string ExistingObjectsComponentType = "existingcomponenttype";
	/// <summary><para>Invalid Dependency Identifier</para>
	/// <para>invaliddependencyid</para></summary>
	public const string InvalidDependencyIdentifierId = "invaliddependencyid";
	/// <summary><para>Is this node the required component</para>
	/// <para>isexistingnoderequiredcomponent</para></summary>
	public const string IsThisNodeTheRequiredComponent = "isexistingnoderequiredcomponent";
	/// <summary><para>Lookup Type</para>
	/// <para>missingcomponentlookuptype</para></summary>
	public const string LookupType = "missingcomponentlookuptype";
	/// <summary><para>Regarding</para>
	/// <para>missingcomponentid</para></summary>
	public const string Regarding = "missingcomponentid";
	/// <summary><para>Type Code</para>
	/// <para>missingcomponenttype</para></summary>
	public const string TypeCode = "missingcomponenttype";
	/// <summary><para>Weight</para>
	/// <para>existingdependencytype</para></summary>
