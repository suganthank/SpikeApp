...
{
    [EntityLogicalNameAttribute("post")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class Post : BaseProxyClass
    {
        public new const string LogicalName = "post";
        public const int ObjectTypeCode = 8000;
        public const string PrimaryIdAttribute = "postid";
        public const string PrimaryNameAttribute = "text";
        
        static Post()
        {
            BaseProxyClass.RegisterProxyType(typeof(Post), "post");
        ...
        public Post() : base(new Entity("post")) { }
        public Post(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<Post>(); }
        /// <summary>
...
{
	get { return this.GetPropertyValue<EntityReference>("postregardingid"); }
}
///<summary>
///<para>Logical Name: posttoyammer</para>
///<para>True = Yes</para>
///<para>False = No</para>
///</summary>
[AttributeLogicalNameAttribute("posttoyammer")]
public bool? PostToYammer
{
	get { return this.GetPropertyValue<bool?>("posttoyammer"); }
}
///<summary>
...
public ePostType? Source
{
	get
	{
		if (Source_OptionSetValue != null) { return (ePostType)Source_OptionSetValue.Value; }
		return null;
	}
	set
	{
...
///<summary>
///<para>Logical Name: yammerpoststate</para>
///<para>Minimum Value: 0</para>
///<para>Maximum Value: 5</para>
///</summary>
[AttributeLogicalNameAttribute("yammerpoststate")]
public int? YammerPostState
{
	get { return this.GetPropertyValue<int?>("yammerpoststate"); }
}
///<summary>
///<para>Logical Name: yammerretrycount</para>
///<para>Minimum Value: 0</para>
///<para>Maximum Value: 2147483647</para>
///</summary>
[AttributeLogicalNameAttribute("yammerretrycount")]
public int? YammerRetryCount
{
	get { return this.GetPropertyValue<int?>("yammerretrycount"); }
}


        /// <summary>
/// <para><b>SystemJob (Regarding)</b></para>
/// <para>Schema Name: post_AsyncOperations</para>
/// </summary>
...
/// <para>Schema Name: post_BulkDeleteFailures</para>
/// </summary>
...
/// <summary>
/// <para><b>Comment (Post)</b></para>
/// <para>Schema Name: Post_Comments</para>
/// </summary>
public List<Comment> GetComments_Post (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Comment>(Service, this.Id, "postcomment", "postid", Columns); }
/// <summary>
/// <para><b>Comment (Post)</b></para>
/// <para>Schema Name: Post_Comments</para>
/// </summary>
public List<Comment> GetComments_Post (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Comment>(Service, this.Id, "postcomment", "postid", Columns); }
/// <summary>
/// <para><b>Like (Post)</b></para>
/// <para>Schema Name: Post_Likes</para>
/// </summary>
public List<Like> GetLikes_Post (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Like>(Service, this.Id, "postlike", "postid", Columns); }
/// <summary>
/// <para><b>Like (Post)</b></para>
/// <para>Schema Name: Post_Likes</para>
/// </summary>
public List<Like> GetLikes_Post (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Like>(Service, this.Id, "postlike", "postid", Columns); }
/// <summary>
/// <para><b>PostRole (Post)</b></para>
/// <para>Schema Name: postRole_Post</para>
/// </summary>
public List<PostRole> GetPostRoles_Post (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<PostRole>(Service, this.Id, "postrole", "postid", Columns); }
/// <summary>
/// <para><b>PostRole (Post)</b></para>
/// <para>Schema Name: postRole_Post</para>
/// </summary>
public List<PostRole> GetPostRoles_Post (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<PostRole>(Service, this.Id, "postrole", "postid", Columns); }
...
{
	///<summary><para>Auto Post</para>
	///<para>Value = 1</para></summary>
	[Description("Auto Post")]
	AutoPost = 1, 
	///<summary><para>Manual Post</para>
	///<para>Value = 2</para></summary>
	[Description("Manual Post")]
	ManualPost = 2, 
	///<summary><para>ActionHub Post</para>
	///<para>Value = 3</para></summary>
	[Description("ActionHub Post")]
	ActionHubPost = 3
}
public enum eType
{
	///<summary><para>Check-in</para>
	///<para>Value = 1</para></summary>
	[Description("Check-in")]
	Check_in = 1, 
	///<summary><para>Idea</para>
	///<para>Value = 2</para></summary>
	[Description("Idea")]
	Idea = 2, 
        ...
        public static class Properties
{
	...
	/// <para>posttoyammer</para></summary>
	...
	/// <summary><para>Yammer Post State</para>
	/// <para>yammerpoststate</para></summary>
	public const string YammerPostState = "yammerpoststate";
	/// <summary><para>Yammer Retry Count</para>
	/// <para>yammerretrycount</para></summary>
