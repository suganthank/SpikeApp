...
{
    [EntityLogicalNameAttribute("msdyn_estimate")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class Estimate : BaseProxyClass
    {
        public new const string LogicalName = "msdyn_estimate";
        public const int ObjectTypeCode = 10037;
        public const string PrimaryIdAttribute = "msdyn_estimateid";
        public const string PrimaryNameAttribute = "msdyn_description";
        
        static Estimate()
        {
            BaseProxyClass.RegisterProxyType(typeof(Estimate), "msdyn_estimate");
        ...
        public Estimate() : base(new Entity("msdyn_estimate")) { }
        public Estimate(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<Estimate>(); }
        /// <summary>
...
///<para>Logical Name: msdyn_estimateid</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_estimateid")]
public Guid EstimateId
{
	get
	{
		return this.Id;
...
/// <summary>
///Logical Name: msdyn_estimateheadertype
/// </summary>
[AttributeLogicalNameAttribute("msdyn_estimateheadertype")]
public eEstimateHeaderType? EstimateHeaderType
{
	get
	{
		if (EstimateHeaderType_OptionSetValue != null) { return (eEstimateHeaderType)EstimateHeaderType_OptionSetValue.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.EstimateHeaderType_OptionSetValue = new OptionSetValue((int)value); }
		else this.EstimateHeaderType_OptionSetValue = null;
	}
}
///<summary>
///<para>Logical Name: msdyn_estimateheadertype</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_estimateheadertype")]
public OptionSetValue EstimateHeaderType_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("msdyn_estimateheadertype"); }
	set { this.SetPropertyValue<OptionSetValue>("msdyn_estimateheadertype", value, "EstimateHeaderType_OptionSetValue"); }
}
/// <summary>
...
/// <returns></returns>
public string EstimateHeaderType_Text(IOrganizationService Service)
{
	return this.EstimateHeaderType_OptionSetValue.GetOptionSetText(Service, this, "msdyn_estimateheadertype");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
...
/// <returns></returns>
public string EstimateHeaderType_Text(EnumAttributeMetadata AttributeMetadata)
{
	return AttributeMetadata.GetOptionSetText(this.EstimateHeaderType_OptionSetValue.Value);
}
///<summary>
...
/// <para>Schema Name: msdyn_estimate_Annotations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_estimate_AsyncOperations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_estimate_BulkDeleteFailures</para>
/// </summary>
...
/// <para>Schema Name: msdyn_estimate_DuplicateBaseRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_estimate_DuplicateMatchingRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_estimate_MailboxTrackingFolders</para>
/// </summary>
...
/// <summary>
/// <para><b>EstimateLine (Estimate)</b></para>
/// <para>Schema Name: msdyn_msdyn_estimate_msdyn_estimateline_Estimate</para>
/// </summary>
public List<EstimateLine> GetEstimateLines_Estimate (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<EstimateLine>(Service, this.Id, "msdyn_estimateline", "msdyn_estimate", Columns); }
/// <summary>
/// <para><b>EstimateLine (Estimate)</b></para>
/// <para>Schema Name: msdyn_msdyn_estimate_msdyn_estimateline_Estimate</para>
/// </summary>
public List<EstimateLine> GetEstimateLines_Estimate (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<EstimateLine>(Service, this.Id, "msdyn_estimateline", "msdyn_estimate", Columns); }
/// <summary>
/// <para><b>Fact (Estimate)</b></para>
/// <para>Schema Name: msdyn_msdyn_estimate_msdyn_fact_Estimate</para>
/// </summary>
public List<Fact> GetFacts_Estimate (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Fact>(Service, this.Id, "msdyn_fact", "msdyn_estimate", Columns); }
/// <summary>
/// <para><b>Fact (Estimate)</b></para>
/// <para>Schema Name: msdyn_msdyn_estimate_msdyn_fact_Estimate</para>
/// </summary>
public List<Fact> GetFacts_Estimate (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Fact>(Service, this.Id, "msdyn_fact", "msdyn_estimate", Columns); }
/// <summary>
/// <para><b>FieldSharing (Entity instance)</b></para>
/// <para>Schema Name: msdyn_estimate_PrincipalObjectAttributeAccesses</para>
/// </summary>
...
/// <para>Schema Name: msdyn_estimate_ProcessSession</para>
/// </summary>
...
/// <para>Schema Name: msdyn_estimate_SyncErrors</para>
/// </summary>
...
/// <para>Schema Name: msdyn_estimate_UserEntityInstanceDatas</para>
/// </summary>
...
public List<UserEntityInstanceData> GetUserEntityInstanceData_ObjectId (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<UserEntityInstanceData>(Service, this.Id, "userentityinstancedata", "objectid", Columns); }
        ...
        public enum eEstimateHeaderType
{
	///<summary><para>Resource based estimate</para>
	///<para>Value = 192350000</para></summary>
	[Description("Resource based estimate")]
	ResourceBasedEstimate = 192350000, 
	///<summary><para>Activity based estimate</para>
	///<para>Value = 192350001</para></summary>
	[Description("Activity based estimate")]
	ActivityBasedEstimate = 192350001, 
	///<summary><para>Assignment based estimate</para>
	///<para>Value = 192350002</para></summary>
	[Description("Assignment based estimate")]
	AssignmentBasedEstimate = 192350002, 
	///<summary><para>Custom estimate</para>
	///<para>Value = 192350003</para></summary>
	[Description("Custom estimate")]
        ...
        public static class Properties
{
	...
	/// <para>msdyn_estimateid</para></summary>
	public const string EstimateId = "msdyn_estimateid";
	/// <summary><para>Estimate Header Type</para>
	/// <para>msdyn_estimateheadertype</para></summary>
	public const string EstimateHeaderType = "msdyn_estimateheadertype";
