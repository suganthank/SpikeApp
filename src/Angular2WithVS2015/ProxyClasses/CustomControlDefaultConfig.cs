...
{
    [EntityLogicalNameAttribute("customcontroldefaultconfig")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class CustomControlDefaultConfig : BaseProxyClass
    {
        public new const string LogicalName = "customcontroldefaultconfig";
        public const int ObjectTypeCode = 9755;
        public const string PrimaryIdAttribute = "customcontroldefaultconfigid";
        public const string PrimaryNameAttribute = "";
        
        static CustomControlDefaultConfig()
        {
            BaseProxyClass.RegisterProxyType(typeof(CustomControlDefaultConfig), "customcontroldefaultconfig");
        ...
        public CustomControlDefaultConfig() : base(new Entity("customcontroldefaultconfig")) { }
        public CustomControlDefaultConfig(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<CustomControlDefaultConfig>(); }
        /// <summary>
...
///<summary>
///<para>Logical Name: customcontroldefaultconfigidunique</para>
///</summary>
[AttributeLogicalNameAttribute("customcontroldefaultconfigidunique")]
public Guid CustomControlDefaultConfigIdUnique
{
	get { return this.GetPropertyValue<Guid>("customcontroldefaultconfigidunique"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: controldescriptionxml</para>
///<para>Max Length: 1073741823 characters</para>
///</summary>
[AttributeLogicalNameAttribute("controldescriptionxml")]
public string ControlDescriptionXML
{
	get { return this.GetPropertyValue<string>("controldescriptionxml"); }
	set { this.SetPropertyValue("controldescriptionxml", value, 1073741823, "ControlDescriptionXML"); }
}
///<summary>
...
///<para>Logical Name: customcontroldefaultconfigid</para>
///</summary>
[AttributeLogicalNameAttribute("customcontroldefaultconfigid")]
public Guid CustomControlDefaultConfigIdentifierId
{
	get
	{
		return this.Id;
...
public string EntityTypeCodeOfTheCustomControlDefaultConfig
{
	...
	set { this.SetPropertyValue<string>("primaryentitytypecode", value, "EntityTypeCodeOfTheCustomControlDefaultConfig"); }
}
///<summary>
///<para>Logical Name: eventsxml</para>
///<para>Max Length: 1073741823 characters</para>
///</summary>
[AttributeLogicalNameAttribute("eventsxml")]
public string EventsXML
{
	get { return this.GetPropertyValue<string>("eventsxml"); }
	set { this.SetPropertyValue("eventsxml", value, 1073741823, "EventsXML"); }
}
///<summary>
        ...
        public static class Properties
{
	...
	/// <summary><para>customcontroldefaultconfigidunique</para>
	/// <para>customcontroldefaultconfigidunique</para></summary>
	...
	/// <summary><para>ControlDescriptionXML</para>
	/// <para>controldescriptionxml</para></summary>
	...
	/// <summary><para>Custom Control Default Config Identifier</para>
	/// <para>customcontroldefaultconfigid</para></summary>
	public const string CustomControlDefaultConfigIdentifierId = "customcontroldefaultconfigid";
	/// <summary><para>Entity Type Code of the Custom Control Default Config</para>
	...
	/// <summary><para>Events XML</para>
	/// <para>eventsxml</para></summary>
