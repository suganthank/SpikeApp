...
{
    [EntityLogicalNameAttribute("msdyn_timegroup")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class TimeGroup : BaseProxyClass
    {
        public new const string LogicalName = "msdyn_timegroup";
        ...
        static TimeGroup()
        {
            BaseProxyClass.RegisterProxyType(typeof(TimeGroup), "msdyn_timegroup");
        ...
        public TimeGroup() : base(new Entity("msdyn_timegroup")) { }
        public TimeGroup(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<TimeGroup>(); }
        /// <summary>
...
///<summary>
///<para>Logical Name: msdyn_displaytopxresultsinsatimegroup</para>
///<para>Minimum Value: 0</para>
///<para>Maximum Value: 2147483647</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_displaytopxresultsinsatimegroup")]
public int? DisplayTopXResultsInScheduleAssistantTimeGroup
{
	get { return this.GetPropertyValue<int?>("msdyn_displaytopxresultsinsatimegroup"); }
	set { this.SetPropertyValue("msdyn_displaytopxresultsinsatimegroup", (int?)value, (int)0, (int)2147483647, "DisplayTopXResultsInScheduleAssistantTimeGroup"); }
}
///<summary>
///<para>Logical Name: msdyn_hidebookingtimeonsa</para>
///<para>True = Yes</para>
///<para>False = No</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_hidebookingtimeonsa")]
public bool? HideBookingTimeOnScheduleAssistant
{
	get { return this.GetPropertyValue<bool?>("msdyn_hidebookingtimeonsa"); }
	set { this.SetPropertyValue<bool?>("msdyn_hidebookingtimeonsa", value, "HideBookingTimeOnScheduleAssistant"); }
}
///<summary>
...
///<para>Logical Name: msdyn_timegroupid</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_timegroupid")]
public Guid TimeGroupId
{
	get
	{
		return this.Id;
...
/// <para>Schema Name: msdyn_timegroup_ActivityPointers</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_Annotations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_Appointments</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_AsyncOperations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_BulkDeleteFailures</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_connections1</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_connections2</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_DuplicateBaseRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_DuplicateMatchingRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_Emails</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_Faxes</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_Letters</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_MailboxTrackingFolders</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_msdyn_approvals</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_msdyn_bookingalerts</para>
/// </summary>
...
/// <summary>
/// <para><b>ResourceRequirement (Time Group)</b></para>
/// <para>Schema Name: msdyn_msdyn_timegroup_msdyn_resourcerequirement_TimeGroup</para>
/// </summary>
public List<ResourceRequirement> GetResourceRequirements_TimeGroup (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ResourceRequirement>(Service, this.Id, "msdyn_resourcerequirement", "msdyn_timegroup", Columns); }
/// <summary>
/// <para><b>ResourceRequirement (Time Group)</b></para>
/// <para>Schema Name: msdyn_msdyn_timegroup_msdyn_resourcerequirement_TimeGroup</para>
/// </summary>
public List<ResourceRequirement> GetResourceRequirements_TimeGroup (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ResourceRequirement>(Service, this.Id, "msdyn_resourcerequirement", "msdyn_timegroup", Columns); }
/// <summary>
/// <para><b>TimeGroupDetail (Time Group)</b></para>
/// <para>Schema Name: msdyn_msdyn_timegroup_msdyn_timegroupdetail</para>
/// </summary>
public List<TimeGroupDetail> GetTimeGroupDetails_TimeGroup (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<TimeGroupDetail>(Service, this.Id, "msdyn_timegroupdetail", "msdyn_timegroupid", Columns); }
/// <summary>
/// <para><b>TimeGroupDetail (Time Group)</b></para>
/// <para>Schema Name: msdyn_msdyn_timegroup_msdyn_timegroupdetail</para>
/// </summary>
public List<TimeGroupDetail> GetTimeGroupDetails_TimeGroup (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<TimeGroupDetail>(Service, this.Id, "msdyn_timegroupdetail", "msdyn_timegroupid", Columns); }
/// <summary>
/// <para><b>WorkOrder (Time Group)</b></para>
/// <para>Schema Name: msdyn_msdyn_timegroup_msdyn_workorder_TimeGroup</para>
/// </summary>
public List<WorkOrder> GetWorkOrders_TimeGroup (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<WorkOrder>(Service, this.Id, "msdyn_workorder", "msdyn_timegroup", Columns); }
/// <summary>
/// <para><b>WorkOrder (Time Group)</b></para>
/// <para>Schema Name: msdyn_msdyn_timegroup_msdyn_workorder_TimeGroup</para>
/// </summary>
public List<WorkOrder> GetWorkOrders_TimeGroup (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<WorkOrder>(Service, this.Id, "msdyn_workorder", "msdyn_timegroup", Columns); }
/// <summary>
/// <para><b>PhoneCall (Regarding)</b></para>
/// <para>Schema Name: msdyn_timegroup_PhoneCalls</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_PrincipalObjectAttributeAccesses</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_ProcessSession</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_QueueItems</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_RecurringAppointmentMasters</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_ServiceAppointments</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_SharePointDocumentLocations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_SocialActivities</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_SyncErrors</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_Tasks</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroup_UserEntityInstanceDatas</para>
/// </summary>
        ...
        public static class Properties
{
	...
	/// <summary><para>Display Top x results in Schedule Assistant Time Group</para>
	/// <para>msdyn_displaytopxresultsinsatimegroup</para></summary>
	public const string DisplayTopXResultsInScheduleAssistantTimeGroup = "msdyn_displaytopxresultsinsatimegroup";
	/// <summary><para>Hide Booking Time On Schedule Assistant</para>
	/// <para>msdyn_hidebookingtimeonsa</para></summary>
	public const string HideBookingTimeOnScheduleAssistant = "msdyn_hidebookingtimeonsa";
	...
	/// <para>msdyn_timegroupid</para></summary>
	public const string TimeGroupId = "msdyn_timegroupid";
