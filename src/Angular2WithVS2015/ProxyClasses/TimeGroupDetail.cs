...
{
    [EntityLogicalNameAttribute("msdyn_timegroupdetail")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class TimeGroupDetail : BaseProxyClass
    {
        public new const string LogicalName = "msdyn_timegroupdetail";
        public const int ObjectTypeCode = 10025;
        public const string PrimaryIdAttribute = "msdyn_timegroupdetailid";
        public const string PrimaryNameAttribute = "msdyn_name";
        
        static TimeGroupDetail()
        {
            BaseProxyClass.RegisterProxyType(typeof(TimeGroupDetail), "msdyn_timegroupdetail");
        ...
        public TimeGroupDetail() : base(new Entity("msdyn_timegroupdetail")) { }
        public TimeGroupDetail(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<TimeGroupDetail>(); }
        /// <summary>
...
///<summary>
///<para>Logical Name: msdyn_timegroupidname</para>
///<para>Max Length: 100 characters</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_timegroupidname")]
public string Msdyn_TimeGroupIdName
{
	get { return this.GetPropertyValue<string>("msdyn_timegroupidname"); }
}
///<summary>
...
{
	get { return this.GetPropertyValue<EntityReference>("msdyn_timegroupid"); }
	set { this.SetPropertyValue<EntityReference>("msdyn_timegroupid", value, "TimeGroup"); }
}
///<summary>
///<para>Key Property (Uniqueidentifier)</para>
///<para>Logical Name: msdyn_timegroupdetailid</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_timegroupdetailid")]
public Guid TimeGroupDetailId
{
	get
	{
		return this.Id;
...
/// <para>Schema Name: msdyn_timegroupdetail_ActivityPointers</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_Annotations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_Appointments</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_AsyncOperations</para>
/// </summary>
...
/// <summary>
/// <para><b>BookableResourceBooking (Time Group Detail Selected)</b></para>
/// <para>Schema Name: msdyn_msdyn_timegroupdetail_bookableresourcebooking_TimeGroupDetailSelected</para>
/// </summary>
public List<BookableResourceBooking> GetBookableResourceBookings_TimeGroupDetailSelected (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<BookableResourceBooking>(Service, this.Id, "bookableresourcebooking", "msdyn_timegroupdetailselected", Columns); }
/// <summary>
/// <para><b>BookableResourceBooking (Time Group Detail Selected)</b></para>
/// <para>Schema Name: msdyn_msdyn_timegroupdetail_bookableresourcebooking_TimeGroupDetailSelected</para>
/// </summary>
public List<BookableResourceBooking> GetBookableResourceBookings_TimeGroupDetailSelected (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<BookableResourceBooking>(Service, this.Id, "bookableresourcebooking", "msdyn_timegroupdetailselected", Columns); }
/// <summary>
/// <para><b>BulkDeleteFailure (Name)</b></para>
/// <para>Schema Name: msdyn_timegroupdetail_BulkDeleteFailures</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_connections1</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_connections2</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_DuplicateBaseRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_DuplicateMatchingRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_Emails</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_Faxes</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_Letters</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_MailboxTrackingFolders</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_msdyn_approvals</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_msdyn_bookingalerts</para>
/// </summary>
...
/// <summary>
/// <para><b>WorkOrder (Time Group Detail Selected (Deprecated))</b></para>
/// <para>Schema Name: msdyn_msdyn_timegroupdetail_msdyn_workorder_TimeGroupDetailSelected</para>
/// </summary>
public List<WorkOrder> GetWorkOrders_TimeGroupDetailSelected_Deprecated (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<WorkOrder>(Service, this.Id, "msdyn_workorder", "msdyn_timegroupdetailselected", Columns); }
/// <summary>
/// <para><b>WorkOrder (Time Group Detail Selected (Deprecated))</b></para>
/// <para>Schema Name: msdyn_msdyn_timegroupdetail_msdyn_workorder_TimeGroupDetailSelected</para>
/// </summary>
public List<WorkOrder> GetWorkOrders_TimeGroupDetailSelected_Deprecated (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<WorkOrder>(Service, this.Id, "msdyn_workorder", "msdyn_timegroupdetailselected", Columns); }
/// <summary>
/// <para><b>PhoneCall (Regarding)</b></para>
/// <para>Schema Name: msdyn_timegroupdetail_PhoneCalls</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_PrincipalObjectAttributeAccesses</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_ProcessSession</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_QueueItems</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_RecurringAppointmentMasters</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_ServiceAppointments</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_SharePointDocumentLocations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_SocialActivities</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_SyncErrors</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_Tasks</para>
/// </summary>
...
/// <para>Schema Name: msdyn_timegroupdetail_UserEntityInstanceDatas</para>
/// </summary>
        ...
        public static class Properties
{
	...
	/// <summary><para>msdyn_timegroupidname</para>
	/// <para>msdyn_timegroupidname</para></summary>
	public const string Msdyn_TimeGroupIdName = "msdyn_timegroupidname";
	...
	public const string TimeGroup = "msdyn_timegroupid";
	/// <summary><para>Time Group Detail</para>
	/// <para>msdyn_timegroupdetailid</para></summary>
	public const string TimeGroupDetailId = "msdyn_timegroupdetailid";
