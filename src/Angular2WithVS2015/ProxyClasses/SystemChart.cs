...
{
    [EntityLogicalNameAttribute("savedqueryvisualization")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class SystemChart : BaseProxyClass
    {
        public new const string LogicalName = "savedqueryvisualization";
        public const int ObjectTypeCode = 1111;
        public const string PrimaryIdAttribute = "savedqueryvisualizationid";
        public const string PrimaryNameAttribute = "name";
        
        static SystemChart()
        {
            BaseProxyClass.RegisterProxyType(typeof(SystemChart), "savedqueryvisualization");
        ...
        public SystemChart() : base(new Entity("savedqueryvisualization")) { }
        public SystemChart(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<SystemChart>(); }
        /// <summary>
...
public eChartUsageArea? FormType
{
	get
	{
		if (FormType_OptionSetValue != null) { return (eChartUsageArea)FormType_OptionSetValue.Value; }
		return null;
	}
	set
	{
...
///<para>Logical Name: savedqueryvisualizationid</para>
///</summary>
[AttributeLogicalNameAttribute("savedqueryvisualizationid")]
public Guid SystemChartId
{
	get
	{
		return this.Id;
...
///<summary>
///<para>Logical Name: savedqueryvisualizationidunique</para>
///</summary>
[AttributeLogicalNameAttribute("savedqueryvisualizationidunique")]
public Guid SystemChartAttribute
{
	get { return this.GetPropertyValue<Guid>("savedqueryvisualizationidunique"); }
}
///<summary>
...
/// <para>Schema Name: SavedQueryVisualization_SyncErrors</para>
/// </summary>
...
/// <para>Schema Name: userentityinstancedata_savedqueryvisualization</para>
/// </summary>
...
{
	///<summary><para>for data centric as well as interaction centric</para>
	///<para>Value = 0</para></summary>
	[Description("for data centric as well as interaction centric")]
	ForDataCentricAsWellAsInteractionCentric = 0, 
	///<summary><para>just for interaction centric</para>
	///<para>Value = 1</para></summary>
	[Description("just for interaction centric")]
        ...
        public static class Properties
{
	...
	/// <para>savedqueryvisualizationid</para></summary>
	public const string SystemChartId = "savedqueryvisualizationid";
	/// <summary><para>System Chart</para>
	/// <para>savedqueryvisualizationidunique</para></summary>
	public const string SystemChartAttribute = "savedqueryvisualizationidunique";
