...
{
    [EntityLogicalNameAttribute("syncattributemapping")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class SyncAttributeMapping : BaseProxyClass
    {
        public new const string LogicalName = "syncattributemapping";
        public const int ObjectTypeCode = 1401;
        public const string PrimaryIdAttribute = "syncattributemappingid";
        public const string PrimaryNameAttribute = "";
        
        static SyncAttributeMapping()
        {
            BaseProxyClass.RegisterProxyType(typeof(SyncAttributeMapping), "syncattributemapping");
        ...
        public SyncAttributeMapping() : base(new Entity("syncattributemapping")) { }
        public SyncAttributeMapping(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<SyncAttributeMapping>(); }
        /// <summary>
...
public string NameOfTheAttributeForWhichThisMappingIsDefined
{
	get { return this.GetPropertyValue<string>("mappingname"); }
	set { this.SetPropertyValue("mappingname", value, 100, "NameOfTheAttributeForWhichThisMappingIsDefined"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: parentsyncattributemappingid</para>
///</summary>
[AttributeLogicalNameAttribute("parentsyncattributemappingid")]
public EntityReference ParentSync_AttributeMapping
{
	get { return this.GetPropertyValue<EntityReference>("parentsyncattributemappingid"); }
	set { this.SetPropertyValue<EntityReference>("parentsyncattributemappingid", value, "ParentSync_AttributeMapping"); }
}
///<summary>
...
{
	get { return this.GetPropertyValue<EntityReference>("syncattributemappingprofileid"); }
	set { this.SetPropertyValue<EntityReference>("syncattributemappingprofileid", value, "Profile"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: syncattributemappingidunique</para>
///</summary>
[AttributeLogicalNameAttribute("syncattributemappingidunique")]
public Guid Sync_AttributeMapping
{
	get { return this.GetPropertyValue<Guid>("syncattributemappingidunique"); }
}
///<summary>
///<para>Key Property (Uniqueidentifier)</para>
///<para>Logical Name: syncattributemappingid</para>
///</summary>
[AttributeLogicalNameAttribute("syncattributemappingid")]
public Guid Sync_AttributeMappingId
{
	get
	{
		return this.Id;
        ...
        public static class Properties
{
	...
	/// <summary><para>Name of the attribute for which this mapping is defined</para>
	/// <para>mappingname</para></summary>
	public const string NameOfTheAttributeForWhichThisMappingIsDefined = "mappingname";
	...
	/// <para>parentsyncattributemappingid</para></summary>
	public const string ParentSync_AttributeMapping = "parentsyncattributemappingid";
	/// <summary><para>Profile</para>
	/// <para>syncattributemappingprofileid</para></summary>
	public const string Profile = "syncattributemappingprofileid";
	...
	/// <para>syncattributemappingidunique</para></summary>
	public const string Sync_AttributeMapping = "syncattributemappingidunique";
	/// <summary><para>Sync-Attribute Mapping Id</para>
	/// <para>syncattributemappingid</para></summary>
	public const string Sync_AttributeMappingId = "syncattributemappingid";
}
