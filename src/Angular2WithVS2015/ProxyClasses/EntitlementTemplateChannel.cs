...
{
    [EntityLogicalNameAttribute("entitlementtemplatechannel")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class EntitlementTemplateChannel : BaseProxyClass
    {
        public new const string LogicalName = "entitlementtemplatechannel";
        public const int ObjectTypeCode = 9703;
        public const string PrimaryIdAttribute = "entitlementtemplatechannelid";
        public const string PrimaryNameAttribute = "name";
        
        static EntitlementTemplateChannel()
        {
            BaseProxyClass.RegisterProxyType(typeof(EntitlementTemplateChannel), "entitlementtemplatechannel");
        ...
        public EntitlementTemplateChannel() : base(new Entity("entitlementtemplatechannel")) { }
        public EntitlementTemplateChannel(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<EntitlementTemplateChannel>(); }
        /// <summary>
...
///<para>Logical Name: entitlementtemplatechannelid</para>
///</summary>
[AttributeLogicalNameAttribute("entitlementtemplatechannelid")]
...
public string EntitlementTemplateChannelName
{
	...
	set { this.SetPropertyValue("name", value, 100, "EntitlementTemplateChannelName"); }
}
///<summary>
...
public EntityReference EntitlementTemplateId
{
	...
	set { this.SetPropertyValue<EntityReference>("entitlementtemplateid", value, "EntitlementTemplateId"); }
}
///<summary>
        ...
        public static class Properties
{
	...
	/// <para>entitlementtemplatechannelid</para></summary>
	public const string EntitlementTemplateChannelId = "entitlementtemplatechannelid";
	/// <summary><para>Entitlement Template Channel Name</para>
	/// <para>name</para></summary>
	public const string EntitlementTemplateChannelName = "name";
	/// <summary><para>Entitlement Template Id</para>
