...
{
    [EntityLogicalNameAttribute("sharepointdocumentlocation")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class DocumentLocation : BaseProxyClass
    {
        public new const string LogicalName = "sharepointdocumentlocation";
        public const int ObjectTypeCode = 9508;
        public const string PrimaryIdAttribute = "sharepointdocumentlocationid";
        public const string PrimaryNameAttribute = "name";
        
        static DocumentLocation()
        {
            BaseProxyClass.RegisterProxyType(typeof(DocumentLocation), "sharepointdocumentlocation");
        ...
        public DocumentLocation() : base(new Entity("sharepointdocumentlocation")) { }
        public DocumentLocation(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<DocumentLocation>(); }
        /// <summary>
...
///<summary>
///<para>Logical Name: parentsiteorlocationname</para>
///<para>Max Length: 160 characters</para>
///</summary>
[AttributeLogicalNameAttribute("parentsiteorlocationname")]
public string ParentSiteOrLocationName
{
	get { return this.GetPropertyValue<string>("parentsiteorlocationname"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: parentsiteorlocationtypecode</para>
///</summary>
[AttributeLogicalNameAttribute("parentsiteorlocationtypecode")]
public string ParentSiteOrLocationTypeCode
{
	get { return this.GetPropertyValue<string>("parentsiteorlocationtypecode"); }
	set { this.SetPropertyValue<string>("parentsiteorlocationtypecode", value, "ParentSiteOrLocationTypeCode"); }
}
///<summary>
...
/// <summary>
///Logical Name: locationtype
/// </summary>
[AttributeLogicalNameAttribute("locationtype")]
public eLocationType? LocationType
{
	get
	{
		if (LocationType_OptionSetValue != null) { return (eLocationType)LocationType_OptionSetValue.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.LocationType_OptionSetValue = new OptionSetValue((int)value); }
		else this.LocationType_OptionSetValue = null;
	}
}
///<summary>
///<para>Logical Name: locationtype</para>
///</summary>
[AttributeLogicalNameAttribute("locationtype")]
public OptionSetValue LocationType_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("locationtype"); }
	set { this.SetPropertyValue<OptionSetValue>("locationtype", value, "LocationType_OptionSetValue"); }
}
/// <summary>
...
/// <returns></returns>
public string LocationType_Text(IOrganizationService Service)
{
	return this.LocationType_OptionSetValue.GetOptionSetText(Service, this, "locationtype");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
...
/// <returns></returns>
public string LocationType_Text(EnumAttributeMetadata AttributeMetadata)
{
	return AttributeMetadata.GetOptionSetText(this.LocationType_OptionSetValue.Value);
}
///<summary>
...
///<summary>
///<para>Logical Name: parentsiteorlocation</para>
///</summary>
[AttributeLogicalNameAttribute("parentsiteorlocation")]
public EntityReference ParentSiteOrLocation
{
	get { return this.GetPropertyValue<EntityReference>("parentsiteorlocation"); }
	set { this.SetPropertyValue<EntityReference>("parentsiteorlocation", value, "ParentSiteOrLocation"); }
}
///<summary>
...
public string RelativeURL
{
	...
	set { this.SetPropertyValue("relativeurl", value, 255, "RelativeURL"); }
}
/// <summary>
...
///<para>Logical Name: sharepointdocumentlocationid</para>
///</summary>
[AttributeLogicalNameAttribute("sharepointdocumentlocationid")]
public Guid SharePointDocumentLocationIDId
{
	get
	{
		return this.Id;
...
public Guid SharePointDocumentLocationOwner
{
	get { return this.GetPropertyValue<Guid>("userid"); }
	set { this.SetPropertyValue<Guid>("userid", value, "SharePointDocumentLocationOwner"); }
}
/// <summary>
...
/// <para>Schema Name: SharePointDocumentLocation_AsyncOperations</para>
/// </summary>
...
/// <para>Schema Name: SharePointDocumentLocation_DuplicateBaseRecord</para>
/// </summary>
...
/// <para>Schema Name: SharePointDocumentLocation_DuplicateMatchingRecord</para>
/// </summary>
...
/// <para>Schema Name: sharepointdocumentlocation_principalobjectattributeaccess</para>
/// </summary>
...
/// <para>Schema Name: SharePointDocumentLocation_ProcessSessions</para>
/// </summary>
...
/// <summary>
/// <para><b>SharePointData (Location)</b></para>
/// <para>Schema Name: sharepointdata_sharepointdocumentlocation</para>
/// </summary>
public List<SharePointData> GetSharePointData_Location (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<SharePointData>(Service, this.Id, "sharepointdata", "location", Columns); }
/// <summary>
/// <para><b>SharePointData (Location)</b></para>
/// <para>Schema Name: sharepointdata_sharepointdocumentlocation</para>
/// </summary>
public List<SharePointData> GetSharePointData_Location (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<SharePointData>(Service, this.Id, "sharepointdata", "location", Columns); }
/// <summary>
/// <para><b>DocumentLocation (Parent Site or Location)</b></para>
/// <para>Schema Name: sharepointdocumentlocation_parent_sharepointdocumentlocation</para>
/// </summary>
...
/// <para>Schema Name: SharePointDocumentLocation_SyncErrors</para>
/// </summary>
...
/// <para>Schema Name: userentityinstancedata_sharepointdocumentlocation</para>
/// </summary>
        ...
        public static class Properties
{
	...
	/// <summary><para>parentsiteorlocationname</para>
	/// <para>parentsiteorlocationname</para></summary>
	...
	/// <summary><para>parentsiteorlocationtypecode</para>
	/// <para>parentsiteorlocationtypecode</para></summary>
	...
	/// <summary><para>Location Type </para>
	/// <para>locationtype</para></summary>
	...
	/// <summary><para>Parent Site or Location</para>
	/// <para>parentsiteorlocation</para></summary>
	...
	/// <summary><para>SharePoint Document Location ID</para>
	/// <para>sharepointdocumentlocationid</para></summary>
	public const string SharePointDocumentLocationIDId = "sharepointdocumentlocationid";
	/// <summary><para>SharePoint Document Location Owner</para>
	/// <para>userid</para></summary>
	public const string SharePointDocumentLocationOwner = "userid";
