...
{
    [EntityLogicalNameAttribute("msdyn_projecttaskstatususer")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class ProjectTaskStatusUser : BaseProxyClass
    {
        public new const string LogicalName = "msdyn_projecttaskstatususer";
        public const int ObjectTypeCode = 10071;
        public const string PrimaryIdAttribute = "msdyn_projecttaskstatususerid";
        public const string PrimaryNameAttribute = "msdyn_name";
        
        static ProjectTaskStatusUser()
        {
            BaseProxyClass.RegisterProxyType(typeof(ProjectTaskStatusUser), "msdyn_projecttaskstatususer");
        ...
        public ProjectTaskStatusUser() : base(new Entity("msdyn_projecttaskstatususer")) { }
        public ProjectTaskStatusUser(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<ProjectTaskStatusUser>(); }
        /// <summary>
...
///<summary>
///<para>Logical Name: msdyn_projecttaskidname</para>
///<para>Max Length: 100 characters</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_projecttaskidname")]
public string Msdyn_projecttaskIdName
{
	get { return this.GetPropertyValue<string>("msdyn_projecttaskidname"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: msdyn_expectedcompletiondate</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_expectedcompletiondate")]
public DateTime? ExpectedCompletionDate
{
	get { return this.GetPropertyValue<DateTime?>("msdyn_expectedcompletiondate"); }
	set { this.SetPropertyValue<DateTime?>("msdyn_expectedcompletiondate", value, "ExpectedCompletionDate"); }
}
///<summary>
///<para>Logical Name: msdyn_expectedhourstocomplete</para>
///<para>Minimum Value: 0</para>
///<para>Maximum Value: 1000000000</para>
///<para>Precision: 2</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_expectedhourstocomplete")]
public double? ExpectedHoursToComplete
{
	get { return this.GetPropertyValue<double?>("msdyn_expectedhourstocomplete"); }
	set { this.SetPropertyValue("msdyn_expectedhourstocomplete", (double?)value, (double)0, (double)1000000000, "ExpectedHoursToComplete"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: msdyn_iscompleted</para>
///<para>True = Yes</para>
///<para>False = No</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_iscompleted")]
public bool? IsCompleted
{
	get { return this.GetPropertyValue<bool?>("msdyn_iscompleted"); }
	set { this.SetPropertyValue<bool?>("msdyn_iscompleted", value, "IsCompleted"); }
}
///<summary>
...
public string Name
{
	...
	set { this.SetPropertyValue("msdyn_name", value, 450, "Name"); }
}
///<summary>
...
{
	get { return this.GetPropertyValue<int?>("msdyn_percentcomplete"); }
	set { this.SetPropertyValue("msdyn_percentcomplete", (int?)value, (int)0, (int)100, "PercentComplete"); }
}
///<summary>
...
{
	get { return this.GetPropertyValue<EntityReference>("msdyn_projecttaskid"); }
	set { this.SetPropertyValue<EntityReference>("msdyn_projecttaskid", value, "ProjectTask"); }
}
/// <summary>
///Logical Name: msdyn_projecttaskstatusindicator
/// </summary>
[AttributeLogicalNameAttribute("msdyn_projecttaskstatusindicator")]
public eProjectTaskStatusIndicators? ProjectTaskStatusIndicator
{
	get
	{
		if (ProjectTaskStatusIndicator_OptionSetValue != null) { return (eProjectTaskStatusIndicators)ProjectTaskStatusIndicator_OptionSetValue.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.ProjectTaskStatusIndicator_OptionSetValue = new OptionSetValue((int)value); }
		else this.ProjectTaskStatusIndicator_OptionSetValue = null;
	}
}
///<summary>
///<para>Logical Name: msdyn_projecttaskstatusindicator</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_projecttaskstatusindicator")]
public OptionSetValue ProjectTaskStatusIndicator_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("msdyn_projecttaskstatusindicator"); }
	set { this.SetPropertyValue<OptionSetValue>("msdyn_projecttaskstatusindicator", value, "ProjectTaskStatusIndicator_OptionSetValue"); }
}
/// <summary>
...
/// <returns></returns>
public string ProjectTaskStatusIndicator_Text(IOrganizationService Service)
{
	return this.ProjectTaskStatusIndicator_OptionSetValue.GetOptionSetText(Service, this, "msdyn_projecttaskstatusindicator");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
...
/// <returns></returns>
public string ProjectTaskStatusIndicator_Text(EnumAttributeMetadata AttributeMetadata)
{
	return AttributeMetadata.GetOptionSetText(this.ProjectTaskStatusIndicator_OptionSetValue.Value);
}
///<summary>
///<para>Key Property (Uniqueidentifier)</para>
///<para>Logical Name: msdyn_projecttaskstatususerid</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_projecttaskstatususerid")]
public Guid ProjectTaskStatusUserId
{
	get
	{
		return this.Id;
...
/// <para>Schema Name: msdyn_projecttaskstatususer_Annotations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_projecttaskstatususer_AsyncOperations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_projecttaskstatususer_BulkDeleteFailures</para>
/// </summary>
...
/// <para>Schema Name: msdyn_projecttaskstatususer_DuplicateBaseRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_projecttaskstatususer_DuplicateMatchingRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_projecttaskstatususer_MailboxTrackingFolders</para>
/// </summary>
...
/// <para>Schema Name: msdyn_projecttaskstatususer_PrincipalObjectAttributeAccesses</para>
/// </summary>
...
/// <para>Schema Name: msdyn_projecttaskstatususer_ProcessSession</para>
/// </summary>
...
/// <para>Schema Name: msdyn_projecttaskstatususer_SyncErrors</para>
/// </summary>
...
/// <para>Schema Name: msdyn_projecttaskstatususer_UserEntityInstanceDatas</para>
/// </summary>
...
public List<UserEntityInstanceData> GetUserEntityInstanceData_ObjectId (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<UserEntityInstanceData>(Service, this.Id, "userentityinstancedata", "objectid", Columns); }
        ...
        public enum eProjectTaskStatusIndicators
{
        ...
        public static class Properties
{
	...
	/// <summary><para>msdyn_projecttaskidname</para>
	/// <para>msdyn_projecttaskidname</para></summary>
	public const string Msdyn_projecttaskIdName = "msdyn_projecttaskidname";
	...
	/// <summary><para>Expected Completion Date</para>
	/// <para>msdyn_expectedcompletiondate</para></summary>
	public const string ExpectedCompletionDate = "msdyn_expectedcompletiondate";
	/// <summary><para>Expected Hours To Complete</para>
	/// <para>msdyn_expectedhourstocomplete</para></summary>
	public const string ExpectedHoursToComplete = "msdyn_expectedhourstocomplete";
	/// <summary><para>Import Sequence Number</para>
	/// <para>importsequencenumber</para></summary>
	public const string ImportSequenceNumber = "importsequencenumber";
	/// <summary><para>Is Completed</para>
	/// <para>msdyn_iscompleted</para></summary>
	public const string IsCompleted = "msdyn_iscompleted";
	...
	public const string PercentComplete = "msdyn_percentcomplete";
	/// <summary><para>Project Task</para>
	/// <para>msdyn_projecttaskid</para></summary>
	public const string ProjectTask = "msdyn_projecttaskid";
	/// <summary><para>Project Task Status Indicator</para>
	/// <para>msdyn_projecttaskstatusindicator</para></summary>
	public const string ProjectTaskStatusIndicator = "msdyn_projecttaskstatusindicator";
	/// <summary><para>Project Task Status User</para>
	/// <para>msdyn_projecttaskstatususerid</para></summary>
	public const string ProjectTaskStatusUserId = "msdyn_projecttaskstatususerid";
