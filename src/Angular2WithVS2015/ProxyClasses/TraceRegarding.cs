...
{
    [EntityLogicalNameAttribute("traceregarding")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class TraceRegarding : BaseProxyClass
    {
        public new const string LogicalName = "traceregarding";
        public const int ObjectTypeCode = 8052;
        public const string PrimaryIdAttribute = "traceregardingid";
        public const string PrimaryNameAttribute = "";
        
        static TraceRegarding()
        {
            BaseProxyClass.RegisterProxyType(typeof(TraceRegarding), "traceregarding");
        ...
        public TraceRegarding() : base(new Entity("traceregarding")) { }
        public TraceRegarding(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<TraceRegarding>(); }
        /// <summary>
...
public string OwnerType
{
	...
	set { this.SetPropertyValue<string>("regardingobjectowneridtype", value, "OwnerType"); }
}
///<summary>
...
public string RegardingObjectTypeForSharing
{
...
public Guid TraceRegardingId
{
	...
	set
	{
        ...
        /// <summary>
/// <para><b>Trace (Trace Regarding)</b></para>
/// <para>Schema Name: tracelog_TraceRegardings</para>
/// </summary>
public List<Trace> GetTraces_TraceRegarding (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Trace>(Service, this.Id, "tracelog", "traceregardingid", Columns); }
/// <summary>
/// <para><b>Trace (Trace Regarding)</b></para>
/// <para>Schema Name: tracelog_TraceRegardings</para>
/// </summary>
public List<Trace> GetTraces_TraceRegarding (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Trace>(Service, this.Id, "tracelog", "traceregardingid", Columns); }
        ...
        public static class Properties
{
	...
	/// <summary><para>Regarding Object Type For Sharing</para>
	/// <para>regardingobjecttypecodeforsharing</para></summary>
	public const string RegardingObjectTypeForSharing = "regardingobjecttypecodeforsharing";
