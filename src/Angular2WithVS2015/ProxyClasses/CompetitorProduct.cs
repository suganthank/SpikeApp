...
{
    [EntityLogicalNameAttribute("competitorproduct")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class CompetitorProduct : BaseProxyClass
    {
        public new const string LogicalName = "competitorproduct";
        public const int ObjectTypeCode = 1006;
        public const string PrimaryIdAttribute = "competitorproductid";
        public const string PrimaryNameAttribute = "";
        
        static CompetitorProduct()
        {
            BaseProxyClass.RegisterProxyType(typeof(CompetitorProduct), "competitorproduct");
        ...
        public CompetitorProduct() : base(new Entity("competitorproduct")) { }
        public CompetitorProduct(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<CompetitorProduct>(); }
        /// <summary>
...
///<para>Logical Name: competitorproductid</para>
///</summary>
[AttributeLogicalNameAttribute("competitorproductid")]
...
/// <para>Schema Name: userentityinstancedata_competitorproduct</para>
/// </summary>
...
/// </summary>
public List<Competitor> GetCompetitors (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<Competitor>(Service, this, "competitorproduct", "competitorproductid", "competitor", "competitorid", "competitorproduct", "productid", "competitorid", Columns); }
public List<Competitor> GetCompetitors (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<Competitor>(Service, this, "competitorproduct", "competitorproductid", "competitor", "competitorid", "competitorproduct", "productid", "competitorid", Columns); }
        ...
        public static class Properties
{
	...
	/// <summary><para>competitorproductid</para>
	/// <para>competitorproductid</para></summary>
