...
{
    [EntityLogicalNameAttribute("mobileofflineprofileitemassociation")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class MobileOfflineProfileItemAssociation : BaseProxyClass
    {
        public new const string LogicalName = "mobileofflineprofileitemassociation";
        public const int ObjectTypeCode = 9868;
        public const string PrimaryIdAttribute = "mobileofflineprofileitemassociationid";
        public const string PrimaryNameAttribute = "name";
        
        static MobileOfflineProfileItemAssociation()
        {
            BaseProxyClass.RegisterProxyType(typeof(MobileOfflineProfileItemAssociation), "mobileofflineprofileitemassociation");
        ...
        public MobileOfflineProfileItemAssociation() : base(new Entity("mobileofflineprofileitemassociation")) { }
        public MobileOfflineProfileItemAssociation(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<MobileOfflineProfileItemAssociation>(); }
        /// <summary>
...
///<summary>
///<para>Logical Name: mobileofflineprofileitemidname</para>
///<para>Max Length: 100 characters</para>
///</summary>
[AttributeLogicalNameAttribute("mobileofflineprofileitemidname")]
public string MobileOfflineProfileItemIdName
{
	get { return this.GetPropertyValue<string>("mobileofflineprofileitemidname"); }
	set { this.SetPropertyValue("mobileofflineprofileitemidname", value, 100, "MobileOfflineProfileItemIdName"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: selectedrelationshipsschema</para>
///</summary>
[AttributeLogicalNameAttribute("selectedrelationshipsschema")]
public OptionSetValue EntityRelationship
{
	get { return this.GetPropertyValue<OptionSetValue>("selectedrelationshipsschema"); }
	set { this.SetPropertyValue<OptionSetValue>("selectedrelationshipsschema", value, "EntityRelationship"); }
}
///<summary>
///<para>Logical Name: relationshipdisplayname</para>
///<para>Max Length: 200 characters</para>
///</summary>
[AttributeLogicalNameAttribute("relationshipdisplayname")]
public string EntityRelationship2
{
	get { return this.GetPropertyValue<string>("relationshipdisplayname"); }
	set { this.SetPropertyValue("relationshipdisplayname", value, 200, "EntityRelationship2"); }
}
///<summary>
...
public string EntityRelationship3
{
...
///<para>Logical Name: mobileofflineprofileitemassociationid</para>
///</summary>
[AttributeLogicalNameAttribute("mobileofflineprofileitemassociationid")]
...
///<summary>
///<para>Logical Name: profileitemassociationentityfilter</para>
///<para>Max Length: 1073741823 characters</para>
///</summary>
[AttributeLogicalNameAttribute("profileitemassociationentityfilter")]
public string ProfileItemAssociationEntityFilter
{
	get { return this.GetPropertyValue<string>("profileitemassociationentityfilter"); }
	set { this.SetPropertyValue("profileitemassociationentityfilter", value, 1073741823, "ProfileItemAssociationEntityFilter"); }
}
///<summary>
...
{
	get { return this.GetPropertyValue<EntityReference>("mobileofflineprofileitemid"); }
	set { this.SetPropertyValue<EntityReference>("mobileofflineprofileitemid", value, "Regarding"); }
}
///<summary>
///<para>Logical Name: relationshipid</para>
///</summary>
[AttributeLogicalNameAttribute("relationshipid")]
public Guid ShowsTheRelationship
{
	get { return this.GetPropertyValue<Guid>("relationshipid"); }
	set { this.SetPropertyValue<Guid>("relationshipid", value, "ShowsTheRelationship"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: mobileofflineprofileitemassociationidunique</para>
///</summary>
[AttributeLogicalNameAttribute("mobileofflineprofileitemassociationidunique")]
public Guid UniqueId
{
	get { return this.GetPropertyValue<Guid>("mobileofflineprofileitemassociationidunique"); }
}
///<summary>
        ...
        public static class Properties
{
	...
	/// <summary><para>mobileofflineprofileitemidname</para>
	/// <para>mobileofflineprofileitemidname</para></summary>
	...
	/// <para>selectedrelationshipsschema</para></summary>
	public const string EntityRelationship = "selectedrelationshipsschema";
	/// <summary><para>Entity Relationship</para>
	/// <para>relationshipdisplayname</para></summary>
	public const string EntityRelationship2 = "relationshipdisplayname";
	/// <summary><para>Entity Relationship</para>
	/// <para>relationshipname</para></summary>
	public const string EntityRelationship3 = "relationshipname";
	...
	/// <summary><para>Mobile Offline profileitemassociation</para>
	/// <para>mobileofflineprofileitemassociationid</para></summary>
	...
	/// <summary><para>Profile item association entity filter</para>
	/// <para>profileitemassociationentityfilter</para></summary>
	...
	/// <summary><para>Shows the relationship</para>
	/// <para>relationshipid</para></summary>
	public const string ShowsTheRelationship = "relationshipid";
	...
	/// <para>mobileofflineprofileitemassociationidunique</para></summary>
