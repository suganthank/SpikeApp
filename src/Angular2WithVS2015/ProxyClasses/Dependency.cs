...
namespace ProxyClasses
{
    ...
    public partial class Dependency : BaseProxyClass
    {
        public new const string LogicalName = "dependency";
        public const int ObjectTypeCode = 7105;
        public const string PrimaryIdAttribute = "dependencyid";
        public const string PrimaryNameAttribute = "";
        
        static Dependency()
        {
            BaseProxyClass.RegisterProxyType(typeof(Dependency), "dependency");
        ...
        public Dependency() : base(new Entity("dependency")) { }
        public Dependency(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<Dependency>(); }
        /// <summary>
        ...
        ///<summary>
///<para>Logical Name: dependentcomponentparentid</para>
///</summary>
[AttributeLogicalNameAttribute("dependentcomponentparentid")]
public Guid DependentComponentParentId
{
	get { return this.GetPropertyValue<Guid>("dependentcomponentparentid"); }
}
/// <summary>
///Logical Name: dependentcomponenttype
/// </summary>
[AttributeLogicalNameAttribute("dependentcomponenttype")]
public eComponentType? DependentComponentType
{
	get
	{
		if (DependentComponentType_OptionSetValue != null) { return (eComponentType)DependentComponentType_OptionSetValue.Value; }
		return null;
	}
}
///<summary>
///<para>Logical Name: dependentcomponenttype</para>
///</summary>
[AttributeLogicalNameAttribute("dependentcomponenttype")]
public OptionSetValue DependentComponentType_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("dependentcomponenttype"); }
}
/// <summary>
...
/// <returns></returns>
public string DependentComponentType_Text(IOrganizationService Service)
{
	return this.DependentComponentType_OptionSetValue.GetOptionSetText(Service, this, "dependentcomponenttype");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
...
/// <returns></returns>
public string DependentComponentType_Text(EnumAttributeMetadata AttributeMetadata)
{
	return AttributeMetadata.GetOptionSetText(this.DependentComponentType_OptionSetValue.Value);
}
///<summary>
///<para>Logical Name: requiredcomponentbasesolutionid</para>
///</summary>
[AttributeLogicalNameAttribute("requiredcomponentbasesolutionid")]
public Guid RequiredComponentBaseSolutionId
{
	get { return this.GetPropertyValue<Guid>("requiredcomponentbasesolutionid"); }
}
///<summary>
///<para>Logical Name: requiredcomponentintroducedversion</para>
///<para>Minimum Value: 0</para>
///<para>Maximum Value: 1000000000</para>
///<para>Precision: 2</para>
///</summary>
[AttributeLogicalNameAttribute("requiredcomponentintroducedversion")]
public double? RequiredComponentIntroducedVersion
{
	get { return this.GetPropertyValue<double?>("requiredcomponentintroducedversion"); }
}
///<summary>
///<para>Logical Name: requiredcomponentparentid</para>
///</summary>
[AttributeLogicalNameAttribute("requiredcomponentparentid")]
public Guid RequiredComponentParentId
{
	get { return this.GetPropertyValue<Guid>("requiredcomponentparentid"); }
}
///<summary>
///<para>Logical Name: dependentcomponentobjectid</para>
///</summary>
[AttributeLogicalNameAttribute("dependentcomponentobjectid")]
public Guid DependentComponentObjectId
{
	get { return this.GetPropertyValue<Guid>("dependentcomponentobjectid"); }
}
///<summary>
///<para>Logical Name: dependentcomponentbasesolutionid</para>
///</summary>
[AttributeLogicalNameAttribute("dependentcomponentbasesolutionid")]
public Guid DependentComponentBaseSolutionId
{
	get { return this.GetPropertyValue<Guid>("dependentcomponentbasesolutionid"); }
}
/// <summary>
///Logical Name: requiredcomponenttype
/// </summary>
[AttributeLogicalNameAttribute("requiredcomponenttype")]
public eComponentType? RequiredComponentType
{
	get
	{
		if (RequiredComponentType_OptionSetValue != null) { return (eComponentType)RequiredComponentType_OptionSetValue.Value; }
		return null;
	}
}
///<summary>
///<para>Logical Name: requiredcomponenttype</para>
///</summary>
[AttributeLogicalNameAttribute("requiredcomponenttype")]
public OptionSetValue RequiredComponentType_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("requiredcomponenttype"); }
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
/// <param name="Service">CRM Organization Service</param>
/// <returns></returns>
public string RequiredComponentType_Text(IOrganizationService Service)
{
	return this.RequiredComponentType_OptionSetValue.GetOptionSetText(Service, this, "requiredcomponenttype");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
/// <param name="AttributeMetadata">The attribute metadata previously retrieved using the 'GetAttributeMetadata' extension method on the IOrganizationService object.</param>
/// <returns></returns>
public string RequiredComponentType_Text(EnumAttributeMetadata AttributeMetadata)
{
	return AttributeMetadata.GetOptionSetText(this.RequiredComponentType_OptionSetValue.Value);
}
///<summary>
///<para>Logical Name: requiredcomponentobjectid</para>
///</summary>
[AttributeLogicalNameAttribute("requiredcomponentobjectid")]
public Guid RequiredComponentObjectId
{
	get { return this.GetPropertyValue<Guid>("requiredcomponentobjectid"); }
}
///<summary>
///<para>Key Property (Uniqueidentifier)</para>
///<para>Logical Name: dependencyid</para>
///</summary>
...
/// <summary>
///Logical Name: dependencytype
/// </summary>
[AttributeLogicalNameAttribute("dependencytype")]
public eDependencyType? DependencyType
{
	get
	{
		if (DependencyType_OptionSetValue != null) { return (eDependencyType)DependencyType_OptionSetValue.Value; }
		return null;
	}
}
///<summary>
///<para>Logical Name: dependencytype</para>
///</summary>
[AttributeLogicalNameAttribute("dependencytype")]
public OptionSetValue DependencyType_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("dependencytype"); }
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
/// <param name="Service">CRM Organization Service</param>
/// <returns></returns>
public string DependencyType_Text(IOrganizationService Service)
{
	return this.DependencyType_OptionSetValue.GetOptionSetText(Service, this, "dependencytype");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
/// <param name="AttributeMetadata">The attribute metadata previously retrieved using the 'GetAttributeMetadata' extension method on the IOrganizationService object.</param>
/// <returns></returns>
public string DependencyType_Text(EnumAttributeMetadata AttributeMetadata)
{
	return AttributeMetadata.GetOptionSetText(this.DependencyType_OptionSetValue.Value);
}
///<summary>
///<para>Logical Name: dependentcomponentnodeid</para>
///</summary>
[AttributeLogicalNameAttribute("dependentcomponentnodeid")]
public EntityReference DependentComponent
{
	get { return this.GetPropertyValue<EntityReference>("dependentcomponentnodeid"); }
}
///<summary>
///<para>Logical Name: requiredcomponentnodeid</para>
///</summary>
[AttributeLogicalNameAttribute("requiredcomponentnodeid")]
public EntityReference RequiredComponent
{
	get { return this.GetPropertyValue<EntityReference>("requiredcomponentnodeid"); }
}


        /// <summary>
/// <para><b>UserEntityInstanceData (Object Id)</b></para>
/// <para>Schema Name: userentityinstancedata_dependency</para>
/// </summary>
...
public enum eDependencyType
{
	...
	[Description("None")]
	None = 0, 
	///<summary><para>Solution Internal</para>
	///<para>Value = 1</para></summary>
	[Description("Solution Internal")]
	SolutionInternal = 1, 
...
{
	/// <summary><para>dependentcomponentparentid</para>
	/// <para>dependentcomponentparentid</para></summary>
	public const string DependentComponentParentId = "dependentcomponentparentid";
	/// <summary><para>dependentcomponenttype</para>
	/// <para>dependentcomponenttype</para></summary>
	public const string DependentComponentType = "dependentcomponenttype";
	/// <summary><para>requiredcomponentbasesolutionid</para>
	/// <para>requiredcomponentbasesolutionid</para></summary>
	public const string RequiredComponentBaseSolutionId = "requiredcomponentbasesolutionid";
	/// <summary><para>requiredcomponentintroducedversion</para>
	/// <para>requiredcomponentintroducedversion</para></summary>
	public const string RequiredComponentIntroducedVersion = "requiredcomponentintroducedversion";
	/// <summary><para>requiredcomponentparentid</para>
	/// <para>requiredcomponentparentid</para></summary>
	public const string RequiredComponentParentId = "requiredcomponentparentid";
	/// <summary><para>dependentcomponentobjectid</para>
	/// <para>dependentcomponentobjectid</para></summary>
	public const string DependentComponentObjectId = "dependentcomponentobjectid";
	/// <summary><para>dependentcomponentbasesolutionid</para>
	/// <para>dependentcomponentbasesolutionid</para></summary>
	public const string DependentComponentBaseSolutionId = "dependentcomponentbasesolutionid";
	/// <summary><para>requiredcomponenttype</para>
	/// <para>requiredcomponenttype</para></summary>
	public const string RequiredComponentType = "requiredcomponenttype";
	/// <summary><para>requiredcomponentobjectid</para>
	/// <para>requiredcomponentobjectid</para></summary>
	public const string RequiredComponentObjectId = "requiredcomponentobjectid";
	/// <summary><para>Dependency Identifier</para>
	/// <para>dependencyid</para></summary>
	public const string DependencyIdentifierId = "dependencyid";
	/// <summary><para>Dependency Type</para>
	/// <para>dependencytype</para></summary>
	public const string DependencyType = "dependencytype";
	/// <summary><para>Dependent Component</para>
	/// <para>dependentcomponentnodeid</para></summary>
	public const string DependentComponent = "dependentcomponentnodeid";
	/// <summary><para>Required Component</para>
	/// <para>requiredcomponentnodeid</para></summary>
