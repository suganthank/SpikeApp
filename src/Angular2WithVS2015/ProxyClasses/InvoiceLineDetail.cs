...
{
    [EntityLogicalNameAttribute("msdyn_invoicelinetransaction")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class InvoiceLineDetail : BaseProxyClass
    {
        public new const string LogicalName = "msdyn_invoicelinetransaction";
        public const int ObjectTypeCode = 10049;
        ...
        static InvoiceLineDetail()
        {
            BaseProxyClass.RegisterProxyType(typeof(InvoiceLineDetail), "msdyn_invoicelinetransaction");
        ...
        public InvoiceLineDetail() : base(new Entity("msdyn_invoicelinetransaction")) { }
        public InvoiceLineDetail(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<InvoiceLineDetail>(); }
        /// <summary>
...
///<summary>
///<para>Logical Name: msdyn_originalinvoicelinedetailname</para>
///<para>Max Length: 100 characters</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_originalinvoicelinedetailname")]
public string Msdyn_OriginalInvoiceLineDetailName
{
	get { return this.GetPropertyValue<string>("msdyn_originalinvoicelinedetailname"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: msdyn_correction</para>
///<para>True = Yes</para>
///<para>False = No</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_correction")]
public bool? Correction
{
	get { return this.GetPropertyValue<bool?>("msdyn_correction"); }
	set { this.SetPropertyValue<bool?>("msdyn_correction", value, "Correction"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: msdyn_invoiceamount</para>
///<para>Minimum Value: -922337203685477</para>
///<para>Maximum Value: 922337203685477</para>
///<para>Precision: 2</para>
///</summary>
public decimal? InvoiceAmount
{
	get
	{
		if (InvoiceAmountMoney != null) { return InvoiceAmountMoney.Value; }
		return null;
	}
}
///<summary>
...
///<para>Precision: 2</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_invoiceamount")]
public Money InvoiceAmountMoney
{
	get { return this.GetPropertyValue<Money>("msdyn_invoiceamount"); }
}
///<summary>
///<para>Logical Name: msdyn_invoiceamount_base</para>
///<para>Minimum Value: -922337203685477</para>
///<para>Maximum Value: 922337203685477</para>
///<para>Precision: 2</para>
///</summary>
public decimal? InvoiceAmount_Base
{
	get
	{
		if (InvoiceAmount_BaseMoney != null) { return InvoiceAmount_BaseMoney.Value; }
		return null;
	}
}
///<summary>
...
///<para>Precision: 2</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_invoiceamount_base")]
public Money InvoiceAmount_BaseMoney
{
	get { return this.GetPropertyValue<Money>("msdyn_invoiceamount_base"); }
}
///<summary>
///<para>Logical Name: msdyn_invoiceline</para>
///<para>Max Length: 100 characters</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_invoiceline")]
public string InvoiceLine
{
	get { return this.GetPropertyValue<string>("msdyn_invoiceline"); }
	set { this.SetPropertyValue("msdyn_invoiceline", value, 100, "InvoiceLine"); }
}
///<summary>
///<para>Key Property (Uniqueidentifier)</para>
///<para>Logical Name: msdyn_invoicelinetransactionid</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_invoicelinetransactionid")]
public Guid InvoiceLineDetailId
{
	get
	{
		return this.Id;
...
///<summary>
///<para>Logical Name: msdyn_originalinvoicelinedetail</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_originalinvoicelinedetail")]
public EntityReference OriginalInvoiceLineDetail
{
	get { return this.GetPropertyValue<EntityReference>("msdyn_originalinvoicelinedetail"); }
	set { this.SetPropertyValue<EntityReference>("msdyn_originalinvoicelinedetail", value, "OriginalInvoiceLineDetail"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: msdyn_previousamount</para>
///<para>Minimum Value: -922337203685477</para>
///<para>Maximum Value: 922337203685477</para>
///<para>Precision: 4</para>
///</summary>
public decimal? PreviousAmount
{
	get
	{
		if (PreviousAmountMoney != null) { return PreviousAmountMoney.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.PreviousAmountMoney = new Money(value.Value); }
		else this.PreviousAmountMoney = null;
	}
}
///<summary>
///<para>Logical Name: msdyn_previousamount</para>
...
///<para>Precision: 4</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_previousamount")]
public Money PreviousAmountMoney
{
	get { return this.GetPropertyValue<Money>("msdyn_previousamount"); }
	set { this.SetPropertyValue("msdyn_previousamount", (Money)value, (decimal)-922337203685477, (decimal)922337203685477, "PreviousAmountMoney"); }
}
///<summary>
///<para>Logical Name: msdyn_previousamount_base</para>
///<para>Minimum Value: -922337203685477</para>
///<para>Maximum Value: 922337203685477</para>
///<para>Precision: 4</para>
///</summary>
public decimal? PreviousAmount_Base
{
	get
	{
		if (PreviousAmount_BaseMoney != null) { return PreviousAmount_BaseMoney.Value; }
		return null;
	}
}
///<summary>
...
///<para>Precision: 4</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_previousamount_base")]
public Money PreviousAmount_BaseMoney
{
	get { return this.GetPropertyValue<Money>("msdyn_previousamount_base"); }
}
///<summary>
...
public DateTime? StartDate
{
	...
	set { this.SetPropertyValue<DateTime?>("msdyn_startdatetime", value, "StartDate"); }
}
/// <summary>
...
/// <para>Schema Name: msdyn_invoicelinetransaction_Annotations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_invoicelinetransaction_AsyncOperations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_invoicelinetransaction_BulkDeleteFailures</para>
/// </summary>
...
/// <para>Schema Name: msdyn_invoicelinetransaction_DuplicateBaseRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_invoicelinetransaction_DuplicateMatchingRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_invoicelinetransaction_MailboxTrackingFolders</para>
/// </summary>
...
/// <summary>
/// <para><b>InvoiceLineDetail (Original Invoice Line Detail)</b></para>
/// <para>Schema Name: msdyn_msdyn_invoicelinetransaction_msdyn_invoicelinetransaction_OriginalInvoiceLineDetail</para>
/// </summary>
public List<InvoiceLineDetail> GetInvoiceLineDetails_OriginalInvoiceLineDetail (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<InvoiceLineDetail>(Service, this.Id, "msdyn_invoicelinetransaction", "msdyn_originalinvoicelinedetail", Columns); }
/// <summary>
/// <para><b>InvoiceLineDetail (Original Invoice Line Detail)</b></para>
/// <para>Schema Name: msdyn_msdyn_invoicelinetransaction_msdyn_invoicelinetransaction_OriginalInvoiceLineDetail</para>
/// </summary>
public List<InvoiceLineDetail> GetInvoiceLineDetails_OriginalInvoiceLineDetail (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<InvoiceLineDetail>(Service, this.Id, "msdyn_invoicelinetransaction", "msdyn_originalinvoicelinedetail", Columns); }
/// <summary>
/// <para><b>FieldSharing (Entity instance)</b></para>
/// <para>Schema Name: msdyn_invoicelinetransaction_PrincipalObjectAttributeAccesses</para>
/// </summary>
...
/// <para>Schema Name: msdyn_invoicelinetransaction_ProcessSession</para>
/// </summary>
...
/// <para>Schema Name: msdyn_invoicelinetransaction_SyncErrors</para>
/// </summary>
...
/// <para>Schema Name: msdyn_invoicelinetransaction_UserEntityInstanceDatas</para>
/// </summary>
        ...
        public static class Properties
{
	...
	/// <summary><para>msdyn_originalinvoicelinedetailname</para>
	/// <para>msdyn_originalinvoicelinedetailname</para></summary>
	public const string Msdyn_OriginalInvoiceLineDetailName = "msdyn_originalinvoicelinedetailname";
	...
	/// <summary><para>Correction</para>
	/// <para>msdyn_correction</para></summary>
	public const string Correction = "msdyn_correction";
	...
	/// <summary><para>Invoice Amount</para>
	/// <para>msdyn_invoiceamount</para></summary>
	public const string InvoiceAmount = "msdyn_invoiceamount";
	/// <summary><para>Invoice Amount (Base)</para>
	/// <para>msdyn_invoiceamount_base</para></summary>
	public const string InvoiceAmount_Base = "msdyn_invoiceamount_base";
	/// <summary><para>Invoice Line</para>
	/// <para>msdyn_invoiceline</para></summary>
	public const string InvoiceLine = "msdyn_invoiceline";
	/// <summary><para>Invoice Line Detail</para>
	/// <para>msdyn_invoicelinetransactionid</para></summary>
	public const string InvoiceLineDetailId = "msdyn_invoicelinetransactionid";
	...
	/// <summary><para>Original Invoice Line Detail</para>
	/// <para>msdyn_originalinvoicelinedetail</para></summary>
	public const string OriginalInvoiceLineDetail = "msdyn_originalinvoicelinedetail";
	...
	/// <summary><para>Previous Amount</para>
	/// <para>msdyn_previousamount</para></summary>
	public const string PreviousAmount = "msdyn_previousamount";
	/// <summary><para>Previous Amount (Base)</para>
	/// <para>msdyn_previousamount_base</para></summary>
	public const string PreviousAmount_Base = "msdyn_previousamount_base";
	...
	public const string StartDate = "msdyn_startdatetime";
