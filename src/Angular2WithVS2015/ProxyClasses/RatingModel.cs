...
/// <summary>
///Logical Name: msdyn_ratableentity
/// </summary>
[AttributeLogicalNameAttribute("msdyn_ratableentity")]
public eRatableEntity? RatableEntity
{
	get
	{
		if (RatableEntity_OptionSetValue != null) { return (eRatableEntity)RatableEntity_OptionSetValue.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.RatableEntity_OptionSetValue = new OptionSetValue((int)value); }
		else this.RatableEntity_OptionSetValue = null;
	}
}
///<summary>
///<para>Logical Name: msdyn_ratableentity</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_ratableentity")]
public OptionSetValue RatableEntity_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("msdyn_ratableentity"); }
	set { this.SetPropertyValue<OptionSetValue>("msdyn_ratableentity", value, "RatableEntity_OptionSetValue"); }
}
/// <summary>
...
/// <returns></returns>
public string RatableEntity_Text(IOrganizationService Service)
{
	return this.RatableEntity_OptionSetValue.GetOptionSetText(Service, this, "msdyn_ratableentity");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
...
/// <returns></returns>
public string RatableEntity_Text(EnumAttributeMetadata AttributeMetadata)
{
	return AttributeMetadata.GetOptionSetText(this.RatableEntity_OptionSetValue.Value);
}
///<summary>
...
/// <summary>
/// <para><b>RatingValue (Rating Model)</b></para>
/// <para>Schema Name: ratingmodel_ratingvalue_RatingModel</para>
/// </summary>
public List<RatingValue> GetRatingValues_RatingModel (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RatingValue>(Service, this.Id, "ratingvalue", "ratingmodel", Columns); }
/// <summary>
/// <para><b>RatingValue (Rating Model)</b></para>
/// <para>Schema Name: ratingmodel_ratingvalue_RatingModel</para>
/// </summary>
public List<RatingValue> GetRatingValues_RatingModel (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<RatingValue>(Service, this.Id, "ratingvalue", "ratingmodel", Columns); }
/// <summary>
        ...
        public static class Properties
{
	...
	/// <summary><para>Ratable Entity</para>
	/// <para>msdyn_ratableentity</para></summary>
	public const string RatableEntity = "msdyn_ratableentity";
