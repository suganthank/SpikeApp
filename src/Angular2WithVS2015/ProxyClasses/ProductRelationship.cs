...
{
    [EntityLogicalNameAttribute("productsubstitute")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class ProductRelationship : BaseProxyClass
    {
        public new const string LogicalName = "productsubstitute";
        public const int ObjectTypeCode = 1028;
        public const string PrimaryIdAttribute = "productsubstituteid";
        public const string PrimaryNameAttribute = "";
        
        static ProductRelationship()
        {
            BaseProxyClass.RegisterProxyType(typeof(ProductRelationship), "productsubstitute");
        ...
        public ProductRelationship() : base(new Entity("productsubstitute")) { }
        public ProductRelationship(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<ProductRelationship>(); }
        /// <summary>
...
///<summary>
///<para>Logical Name: substitutedproductidname</para>
///<para>Max Length: 100 characters</para>
///</summary>
[AttributeLogicalNameAttribute("substitutedproductidname")]
public string SubstitutedProductIdName
{
	get { return this.GetPropertyValue<string>("substitutedproductidname"); }
}
///<summary>
...
public eDirection? Direction
{
	get
	{
		if (Direction_OptionSetValue != null) { return (eDirection)Direction_OptionSetValue.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.Direction_OptionSetValue = new OptionSetValue((int)value); }
		else this.Direction_OptionSetValue = null;
	}
}
///<summary>
///<para>Logical Name: direction</para>
///</summary>
[AttributeLogicalNameAttribute("direction")]
public OptionSetValue Direction_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("direction"); }
	set { this.SetPropertyValue<OptionSetValue>("direction", value, "Direction_OptionSetValue"); }
}
/// <summary>
...
/// <returns></returns>
public string Direction_Text(IOrganizationService Service)
{
	return this.Direction_OptionSetValue.GetOptionSetText(Service, this, "direction");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
...
/// <returns></returns>
public string Direction_Text(EnumAttributeMetadata AttributeMetadata)
{
	return AttributeMetadata.GetOptionSetText(this.Direction_OptionSetValue.Value);
}
///<summary>
...
///<para>Logical Name: productsubstituteid</para>
///</summary>
[AttributeLogicalNameAttribute("productsubstituteid")]
public Guid ProductRelationshipIDId
{
	get
	{
		return this.Id;
...
///<summary>
///<para>Logical Name: substitutedproductid</para>
///</summary>
[AttributeLogicalNameAttribute("substitutedproductid")]
public EntityReference RelatedProduct
{
	get { return this.GetPropertyValue<EntityReference>("substitutedproductid"); }
	set { this.SetPropertyValue<EntityReference>("substitutedproductid", value, "RelatedProduct"); }
}
/// <summary>
///Logical Name: salesrelationshiptype
/// </summary>
...
public eSalesRelationshipType? SalesRelationshipType
{
	get
	{
		if (SalesRelationshipType_OptionSetValue != null) { return (eSalesRelationshipType)SalesRelationshipType_OptionSetValue.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.SalesRelationshipType_OptionSetValue = new OptionSetValue((int)value); }
		else this.SalesRelationshipType_OptionSetValue = null;
	}
}
///<summary>
///<para>Logical Name: salesrelationshiptype</para>
///</summary>
[AttributeLogicalNameAttribute("salesrelationshiptype")]
public OptionSetValue SalesRelationshipType_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("salesrelationshiptype"); }
	set { this.SetPropertyValue<OptionSetValue>("salesrelationshiptype", value, "SalesRelationshipType_OptionSetValue"); }
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
/// <param name="Service">CRM Organization Service</param>
/// <returns></returns>
public string SalesRelationshipType_Text(IOrganizationService Service)
{
	return this.SalesRelationshipType_OptionSetValue.GetOptionSetText(Service, this, "salesrelationshiptype");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
/// <param name="AttributeMetadata">The attribute metadata previously retrieved using the 'GetAttributeMetadata' extension method on the IOrganizationService object.</param>
/// <returns></returns>
public string SalesRelationshipType_Text(EnumAttributeMetadata AttributeMetadata)
{
	return AttributeMetadata.GetOptionSetText(this.SalesRelationshipType_OptionSetValue.Value);
}
/// <summary>
...
/// <para>Schema Name: ProductSubstitute_AsyncOperations</para>
/// </summary>
...
/// <para>Schema Name: ProductSubstitute_BulkDeleteFailures</para>
/// </summary>
...
/// <para>Schema Name: ProductSubstitute_PrincipalObjectAttributeAccess</para>
/// </summary>
...
/// <para>Schema Name: ProductSubstitute_ProcessSession</para>
/// </summary>
...
/// <para>Schema Name: ProductSubstitute_SyncErrors</para>
/// </summary>
...
{
	///<summary><para>Uni-Directional</para>
	///<para>Value = 0</para></summary>
	[Description("Uni-Directional")]
	Uni_Directional = 0, 
	///<summary><para>Bi-Directional</para>
        ...
        public static class Properties
{
	...
	/// <summary><para>substitutedproductidname</para>
	/// <para>substitutedproductidname</para></summary>
	...
	/// <summary><para>Product Relationship ID</para>
	/// <para>productsubstituteid</para></summary>
	public const string ProductRelationshipIDId = "productsubstituteid";
	/// <summary><para>Record Created On</para>
	/// <para>overriddencreatedon</para></summary>
	public const string RecordCreatedOn = "overriddencreatedon";
	/// <summary><para>Related Product</para>
	/// <para>substitutedproductid</para></summary>
	public const string RelatedProduct = "substitutedproductid";
	/// <summary><para>Sales Relationship Type</para>
	/// <para>salesrelationshiptype</para></summary>
