...
namespace ProxyClasses
{
    ...
    public partial class Appointment : BaseProxyClass
    {
        ...
        static Appointment()
        {
            BaseProxyClass.RegisterProxyType(typeof(Appointment), "appointment");
        ...
        public Appointment() : base(new Entity("appointment")) { }
        public Appointment(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<Appointment>(); }
        /// <summary>
...
public eAttachmentErrors? AttachmentErrors
{
	get
	{
		if (AttachmentErrors_OptionSetValue != null) { return (eAttachmentErrors)AttachmentErrors_OptionSetValue.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.AttachmentErrors_OptionSetValue = new OptionSetValue((int)value); }
		else this.AttachmentErrors_OptionSetValue = null;
	}
}
///<summary>
///<para>Logical Name: attachmenterrors</para>
///</summary>
[AttributeLogicalNameAttribute("attachmenterrors")]
public OptionSetValue AttachmentErrors_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("attachmenterrors"); }
	set { this.SetPropertyValue<OptionSetValue>("attachmenterrors", value, "AttachmentErrors_OptionSetValue"); }
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
...
{
	return this.AttachmentErrors_OptionSetValue.GetOptionSetText(Service, this, "attachmenterrors");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
...
public int? Duration
{
	...
	set { this.SetPropertyValue("scheduleddurationminutes", (int?)value, (int)0, (int)2147483647, "Duration"); }
}
///<summary>
...
public DateTime? EndTime
{
	...
	set { this.SetPropertyValue<DateTime?>("scheduledend", value, "EndTime"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: modifiedfieldsmask</para>
...
{
	get { return this.GetPropertyValue<string>("modifiedfieldsmask"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: originalstartdate</para>
///</summary>
[AttributeLogicalNameAttribute("originalstartdate")]
public DateTime? OriginalStartDate
{
	get { return this.GetPropertyValue<DateTime?>("originalstartdate"); }
}
///<summary>
...
public string OutlookAppointment
{
	...
	set { this.SetPropertyValue("globalobjectid", value, 300, "OutlookAppointment"); }
}
///<summary>
...
public int? OutlookAppointmentOwner
{
	...
	set { this.SetPropertyValue("outlookownerapptid", (int?)value, (int)-2147483648, (int)2147483647, "OutlookAppointmentOwner"); }
}
///<summary>
...
public DateTime? StartTime
{
	...
	set { this.SetPropertyValue<DateTime?>("scheduledstart", value, "StartTime"); }
}
/// <summary>
...
/// <para>Schema Name: appointment_actioncard</para>
/// </summary>
...
/// <para>Schema Name: appointment_activity_mime_attachment</para>
/// </summary>
...
/// <para>Schema Name: appointment_activity_parties</para>
/// </summary>
...
/// <para>Schema Name: Appointment_Annotation</para>
/// </summary>
...
/// <para>Schema Name: Appointment_AsyncOperations</para>
/// </summary>
...
/// <para>Schema Name: Appointment_BulkDeleteFailures</para>
/// </summary>
...
/// <para>Schema Name: appointment_campaignresponse</para>
/// </summary>
...
/// <para>Schema Name: appointment_connections1</para>
/// </summary>
...
/// <para>Schema Name: appointment_connections2</para>
/// </summary>
...
/// <para>Schema Name: Appointment_DuplicateBaseRecord</para>
/// </summary>
...
/// <para>Schema Name: Appointment_DuplicateMatchingRecord</para>
/// </summary>
...
/// <para>Schema Name: appointment_PostFollows</para>
/// </summary>
...
/// <para>Schema Name: appointment_PostRegardings</para>
/// </summary>
...
/// <para>Schema Name: appointment_PostRoles</para>
/// </summary>
...
/// <para>Schema Name: appointment_principalobjectattributeaccess</para>
/// </summary>
...
/// <para>Schema Name: Appointment_ProcessSessions</para>
/// </summary>
...
/// <para>Schema Name: Appointment_QueueItem</para>
/// </summary>
...
/// <para>Schema Name: slakpiinstance_appointment</para>
/// </summary>
...
/// <para>Schema Name: Appointment_SyncErrors</para>
/// </summary>
...
/// <para>Schema Name: userentityinstancedata_appointment</para>
/// </summary>
...
public enum eAttachmentErrors
{
	...
	[Description("None")]
	None = 0, 
	///<summary><para>The appointment was saved as a Microsoft Dynamics 365 appointment record, but not all the attachments could be saved with it. An attachment cannot be saved if it is blocked or if its file type is invalid.</para>
	///<para>Value = 1</para></summary>
	[Description("The appointment was saved as a Microsoft Dynamics 365 appointment record, but not all the attachments could be saved with it. An attachment cannot be saved if it is blocked or if its file type is invalid.")]
	TheAppointmentWasSavedAsAMicrosoftDynamics365AppointmentRecord_ButNotAllTheAttachmentsCouldBeSavedWithIt_AnAttachmentCannotBeSavedIfItIsBlockedOrIfItsFileTypeIsInvalid = 1
}
        ...
        public static class Properties
{
	...
	/// <summary><para>AttachmentErrors</para>
	/// <para>attachmenterrors</para></summary>
	...
	/// <summary><para>Modified Fields Mask</para>
	/// <para>modifiedfieldsmask</para></summary>
	...
	/// <summary><para>Original Start Date</para>
	/// <para>originalstartdate</para></summary>
	public const string OriginalStartDate = "originalstartdate";
	/// <summary><para>Outlook Appointment</para>
	/// <para>globalobjectid</para></summary>
	public const string OutlookAppointment = "globalobjectid";
	/// <summary><para>Outlook Appointment Owner</para>
