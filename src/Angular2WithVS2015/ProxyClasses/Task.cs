...
/// </summary>
public List<Subscription> GetSubscriptions (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<Subscription>(Service, this, "task", "activityid", "subscription", "subscriptionid", "subscriptionmanuallytrackedobject", "objectid", "subscriptionid", Columns); }
public List<Subscription> GetSubscriptions (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<Subscription>(Service, this, "task", "activityid", "subscription", "subscriptionid", "subscriptionmanuallytrackedobject", "objectid", "subscriptionid", Columns); }
