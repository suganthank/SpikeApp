...
{
    [EntityLogicalNameAttribute("msdyn_characteristicreqforteammember")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class CompetencyRequirement_Deprecated : BaseProxyClass
    {
        public new const string LogicalName = "msdyn_characteristicreqforteammember";
        public const int ObjectTypeCode = 10031;
        public const string PrimaryIdAttribute = "msdyn_characteristicreqforteammemberid";
        public const string PrimaryNameAttribute = "msdyn_name";
        
        static CompetencyRequirement_Deprecated()
        {
            BaseProxyClass.RegisterProxyType(typeof(CompetencyRequirement_Deprecated), "msdyn_characteristicreqforteammember");
        ...
        public CompetencyRequirement_Deprecated() : base(new Entity("msdyn_characteristicreqforteammember")) { }
        public CompetencyRequirement_Deprecated(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<CompetencyRequirement_Deprecated>(); }
        /// <summary>
...
///<summary>
///<para>Logical Name: msdyn_ratingvaluename</para>
///<para>Max Length: 100 characters</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_ratingvaluename")]
public string Msdyn_ratingvalueName
{
	get { return this.GetPropertyValue<string>("msdyn_ratingvaluename"); }
}
///<summary>
...
/// <summary>
///Logical Name: msdyn_characteristictype
/// </summary>
[AttributeLogicalNameAttribute("msdyn_characteristictype")]
public eBookableResourceCharacteristicType? BookableCharacteristicType
{
	get
	{
		if (BookableCharacteristicType_OptionSetValue != null) { return (eBookableResourceCharacteristicType)BookableCharacteristicType_OptionSetValue.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.BookableCharacteristicType_OptionSetValue = new OptionSetValue((int)value); }
		else this.BookableCharacteristicType_OptionSetValue = null;
	}
}
///<summary>
///<para>Logical Name: msdyn_characteristictype</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_characteristictype")]
public OptionSetValue BookableCharacteristicType_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("msdyn_characteristictype"); }
	set { this.SetPropertyValue<OptionSetValue>("msdyn_characteristictype", value, "BookableCharacteristicType_OptionSetValue"); }
}
/// <summary>
...
/// <returns></returns>
public string BookableCharacteristicType_Text(IOrganizationService Service)
{
	return this.BookableCharacteristicType_OptionSetValue.GetOptionSetText(Service, this, "msdyn_characteristictype");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
...
/// <returns></returns>
public string BookableCharacteristicType_Text(EnumAttributeMetadata AttributeMetadata)
{
	return AttributeMetadata.GetOptionSetText(this.BookableCharacteristicType_OptionSetValue.Value);
}
///<summary>
...
///<para>Logical Name: msdyn_characteristicreqforteammemberid</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_characteristicreqforteammemberid")]
public Guid CharacteristicRequirementForTeamMemberId
{
	get
	{
		return this.Id;
...
///<summary>
///<para>Logical Name: msdyn_ratingvalue</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_ratingvalue")]
public EntityReference RatingValue
{
	get { return this.GetPropertyValue<EntityReference>("msdyn_ratingvalue"); }
	set { this.SetPropertyValue<EntityReference>("msdyn_ratingvalue", value, "RatingValue"); }
}
///<summary>
...
/// <para>Schema Name: msdyn_characteristicreqforteammember_Annotations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_characteristicreqforteammember_AsyncOperations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_characteristicreqforteammember_BulkDeleteFailures</para>
/// </summary>
...
/// <para>Schema Name: msdyn_characteristicreqforteammember_DuplicateBaseRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_characteristicreqforteammember_DuplicateMatchingRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_characteristicreqforteammember_MailboxTrackingFolders</para>
/// </summary>
...
/// <para>Schema Name: msdyn_characteristicreqforteammember_PrincipalObjectAttributeAccesses</para>
/// </summary>
...
/// <para>Schema Name: msdyn_characteristicreqforteammember_ProcessSession</para>
/// </summary>
...
/// <para>Schema Name: msdyn_characteristicreqforteammember_SyncErrors</para>
/// </summary>
...
/// <para>Schema Name: msdyn_characteristicreqforteammember_UserEntityInstanceDatas</para>
/// </summary>
        ...
        public static class Properties
{
	...
	/// <summary><para>msdyn_ratingvaluename</para>
	/// <para>msdyn_ratingvaluename</para></summary>
	public const string Msdyn_ratingvalueName = "msdyn_ratingvaluename";
	...
	/// <summary><para>Bookable Characteristic Type</para>
	/// <para>msdyn_characteristictype</para></summary>
	public const string BookableCharacteristicType = "msdyn_characteristictype";
	...
	/// <summary><para>Characteristic requirement for team member</para>
	/// <para>msdyn_characteristicreqforteammemberid</para></summary>
	public const string CharacteristicRequirementForTeamMemberId = "msdyn_characteristicreqforteammemberid";
	...
	/// <para>msdyn_ratingvalue</para></summary>
	public const string RatingValue = "msdyn_ratingvalue";
