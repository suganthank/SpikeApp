...
{
    [EntityLogicalNameAttribute("internaladdress")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class InternalAddress : BaseProxyClass
    {
        public new const string LogicalName = "internaladdress";
        public const int ObjectTypeCode = 1003;
        public const string PrimaryIdAttribute = "internaladdressid";
        public const string PrimaryNameAttribute = "";
        
        static InternalAddress()
        {
            BaseProxyClass.RegisterProxyType(typeof(InternalAddress), "internaladdress");
        ...
        public InternalAddress() : base(new Entity("internaladdress")) { }
        public InternalAddress(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<InternalAddress>(); }
        /// <summary>
...
public string City
{
	...
	set { this.SetPropertyValue("city", value, 128, "City"); }
}
///<summary>
...
public string Country_Region
{
	...
	set { this.SetPropertyValue("country", value, 128, "Country_Region"); }
}
///<summary>
...
public string Fax
{
	...
	set { this.SetPropertyValue("fax", value, 64, "Fax"); }
}
///<summary>
///<para>Key Property (Uniqueidentifier)</para>
///<para>Logical Name: internaladdressid</para>
///</summary>
[AttributeLogicalNameAttribute("internaladdressid")]
...
public string MainPhone
{
	...
	set { this.SetPropertyValue("telephone1", value, 64, "MainPhone"); }
}
///<summary>
...
public Guid Parent
{
	...
	set { this.SetPropertyValue<Guid>("parentid", value, "Parent"); }
}
///<summary>
...
public string Phone3
{
	...
	set { this.SetPropertyValue("telephone3", value, 50, "Phone3"); }
}
///<summary>
...
public string State_Province
{
	...
	set { this.SetPropertyValue("stateorprovince", value, 128, "State_Province"); }
}
///<summary>
...
public string Street1
{
	...
	set { this.SetPropertyValue("line1", value, 1024, "Street1"); }
}
///<summary>
...
public string ZIP_PostalCode
{
	...
	set { this.SetPropertyValue("postalcode", value, 40, "ZIP_PostalCode"); }
}


        /// <summary>
/// <para><b>SyncError (Record)</b></para>
/// <para>Schema Name: InternalAddress_SyncErrors</para>
/// </summary>
...
/// <para>Schema Name: userentityinstancedata_internaladdress</para>
/// </summary>
        ...
        public static class Properties
{
	...
	/// <para>internaladdressid</para></summary>
