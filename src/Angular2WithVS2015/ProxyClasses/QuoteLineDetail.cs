...
{
    [EntityLogicalNameAttribute("msdyn_quotelinetransaction")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class QuoteLineDetail : BaseProxyClass
    {
        public new const string LogicalName = "msdyn_quotelinetransaction";
        public const int ObjectTypeCode = 10079;
        ...
        static QuoteLineDetail()
        {
            BaseProxyClass.RegisterProxyType(typeof(QuoteLineDetail), "msdyn_quotelinetransaction");
        ...
        public QuoteLineDetail() : base(new Entity("msdyn_quotelinetransaction")) { }
        public QuoteLineDetail(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<QuoteLineDetail>(); }
        /// <summary>
...
///<summary>
///<para>Logical Name: msdyn_quoteidname</para>
///<para>Max Length: 100 characters</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_quoteidname")]
public string Msdyn_QuoteIdName
{
	get { return this.GetPropertyValue<string>("msdyn_quoteidname"); }
}
///<summary>
///<para>Logical Name: msdyn_originname</para>
///<para>Max Length: 100 characters</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_originname")]
public string Msdyn_OriginName
{
	get { return this.GetPropertyValue<string>("msdyn_originname"); }
}
///<summary>
...
public eAmountMethod? AmountCalculationMethod
{
	get
	{
		if (AmountCalculationMethod_OptionSetValue != null) { return (eAmountMethod)AmountCalculationMethod_OptionSetValue.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.AmountCalculationMethod_OptionSetValue = new OptionSetValue((int)value); }
		else this.AmountCalculationMethod_OptionSetValue = null;
	}
}
///<summary>
...
///</summary>
[AttributeLogicalNameAttribute("msdyn_amountmethod")]
public OptionSetValue AmountCalculationMethod_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("msdyn_amountmethod"); }
	set { this.SetPropertyValue<OptionSetValue>("msdyn_amountmethod", value, "AmountCalculationMethod_OptionSetValue"); }
}
/// <summary>
...
/// <returns></returns>
public string AmountCalculationMethod_Text(IOrganizationService Service)
{
	return this.AmountCalculationMethod_OptionSetValue.GetOptionSetText(Service, this, "msdyn_amountmethod");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
...
/// <returns></returns>
public string AmountCalculationMethod_Text(EnumAttributeMetadata AttributeMetadata)
{
	return AttributeMetadata.GetOptionSetText(this.AmountCalculationMethod_OptionSetValue.Value);
}
///<summary>
...
public Money BasisAmountMoney
{
	...
	set { this.SetPropertyValue("msdyn_basisamount", (Money)value, (decimal)-922337203685477, (decimal)922337203685477, "BasisAmountMoney"); }
}
///<summary>
...
public Money BasisPriceMoney
{
	...
	set { this.SetPropertyValue("msdyn_basisprice", (Money)value, (decimal)-922337203685477, (decimal)922337203685477, "BasisPriceMoney"); }
}
///<summary>
...
public decimal? BasisQuantity
{
	...
	set { this.SetPropertyValue("msdyn_basisquantity", (decimal?)value, (decimal)-100000000000, (decimal)100000000000, "BasisQuantity"); }
}
/// <summary>
...
public EntityReference ContactCustomer
{
	get { return this.GetPropertyValue<EntityReference>("msdyn_contactcustomer"); }
	set { this.SetPropertyValue<EntityReference>("msdyn_contactcustomer", value, "ContactCustomer"); }
}
///<summary>
...
public EntityReference Customer
{
	...
	set { this.SetPropertyValue<EntityReference>("msdyn_accountcustomer", value, "Customer"); }
}
/// <summary>
...
///<summary>
///<para>Logical Name: msdyn_origin</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_origin")]
public EntityReference Origin
{
	get { return this.GetPropertyValue<EntityReference>("msdyn_origin"); }
	set { this.SetPropertyValue<EntityReference>("msdyn_origin", value, "Origin"); }
}
///<summary>
...
public decimal? Percent
{
	...
	set { this.SetPropertyValue("msdyn_percent", (decimal?)value, (decimal)-100000000000, (decimal)100000000000, "Percent"); }
}
///<summary>
...
public EntityReference ProjectTask
{
	...
	set { this.SetPropertyValue<EntityReference>("msdyn_task", value, "ProjectTask"); }
}
///<summary>
...
///<summary>
///<para>Logical Name: msdyn_quoteid</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_quoteid")]
public EntityReference Quote
{
	get { return this.GetPropertyValue<EntityReference>("msdyn_quoteid"); }
	set { this.SetPropertyValue<EntityReference>("msdyn_quoteid", value, "Quote"); }
}
///<summary>
...
///<para>Logical Name: msdyn_quotelinetransactionid</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_quotelinetransactionid")]
public Guid QuoteLineDetailId
{
	get
	{
		return this.Id;
...
/// <para>Schema Name: msdyn_quotelinetransaction_Annotations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_quotelinetransaction_AsyncOperations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_quotelinetransaction_BulkDeleteFailures</para>
/// </summary>
...
/// <para>Schema Name: msdyn_quotelinetransaction_DuplicateBaseRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_quotelinetransaction_DuplicateMatchingRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_quotelinetransaction_MailboxTrackingFolders</para>
/// </summary>
...
/// <summary>
/// <para><b>QuoteLineAnalyticsBreakdown (Quote Line Detail)</b></para>
/// <para>Schema Name: msdyn_msdyn_quotelinetransaction_msdyn_quotelineanalyticsbreakdown_QuoteLineDetail</para>
/// </summary>
public List<QuoteLineAnalyticsBreakdown> GetQuoteLineAnalyticsBreakdown_QuoteLineDetail (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<QuoteLineAnalyticsBreakdown>(Service, this.Id, "msdyn_quotelineanalyticsbreakdown", "msdyn_quotelinedetail", Columns); }
/// <summary>
/// <para><b>QuoteLineAnalyticsBreakdown (Quote Line Detail)</b></para>
/// <para>Schema Name: msdyn_msdyn_quotelinetransaction_msdyn_quotelineanalyticsbreakdown_QuoteLineDetail</para>
/// </summary>
public List<QuoteLineAnalyticsBreakdown> GetQuoteLineAnalyticsBreakdown_QuoteLineDetail (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<QuoteLineAnalyticsBreakdown>(Service, this.Id, "msdyn_quotelineanalyticsbreakdown", "msdyn_quotelinedetail", Columns); }
/// <summary>
/// <para><b>QuoteLineDetail (Origin)</b></para>
/// <para>Schema Name: msdyn_msdyn_quotelinetransaction_msdyn_quotelinetransaction_Origin</para>
/// </summary>
public List<QuoteLineDetail> GetQuoteLineDetail_Origin (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<QuoteLineDetail>(Service, this.Id, "msdyn_quotelinetransaction", "msdyn_origin", Columns); }
/// <summary>
/// <para><b>QuoteLineDetail (Origin)</b></para>
/// <para>Schema Name: msdyn_msdyn_quotelinetransaction_msdyn_quotelinetransaction_Origin</para>
/// </summary>
public List<QuoteLineDetail> GetQuoteLineDetail_Origin (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<QuoteLineDetail>(Service, this.Id, "msdyn_quotelinetransaction", "msdyn_origin", Columns); }
/// <summary>
/// <para><b>FieldSharing (Entity instance)</b></para>
/// <para>Schema Name: msdyn_quotelinetransaction_PrincipalObjectAttributeAccesses</para>
/// </summary>
...
/// <para>Schema Name: msdyn_quotelinetransaction_ProcessSession</para>
/// </summary>
...
/// <para>Schema Name: msdyn_quotelinetransaction_SyncErrors</para>
/// </summary>
...
/// <para>Schema Name: msdyn_quotelinetransaction_UserEntityInstanceDatas</para>
/// </summary>
        ...
        public static class Properties
{
	...
	/// <summary><para>msdyn_quoteidname</para>
	/// <para>msdyn_quoteidname</para></summary>
	public const string Msdyn_QuoteIdName = "msdyn_quoteidname";
	/// <summary><para>msdyn_originname</para>
	/// <para>msdyn_originname</para></summary>
	public const string Msdyn_OriginName = "msdyn_originname";
	...
	/// <summary><para>Amount calculation method</para>
	/// <para>msdyn_amountmethod</para></summary>
	public const string AmountCalculationMethod = "msdyn_amountmethod";
	...
	/// <summary><para>Contact Customer</para>
	/// <para>msdyn_contactcustomer</para></summary>
	public const string ContactCustomer = "msdyn_contactcustomer";
	...
	public const string Customer = "msdyn_accountcustomer";
	...
	/// <para>msdyn_origin</para></summary>
	public const string Origin = "msdyn_origin";
	...
	public const string ProjectTask = "msdyn_task";
	...
	/// <para>msdyn_quoteid</para></summary>
	public const string Quote = "msdyn_quoteid";
	...
	/// <para>msdyn_quotelinetransactionid</para></summary>
	public const string QuoteLineDetailId = "msdyn_quotelinetransactionid";
