...
{
    [EntityLogicalNameAttribute("systemuserprofiles")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class SystemUserProfiles : BaseProxyClass
    {
        public new const string LogicalName = "systemuserprofiles";
        public const int ObjectTypeCode = 1202;
        public const string PrimaryIdAttribute = "systemuserprofileid";
        public const string PrimaryNameAttribute = "";
        
        static SystemUserProfiles()
        {
            BaseProxyClass.RegisterProxyType(typeof(SystemUserProfiles), "systemuserprofiles");
        ...
        public SystemUserProfiles() : base(new Entity("systemuserprofiles")) { }
        public SystemUserProfiles(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<SystemUserProfiles>(); }
        /// <summary>
...
///<para>Logical Name: systemuserprofileid</para>
///</summary>
[AttributeLogicalNameAttribute("systemuserprofileid")]
...
/// </summary>
public List<User> GetUsers (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<User>(Service, this, "systemuserprofiles", "systemuserprofileid", "systemuser", "systemuserid", "systemuserprofiles", "fieldsecurityprofileid", "systemuserid", Columns); }
public List<User> GetUsers (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<User>(Service, this, "systemuserprofiles", "systemuserprofileid", "systemuser", "systemuserid", "systemuserprofiles", "fieldsecurityprofileid", "systemuserid", Columns); }
        ...
        public static class Properties
{
	...
	/// <summary><para>systemuserprofileid</para>
	/// <para>systemuserprofileid</para></summary>
