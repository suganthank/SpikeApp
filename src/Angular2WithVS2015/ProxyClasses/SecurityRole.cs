...
/// </summary>
public List<App> GetApps (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<App>(Service, this, "role", "roleid", "appmodule", "appmoduleid", "appmoduleroles", "roleid", "appmoduleid", Columns); }
public List<App> GetApps (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<App>(Service, this, "role", "roleid", "appmodule", "appmoduleid", "appmoduleroles", "roleid", "appmoduleid", Columns); }
...
/// </summary>
public List<Privilege> GetPrivileges (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<Privilege>(Service, this, "role", "roleid", "privilege", "privilegeid", "roleprivileges", "roleid", "privilegeid", Columns); }
public List<Privilege> GetPrivileges (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<Privilege>(Service, this, "role", "roleid", "privilege", "privilegeid", "roleprivileges", "roleid", "privilegeid", Columns); }
...
/// </summary>
public List<User> GetUsers (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<User>(Service, this, "role", "roleid", "systemuser", "systemuserid", "systemuserroles", "roleid", "systemuserid", Columns); }
public List<User> GetUsers (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<User>(Service, this, "role", "roleid", "systemuser", "systemuserid", "systemuserroles", "roleid", "systemuserid", Columns); }
...
/// </summary>
public List<Team> GetTeams (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<Team>(Service, this, "role", "roleid", "team", "teamid", "teamroles", "roleid", "teamid", Columns); }
public List<Team> GetTeams (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<Team>(Service, this, "role", "roleid", "team", "teamid", "teamroles", "roleid", "teamid", Columns); }
