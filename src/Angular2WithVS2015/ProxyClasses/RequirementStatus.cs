...
{
    [EntityLogicalNameAttribute("msdyn_requirementstatus")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class RequirementStatus : BaseProxyClass
    {
        public new const string LogicalName = "msdyn_requirementstatus";
        public const int ObjectTypeCode = 10017;
        public const string PrimaryIdAttribute = "msdyn_requirementstatusid";
        public const string PrimaryNameAttribute = "msdyn_name";
        
        static RequirementStatus()
        {
            BaseProxyClass.RegisterProxyType(typeof(RequirementStatus), "msdyn_requirementstatus");
        ...
        public RequirementStatus() : base(new Entity("msdyn_requirementstatus")) { }
        public RequirementStatus(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<RequirementStatus>(); }
        /// <summary>
...
///<para>Logical Name: msdyn_requirementstatusid</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_requirementstatusid")]
...
public eRequirementStatus? Status2
{
	get
	{
		if (Status2_OptionSetValue != null) { return (eRequirementStatus)Status2_OptionSetValue.Value; }
		return null;
	}
	set
	{
...
/// <para>Schema Name: msdyn_requirementstatus_Annotations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_requirementstatus_AsyncOperations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_requirementstatus_BulkDeleteFailures</para>
/// </summary>
...
/// <para>Schema Name: msdyn_requirementstatus_DuplicateBaseRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_requirementstatus_DuplicateMatchingRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_requirementstatus_MailboxTrackingFolders</para>
/// </summary>
...
/// <summary>
/// <para><b>BookingSetupMetadata (Default Requirement Active Status)</b></para>
/// <para>Schema Name: msdyn_msdyn_requirementstatus_msdyn_bookingsetupmetadata_DefaultRequirementActiveStatus</para>
/// </summary>
public List<BookingSetupMetadata> GetBookingSetupMetadataRecords_DefaultRequirementActiveStatus (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<BookingSetupMetadata>(Service, this.Id, "msdyn_bookingsetupmetadata", "msdyn_defaultrequirementactivestatus", Columns); }
/// <summary>
/// <para><b>BookingSetupMetadata (Default Requirement Active Status)</b></para>
/// <para>Schema Name: msdyn_msdyn_requirementstatus_msdyn_bookingsetupmetadata_DefaultRequirementActiveStatus</para>
/// </summary>
public List<BookingSetupMetadata> GetBookingSetupMetadataRecords_DefaultRequirementActiveStatus (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<BookingSetupMetadata>(Service, this.Id, "msdyn_bookingsetupmetadata", "msdyn_defaultrequirementactivestatus", Columns); }
/// <summary>
/// <para><b>BookingSetupMetadata (Default Requirement Canceled Status)</b></para>
/// <para>Schema Name: msdyn_msdyn_requirementstatus_msdyn_bookingsetupmetadata_DefaultRequirementCanceledStatus</para>
/// </summary>
public List<BookingSetupMetadata> GetBookingSetupMetadataRecords_DefaultRequirementCanceledStatus (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<BookingSetupMetadata>(Service, this.Id, "msdyn_bookingsetupmetadata", "msdyn_defaultrequirementcanceledstatus", Columns); }
/// <summary>
/// <para><b>BookingSetupMetadata (Default Requirement Canceled Status)</b></para>
/// <para>Schema Name: msdyn_msdyn_requirementstatus_msdyn_bookingsetupmetadata_DefaultRequirementCanceledStatus</para>
/// </summary>
public List<BookingSetupMetadata> GetBookingSetupMetadataRecords_DefaultRequirementCanceledStatus (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<BookingSetupMetadata>(Service, this.Id, "msdyn_bookingsetupmetadata", "msdyn_defaultrequirementcanceledstatus", Columns); }
/// <summary>
/// <para><b>BookingSetupMetadata (Default Requirement Completed Status)</b></para>
/// <para>Schema Name: msdyn_msdyn_requirementstatus_msdyn_bookingsetupmetadata_DefaultRequirementCompletedStatus</para>
/// </summary>
public List<BookingSetupMetadata> GetBookingSetupMetadataRecords_DefaultRequirementCompletedStatus (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<BookingSetupMetadata>(Service, this.Id, "msdyn_bookingsetupmetadata", "msdyn_defaultrequirementcompletedstatus", Columns); }
/// <summary>
/// <para><b>BookingSetupMetadata (Default Requirement Completed Status)</b></para>
/// <para>Schema Name: msdyn_msdyn_requirementstatus_msdyn_bookingsetupmetadata_DefaultRequirementCompletedStatus</para>
/// </summary>
...
/// <para><b>ResourceRequirement (Status)</b></para>
/// <para>Schema Name: msdyn_requirementstatus_resourcerequirement_status</para>
/// </summary>
public List<ResourceRequirement> GetRequirements_Status (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ResourceRequirement>(Service, this.Id, "msdyn_resourcerequirement", "msdyn_status", Columns); }
/// <summary>
/// <para>Requirements</para>
/// <para><b>ResourceRequirement (Status)</b></para>
/// <para>Schema Name: msdyn_requirementstatus_resourcerequirement_status</para>
/// </summary>
public List<ResourceRequirement> GetRequirements_Status (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ResourceRequirement>(Service, this.Id, "msdyn_resourcerequirement", "msdyn_status", Columns); }
/// <summary>
/// <para><b>FieldSharing (Entity instance)</b></para>
/// <para>Schema Name: msdyn_requirementstatus_PrincipalObjectAttributeAccesses</para>
/// </summary>
...
/// <para>Schema Name: msdyn_requirementstatus_ProcessSession</para>
/// </summary>
...
/// <para>Schema Name: msdyn_requirementstatus_SyncErrors</para>
/// </summary>
...
/// <para>Schema Name: msdyn_requirementstatus_UserEntityInstanceDatas</para>
/// </summary>
...
public enum eRequirementStatus
{
	///<summary><para>Active</para>
        ...
        public static class Properties
{
	...
	/// <para>msdyn_requirementstatusid</para></summary>
	public const string RequirementStatusId = "msdyn_requirementstatusid";
