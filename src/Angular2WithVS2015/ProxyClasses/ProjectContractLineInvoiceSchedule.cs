...
{
    [EntityLogicalNameAttribute("msdyn_contractlineinvoiceschedule")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class ProjectContractLineInvoiceSchedule : BaseProxyClass
    {
        public new const string LogicalName = "msdyn_contractlineinvoiceschedule";
        public const int ObjectTypeCode = 10033;
        public const string PrimaryIdAttribute = "msdyn_contractlineinvoicescheduleid";
        public const string PrimaryNameAttribute = "msdyn_name";
        
        static ProjectContractLineInvoiceSchedule()
        {
            BaseProxyClass.RegisterProxyType(typeof(ProjectContractLineInvoiceSchedule), "msdyn_contractlineinvoiceschedule");
        ...
        public ProjectContractLineInvoiceSchedule() : base(new Entity("msdyn_contractlineinvoiceschedule")) { }
        public ProjectContractLineInvoiceSchedule(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<ProjectContractLineInvoiceSchedule>(); }
        /// <summary>
...
///<summary>
///<para>Logical Name: msdyn_contractlinescheduleofvaluename</para>
///<para>Max Length: 100 characters</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_contractlinescheduleofvaluename")]
public string Msdyn_ContractLineScheduleOfValueName
{
	get { return this.GetPropertyValue<string>("msdyn_contractlinescheduleofvaluename"); }
}
///<summary>
...
/// <summary>
///Logical Name: msdyn_invoicerunstatus
/// </summary>
[AttributeLogicalNameAttribute("msdyn_invoicerunstatus")]
public eInvoiceRunStatus? MilestoneStatus
{
	get
	{
		if (MilestoneStatus_OptionSetValue != null) { return (eInvoiceRunStatus)MilestoneStatus_OptionSetValue.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.MilestoneStatus_OptionSetValue = new OptionSetValue((int)value); }
		else this.MilestoneStatus_OptionSetValue = null;
	}
}
///<summary>
///<para>Logical Name: msdyn_invoicerunstatus</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_invoicerunstatus")]
public OptionSetValue MilestoneStatus_OptionSetValue
{
	get { return this.GetPropertyValue<OptionSetValue>("msdyn_invoicerunstatus"); }
	set { this.SetPropertyValue<OptionSetValue>("msdyn_invoicerunstatus", value, "MilestoneStatus_OptionSetValue"); }
}
/// <summary>
...
/// <returns></returns>
public string MilestoneStatus_Text(IOrganizationService Service)
{
	return this.MilestoneStatus_OptionSetValue.GetOptionSetText(Service, this, "msdyn_invoicerunstatus");
}
/// <summary>
/// Retrieves the current value's text in the user's language.
/// </summary>
...
/// <returns></returns>
public string MilestoneStatus_Text(EnumAttributeMetadata AttributeMetadata)
{
	return AttributeMetadata.GetOptionSetText(this.MilestoneStatus_OptionSetValue.Value);
}
///<summary>
...
///<para>Logical Name: msdyn_contractlineinvoicescheduleid</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_contractlineinvoicescheduleid")]
public Guid ProjectContractLineInvoiceScheduleId
{
	get
	{
		return this.Id;
...
///<summary>
///<para>Logical Name: msdyn_contractlinescheduleofvalue</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_contractlinescheduleofvalue")]
public EntityReference ProjectContractLineMilestone
{
	get { return this.GetPropertyValue<EntityReference>("msdyn_contractlinescheduleofvalue"); }
	set { this.SetPropertyValue<EntityReference>("msdyn_contractlinescheduleofvalue", value, "ProjectContractLineMilestone"); }
}
///<summary>
...
/// <para>Schema Name: msdyn_contractlineinvoiceschedule_AsyncOperations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_contractlineinvoiceschedule_BulkDeleteFailures</para>
/// </summary>
...
/// <para>Schema Name: msdyn_contractlineinvoiceschedule_DuplicateBaseRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_contractlineinvoiceschedule_DuplicateMatchingRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_contractlineinvoiceschedule_MailboxTrackingFolders</para>
/// </summary>
...
/// <para>Schema Name: msdyn_contractlineinvoiceschedule_PrincipalObjectAttributeAccesses</para>
/// </summary>
...
/// <para>Schema Name: msdyn_contractlineinvoiceschedule_ProcessSession</para>
/// </summary>
...
/// <para>Schema Name: msdyn_contractlineinvoiceschedule_SyncErrors</para>
/// </summary>
...
/// <para>Schema Name: msdyn_contractlineinvoiceschedule_UserEntityInstanceDatas</para>
/// </summary>
...
public List<UserEntityInstanceData> GetUserEntityInstanceData_ObjectId (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<UserEntityInstanceData>(Service, this.Id, "userentityinstancedata", "objectid", Columns); }
        ...
        public enum eInvoiceRunStatus
{
	///<summary><para>Not Run</para>
	///<para>Value = 192350000</para></summary>
	[Description("Not Run")]
	NotRun = 192350000, 
	///<summary><para>Run Successful</para>
	///<para>Value = 192350001</para></summary>
	[Description("Run Successful")]
	RunSuccessful = 192350001, 
	///<summary><para>Run Failed</para>
        ...
        public static class Properties
{
	...
	/// <summary><para>msdyn_contractlinescheduleofvaluename</para>
	/// <para>msdyn_contractlinescheduleofvaluename</para></summary>
	public const string Msdyn_ContractLineScheduleOfValueName = "msdyn_contractlinescheduleofvaluename";
	...
	/// <summary><para>Milestone status</para>
	/// <para>msdyn_invoicerunstatus</para></summary>
	public const string MilestoneStatus = "msdyn_invoicerunstatus";
	...
	/// <para>msdyn_contractlineinvoicescheduleid</para></summary>
	public const string ProjectContractLineInvoiceScheduleId = "msdyn_contractlineinvoicescheduleid";
	/// <summary><para>Project Contract Line Milestone</para>
	/// <para>msdyn_contractlinescheduleofvalue</para></summary>
	public const string ProjectContractLineMilestone = "msdyn_contractlinescheduleofvalue";
