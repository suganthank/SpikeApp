...
namespace ProxyClasses
{
    ...
    public partial class WorkOrderService : BaseProxyClass
    {
        public new const string LogicalName = "msdyn_workorderservice";
        public const int ObjectTypeCode = 10179;
        public const string PrimaryIdAttribute = "msdyn_workorderserviceid";
        public const string PrimaryNameAttribute = "msdyn_name";
        
        static WorkOrderService()
        {
            BaseProxyClass.RegisterProxyType(typeof(WorkOrderService), "msdyn_workorderservice");
        ...
        public WorkOrderService() : base(new Entity("msdyn_workorderservice")) { }
        public WorkOrderService(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<WorkOrderService>(); }
        /// <summary>
...
public EntityReference AgreementBookingService
{
	get { return this.GetPropertyValue<EntityReference>("msdyn_agreementbookingservice"); }
	set { this.SetPropertyValue<EntityReference>("msdyn_agreementbookingservice", value, "AgreementBookingService"); }
}
///<summary>
...
///<para>Precision: 2</para>
///</summary>
public decimal? CalculatedUnitAmount
{
	get
	{
		if (CalculatedUnitAmountMoney != null) { return CalculatedUnitAmountMoney.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.CalculatedUnitAmountMoney = new Money(value.Value); }
		else this.CalculatedUnitAmountMoney = null;
	}
}
///<summary>
///<para>Logical Name: msdyn_calculatedunitamount</para>
...
public Money CalculatedUnitAmountMoney
{
	get { return this.GetPropertyValue<Money>("msdyn_calculatedunitamount"); }
	set { this.SetPropertyValue("msdyn_calculatedunitamount", (Money)value, (decimal)0, (decimal)1000000000, "CalculatedUnitAmountMoney"); }
}
///<summary>
...
///<para>Precision: 2</para>
///</summary>
public decimal? CalculatedUnitAmount_Base
{
	get
	{
		if (CalculatedUnitAmount_BaseMoney != null) { return CalculatedUnitAmount_BaseMoney.Value; }
		return null;
	}
}
///<summary>
...
public Money CalculatedUnitAmount_BaseMoney
{
...
public double? Discount
{
	...
	set { this.SetPropertyValue("msdyn_discountpercent", (double?)value, (double)0, (double)1000000000, "Discount"); }
}
///<summary>
...
///<para>Precision: 2</para>
///</summary>
public decimal? EstimateCalculatedUnitAmount
{
	get
	{
		if (EstimateCalculatedUnitAmountMoney != null) { return EstimateCalculatedUnitAmountMoney.Value; }
		return null;
	}
	set
	{
		if (value != null) { this.EstimateCalculatedUnitAmountMoney = new Money(value.Value); }
		else this.EstimateCalculatedUnitAmountMoney = null;
	}
}
///<summary>
///<para>Logical Name: msdyn_estimatecalculatedunitamount</para>
...
public Money EstimateCalculatedUnitAmountMoney
{
	get { return this.GetPropertyValue<Money>("msdyn_estimatecalculatedunitamount"); }
	set { this.SetPropertyValue("msdyn_estimatecalculatedunitamount", (Money)value, (decimal)0, (decimal)1000000000, "EstimateCalculatedUnitAmountMoney"); }
}
///<summary>
...
///<para>Precision: 2</para>
///</summary>
public decimal? EstimateCalculatedUnitAmount_Base
{
	get
	{
		if (EstimateCalculatedUnitAmount_BaseMoney != null) { return EstimateCalculatedUnitAmount_BaseMoney.Value; }
		return null;
	}
}
///<summary>
...
public Money EstimateCalculatedUnitAmount_BaseMoney
{
...
public double? EstimateDiscount
{
	...
	set { this.SetPropertyValue("msdyn_estimatediscountpercent", (double?)value, (double)0, (double)1000000000, "EstimateDiscount"); }
}
///<summary>
...
public int? EstimateDuration
{
	...
	set { this.SetPropertyValue("msdyn_estimateduration", (int?)value, (int)0, (int)2147483647, "EstimateDuration"); }
}
///<summary>
...
public Guid WorkOrderServiceId
{
	get
	{
		return this.Id;
...
/// <summary>
/// <para><b>InvoiceLine (Work Order Service)</b></para>
/// <para>Schema Name: msdyn_msdyn_workorderservice_invoicedetail</para>
/// </summary>
public List<InvoiceLine> GetInvoiceLines_WorkOrderService (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<InvoiceLine>(Service, this.Id, "invoicedetail", "msdyn_workorderserviceid", Columns); }
/// <summary>
/// <para><b>InvoiceLine (Work Order Service)</b></para>
/// <para>Schema Name: msdyn_msdyn_workorderservice_invoicedetail</para>
/// </summary>
public List<InvoiceLine> GetInvoiceLines_WorkOrderService (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<InvoiceLine>(Service, this.Id, "invoicedetail", "msdyn_workorderserviceid", Columns); }
/// <summary>
...
/// <para>Schema Name: msdyn_workorderservice_msdyn_approvals</para>
/// </summary>
        ...
        public static class Properties
{
	...
	public const string AgreementBookingService = "msdyn_agreementbookingservice";
	...
	public const string CalculatedUnitAmount = "msdyn_calculatedunitamount";
	/// <summary><para>Calculated Unit Amount (Base)</para>
	/// <para>msdyn_calculatedunitamount_base</para></summary>
	public const string CalculatedUnitAmount_Base = "msdyn_calculatedunitamount_base";
	...
	public const string EstimateCalculatedUnitAmount = "msdyn_estimatecalculatedunitamount";
	/// <summary><para>Estimate Calculated Unit Amount (Base)</para>
	/// <para>msdyn_estimatecalculatedunitamount_base</para></summary>
	public const string EstimateCalculatedUnitAmount_Base = "msdyn_estimatecalculatedunitamount_base";
	...
	public const string EstimateDuration = "msdyn_estimateduration";
	...
	public const string WorkOrderServiceId = "msdyn_workorderserviceid";
}
