...
public string WorkflowState
{
	get { return this.GetPropertyValue<string>("workflowstate"); }
        ...
        /// <summary>
/// <para><b>BulkDeleteOperation (System Job)</b></para>
/// <para>Schema Name: AsyncOperation_BulkDeleteOperation</para>
/// </summary>
public List<BulkDeleteOperation> GetBulkDeleteOperations_SystemJob (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<BulkDeleteOperation>(Service, this.Id, "bulkdeleteoperation", "asyncoperationid", Columns); }
/// <summary>
/// <para><b>BulkDeleteOperation (System Job)</b></para>
/// <para>Schema Name: AsyncOperation_BulkDeleteOperation</para>
/// </summary>
public List<BulkDeleteOperation> GetBulkDeleteOperations_SystemJob (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<BulkDeleteOperation>(Service, this.Id, "bulkdeleteoperation", "asyncoperationid", Columns); }
/// <summary>
/// <para><b>DuplicateRecord (System Job)</b></para>
/// <para>Schema Name: AsyncOperation_DuplicateBaseRecord</para>
/// </summary>
public List<DuplicateRecord> GetDuplicateRecords_SystemJob (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<DuplicateRecord>(Service, this.Id, "duplicaterecord", "asyncoperationid", Columns); }
/// <summary>
/// <para><b>DuplicateRecord (System Job)</b></para>
/// <para>Schema Name: AsyncOperation_DuplicateBaseRecord</para>
/// </summary>
public List<DuplicateRecord> GetDuplicateRecords_SystemJob (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<DuplicateRecord>(Service, this.Id, "duplicaterecord", "asyncoperationid", Columns); }
/// <summary>
...
/// <summary>
/// <para><b>WorkflowWaitSubscription ()</b></para>
/// <para>Schema Name: asyncoperation_workflowwaitsubscription</para>
/// </summary>
public List<WorkflowWaitSubscription> GetWorkflowWaitSubscriptions (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<WorkflowWaitSubscription>(Service, this.Id, "workflowwaitsubscription", "asyncoperationid", Columns); }
/// <summary>
/// <para><b>WorkflowWaitSubscription ()</b></para>
/// <para>Schema Name: asyncoperation_workflowwaitsubscription</para>
/// </summary>
public List<WorkflowWaitSubscription> GetWorkflowWaitSubscriptions (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<WorkflowWaitSubscription>(Service, this.Id, "workflowwaitsubscription", "asyncoperationid", Columns); }
