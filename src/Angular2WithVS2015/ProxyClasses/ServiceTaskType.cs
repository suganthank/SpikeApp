...
{
    [EntityLogicalNameAttribute("msdyn_servicetasktype")]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XrmToolkit", "4.0")]
    public partial class ServiceTaskType : BaseProxyClass
    {
        public new const string LogicalName = "msdyn_servicetasktype";
        public const int ObjectTypeCode = 10166;
        public const string PrimaryIdAttribute = "msdyn_servicetasktypeid";
        public const string PrimaryNameAttribute = "msdyn_name";
        
        static ServiceTaskType()
        {
            BaseProxyClass.RegisterProxyType(typeof(ServiceTaskType), "msdyn_servicetasktype");
        ...
        public ServiceTaskType() : base(new Entity("msdyn_servicetasktype")) { }
        public ServiceTaskType(Entity original) : base(original) { }
        public static string GetLogicalName() { return BaseProxyClass.GetLogicalName<ServiceTaskType>(); }
        /// <summary>
...
///<para>Logical Name: msdyn_servicetasktypeid</para>
///</summary>
[AttributeLogicalNameAttribute("msdyn_servicetasktypeid")]
public Guid ServiceTaskTypeId
{
	get
	{
		return this.Id;
...
/// <para>Schema Name: msdyn_servicetasktype_Annotations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_servicetasktype_AsyncOperations</para>
/// </summary>
...
/// <para>Schema Name: msdyn_servicetasktype_BulkDeleteFailures</para>
/// </summary>
...
/// <para>Schema Name: msdyn_servicetasktype_DuplicateBaseRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_servicetasktype_DuplicateMatchingRecord</para>
/// </summary>
...
/// <para>Schema Name: msdyn_servicetasktype_MailboxTrackingFolders</para>
/// </summary>
...
/// <summary>
/// <para>Task Type</para>
/// <para><b>AgreementBookingServiceTask (Task Type)</b></para>
/// <para>Schema Name: msdyn_msdyn_servicetasktype_msdyn_agreementbookingservicetask_TaskType</para>
/// </summary>
public List<AgreementBookingServiceTask> GetTaskType_TaskType (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<AgreementBookingServiceTask>(Service, this.Id, "msdyn_agreementbookingservicetask", "msdyn_tasktype", Columns); }
/// <summary>
/// <para>Task Type</para>
/// <para><b>AgreementBookingServiceTask (Task Type)</b></para>
/// <para>Schema Name: msdyn_msdyn_servicetasktype_msdyn_agreementbookingservicetask_TaskType</para>
/// </summary>
public List<AgreementBookingServiceTask> GetTaskType_TaskType (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<AgreementBookingServiceTask>(Service, this.Id, "msdyn_agreementbookingservicetask", "msdyn_tasktype", Columns); }
/// <summary>
/// <para><b>IncidentTypeServiceTask (Task Type)</b></para>
/// <para>Schema Name: msdyn_msdyn_servicetasktype_msdyn_incidenttypeservicetask_TaskType</para>
/// </summary>
public List<IncidentTypeServiceTask> GetIncidentTypeServiceTasks_TaskType (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<IncidentTypeServiceTask>(Service, this.Id, "msdyn_incidenttypeservicetask", "msdyn_tasktype", Columns); }
/// <summary>
/// <para><b>IncidentTypeServiceTask (Task Type)</b></para>
/// <para>Schema Name: msdyn_msdyn_servicetasktype_msdyn_incidenttypeservicetask_TaskType</para>
/// </summary>
public List<IncidentTypeServiceTask> GetIncidentTypeServiceTasks_TaskType (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<IncidentTypeServiceTask>(Service, this.Id, "msdyn_incidenttypeservicetask", "msdyn_tasktype", Columns); }
/// <summary>
/// <para><b>QuoteBookingServiceTask (Task Type)</b></para>
/// <para>Schema Name: msdyn_msdyn_servicetasktype_msdyn_quotebookingservicetask_TaskType</para>
/// </summary>
public List<QuoteBookingServiceTask> GetQuoteBookingServiceTasks_TaskType (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<QuoteBookingServiceTask>(Service, this.Id, "msdyn_quotebookingservicetask", "msdyn_tasktype", Columns); }
/// <summary>
/// <para><b>QuoteBookingServiceTask (Task Type)</b></para>
/// <para>Schema Name: msdyn_msdyn_servicetasktype_msdyn_quotebookingservicetask_TaskType</para>
/// </summary>
public List<QuoteBookingServiceTask> GetQuoteBookingServiceTasks_TaskType (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<QuoteBookingServiceTask>(Service, this.Id, "msdyn_quotebookingservicetask", "msdyn_tasktype", Columns); }
/// <summary>
/// <para>Task Type</para>
/// <para><b>WorkOrderServiceTask (Task Type)</b></para>
/// <para>Schema Name: msdyn_msdyn_servicetasktype_msdyn_workorderservicetask_TaskType</para>
/// </summary>
public List<WorkOrderServiceTask> GetTaskType_TaskType2 (IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<WorkOrderServiceTask>(Service, this.Id, "msdyn_workorderservicetask", "msdyn_tasktype", Columns); }
/// <summary>
/// <para>Task Type</para>
/// <para><b>WorkOrderServiceTask (Task Type)</b></para>
/// <para>Schema Name: msdyn_msdyn_servicetasktype_msdyn_workorderservicetask_TaskType</para>
/// </summary>
public List<WorkOrderServiceTask> GetTaskType_TaskType2 (IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<WorkOrderServiceTask>(Service, this.Id, "msdyn_workorderservicetask", "msdyn_tasktype", Columns); }
/// <summary>
/// <para><b>FieldSharing (Entity instance)</b></para>
/// <para>Schema Name: msdyn_servicetasktype_PrincipalObjectAttributeAccesses</para>
/// </summary>
...
/// <para>Schema Name: msdyn_servicetasktype_ProcessSession</para>
/// </summary>
...
/// <para>Schema Name: msdyn_servicetasktype_SyncErrors</para>
/// </summary>
...
/// <para>Schema Name: msdyn_servicetasktype_UserEntityInstanceDatas</para>
/// </summary>
        ...
        public static class Properties
{
	...
	/// <para>msdyn_servicetasktypeid</para></summary>
	public const string ServiceTaskTypeId = "msdyn_servicetasktypeid";
