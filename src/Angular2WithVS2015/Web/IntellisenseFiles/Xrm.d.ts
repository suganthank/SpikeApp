    ...
    export module Page {
        ...
        */
        ...
        export interface SubGridControl extends Control {
            ...
            refresh(): void;
            getGrid(): Grid;
            addOnLoad(onLoad: Function): void;
            removeOnLoad(onLoad: Function): void;
        ...
        /**
         * Interface for an entity in a grid row.
         *
         */
        export interface GridEntity {
            ...
            */
            getAttributes(): GridEntityAttributes;
        }

        /**
        * WARNING! - Undocumented
        */
        export interface GridEntityAttributes {
            /**
            * WARNING! - Undocumented
            */
            getByName(name: string): GridEntityAttribute;
        }

        /**
        * WARNING! - Undocumented
        */
        export interface GridEntityAttribute {
        ...
        /**
         * Interface for a grid view selector.
         *
         */
        export interface ViewSelector {
            getCurrentView(): LookupValue;
            isVisible(): boolean;
            setCurrentView(value: LookupValue): void;
        }
